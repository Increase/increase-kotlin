...
class CheckTransferServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val checkTransfer = checkTransferServiceAsync.create(CheckTransferCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val checkTransfer = checkTransferServiceAsync.retrieve(CheckTransferRetrieveParams.builder()
    ...
    suspend fun approve() {
      ...
      val checkTransfer = checkTransferServiceAsync.approve(CheckTransferApproveParams.builder()
          .checkTransferId("check_transfer_30b43acfu9vw8fyc4f5")
          .build())
    ...
    suspend fun cancel() {
      ...
      val checkTransfer = checkTransferServiceAsync.cancel(CheckTransferCancelParams.builder()
          .checkTransferId("check_transfer_30b43acfu9vw8fyc4f5")
          .build())
    ...
    suspend fun stopPayment() {
      ...
      val checkTransfer = checkTransferServiceAsync.stopPayment(CheckTransferStopPaymentParams.builder()
          .checkTransferId("check_transfer_30b43acfu9vw8fyc4f5")
