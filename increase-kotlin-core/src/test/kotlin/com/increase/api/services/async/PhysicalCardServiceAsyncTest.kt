...
class PhysicalCardServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val physicalCard = physicalCardServiceAsync.create(PhysicalCardCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val physicalCard = physicalCardServiceAsync.retrieve(PhysicalCardRetrieveParams.builder()
    ...
    suspend fun update() {
      ...
      val physicalCard = physicalCardServiceAsync.update(PhysicalCardUpdateParams.builder()
          .physicalCardId("physical_card_ode8duyq5v2ynhjoharl")
