...
class WireDrawdownRequestServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val wireDrawdownRequest = wireDrawdownRequestServiceAsync.create(WireDrawdownRequestCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val wireDrawdownRequest = wireDrawdownRequestServiceAsync.retrieve(WireDrawdownRequestRetrieveParams.builder()
