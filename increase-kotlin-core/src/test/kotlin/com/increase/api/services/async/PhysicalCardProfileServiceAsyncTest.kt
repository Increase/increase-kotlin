...
class PhysicalCardProfileServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val physicalCardProfile = physicalCardProfileServiceAsync.create(PhysicalCardProfileCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val physicalCardProfile = physicalCardProfileServiceAsync.retrieve(PhysicalCardProfileRetrieveParams.builder()
    ...
    suspend fun archive() {
      ...
      val physicalCardProfile = physicalCardProfileServiceAsync.archive(PhysicalCardProfileArchiveParams.builder()
          .physicalCardProfileId("physical_card_profile_m534d5rn9qyy9ufqxoec")
          .build())
    ...
    suspend fun clone() {
      ...
      val physicalCardProfile = physicalCardProfileServiceAsync.clone(PhysicalCardProfileCloneParams.builder()
          .physicalCardProfileId("physical_card_profile_m534d5rn9qyy9ufqxoec")
