...
class AccountTransferServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val accountTransfer = accountTransferServiceAsync.create(AccountTransferCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val accountTransfer = accountTransferServiceAsync.retrieve(AccountTransferRetrieveParams.builder()
    ...
    suspend fun approve() {
      ...
      val accountTransfer = accountTransferServiceAsync.approve(AccountTransferApproveParams.builder()
          .accountTransferId("account_transfer_7k9qe1ysdgqztnt63l7n")
          .build())
    ...
    suspend fun cancel() {
      ...
      val accountTransfer = accountTransferServiceAsync.cancel(AccountTransferCancelParams.builder()
          .accountTransferId("account_transfer_7k9qe1ysdgqztnt63l7n")
          .build())
