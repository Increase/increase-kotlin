...
class DigitalCardProfileServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val digitalCardProfile = digitalCardProfileServiceAsync.create(DigitalCardProfileCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val digitalCardProfile = digitalCardProfileServiceAsync.retrieve(DigitalCardProfileRetrieveParams.builder()
    ...
    suspend fun list() {
      ...
      val page = digitalCardProfileServiceAsync.list()
    ...
    suspend fun archive() {
      ...
      val digitalCardProfile = digitalCardProfileServiceAsync.archive(DigitalCardProfileArchiveParams.builder()
          .digitalCardProfileId("digital_card_profile_s3puplu90f04xhcwkiga")
          .build())
    ...
    suspend fun clone() {
      ...
      val digitalCardProfile = digitalCardProfileServiceAsync.clone(DigitalCardProfileCloneParams.builder()
          .digitalCardProfileId("digital_card_profile_s3puplu90f04xhcwkiga")
