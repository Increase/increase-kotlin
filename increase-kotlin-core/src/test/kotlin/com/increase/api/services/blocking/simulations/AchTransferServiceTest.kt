...
class AchTransferServiceTest {
    ...
    fun callAcknowledge() {
      ...
      val achTransfer = achTransferService.acknowledge(SimulationAchTransferAcknowledgeParams.builder()
    ...
    fun callCreateNotificationOfChange() {
      val client = IncreaseOkHttpClient.builder()
          ...
          .build()
      val achTransferService = client.simulations().achTransfers()
      val achTransfer = achTransferService.createNotificationOfChange(SimulationAchTransferCreateNotificationOfChangeParams.builder()
          .achTransferId("ach_transfer_id")
