...
class AccountServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val account = accountServiceAsync.create(AccountCreateParams.builder()
          .name("New Account!")
    ...
    suspend fun retrieve() {
      ...
      val account = accountServiceAsync.retrieve(AccountRetrieveParams.builder()
    ...
    suspend fun update() {
      ...
      val account = accountServiceAsync.update(AccountUpdateParams.builder()
          .accountId("account_in71c4amph0vgo2qllky")
    ...
    suspend fun balance() {
      ...
      val balanceLookup = accountServiceAsync.balance(AccountBalanceParams.builder()
          .accountId("account_in71c4amph0vgo2qllky")
    ...
    suspend fun close() {
      ...
      val account = accountServiceAsync.close(AccountCloseParams.builder()
          .accountId("account_in71c4amph0vgo2qllky")
          .build())
