...
class InboundWireDrawdownRequestServiceAsyncTest {
    ...
    suspend fun create() {
      val client = IncreaseOkHttpClientAsync.builder()
          ...
          .apiKey("My API Key")
          .build()
      val inboundWireDrawdownRequestServiceAsync = client.simulations().inboundWireDrawdownRequests()

      val inboundWireDrawdownRequest = inboundWireDrawdownRequestServiceAsync.create(InboundWireDrawdownRequestCreateParams.builder()
          .amount(10000L)
