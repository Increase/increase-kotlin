...
class WireTransferServiceTest {
    ...
    fun callReverse() {
      ...
      val wireTransfer = wireTransferService.reverse(SimulationWireTransferReverseParams.builder()
    ...
    fun callSubmit() {
      val client = IncreaseOkHttpClient.builder()
          ...
          .build()
      val wireTransferService = client.simulations().wireTransfers()
      val wireTransfer = wireTransferService.submit(SimulationWireTransferSubmitParams.builder()
          .wireTransferId("wire_transfer_id")
          .build())
      println(wireTransfer)
      wireTransfer.validate()
