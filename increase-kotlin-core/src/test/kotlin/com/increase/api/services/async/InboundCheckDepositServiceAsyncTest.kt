...
class InboundCheckDepositServiceAsyncTest {
    ...
    suspend fun retrieve() {
      ...
      val inboundCheckDeposit = inboundCheckDepositServiceAsync.retrieve(InboundCheckDepositRetrieveParams.builder()
    ...
    suspend fun decline() {
      ...
      val inboundCheckDeposit = inboundCheckDepositServiceAsync.decline(InboundCheckDepositDeclineParams.builder()
          .inboundCheckDepositId("inbound_check_deposit_zoshvqybq0cjjm31mra")
          .build())
    ...
    suspend fun return_() {
      ...
      val inboundCheckDeposit = inboundCheckDepositServiceAsync.return_(InboundCheckDepositReturnParams.builder()
          .inboundCheckDepositId("inbound_check_deposit_zoshvqybq0cjjm31mra")
