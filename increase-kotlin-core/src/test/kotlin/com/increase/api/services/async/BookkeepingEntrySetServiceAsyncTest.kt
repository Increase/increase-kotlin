...
class BookkeepingEntrySetServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val bookkeepingEntrySet = bookkeepingEntrySetServiceAsync.create(BookkeepingEntrySetCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val bookkeepingEntrySet = bookkeepingEntrySetServiceAsync.retrieve(BookkeepingEntrySetRetrieveParams.builder()
