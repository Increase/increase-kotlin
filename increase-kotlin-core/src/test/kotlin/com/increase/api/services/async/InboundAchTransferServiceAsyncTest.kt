...
class InboundAchTransferServiceAsyncTest {
    ...
    suspend fun retrieve() {
      ...
      val inboundAchTransfer = inboundAchTransferServiceAsync.retrieve(InboundAchTransferRetrieveParams.builder()
    ...
    suspend fun createNotificationOfChange() {
      ...
      val inboundAchTransfer = inboundAchTransferServiceAsync.createNotificationOfChange(InboundAchTransferCreateNotificationOfChangeParams.builder()
          .inboundAchTransferId("inbound_ach_transfer_tdrwqr3fq9gnnq49odev")
    ...
    suspend fun decline() {
      ...
      val inboundAchTransfer = inboundAchTransferServiceAsync.decline(InboundAchTransferDeclineParams.builder()
          .inboundAchTransferId("inbound_ach_transfer_tdrwqr3fq9gnnq49odev")
    ...
    suspend fun transferReturn() {
      ...
      val inboundAchTransfer = inboundAchTransferServiceAsync.transferReturn(InboundAchTransferTransferReturnParams.builder()
          .inboundAchTransferId("inbound_ach_transfer_tdrwqr3fq9gnnq49odev")
