...
class ProofOfAuthorizationRequestSubmissionServiceAsyncTest {
    ...
    suspend fun create() {
      val client = IncreaseOkHttpClientAsync.builder()
          ...
          .apiKey("My API Key")
          .build()
      val proofOfAuthorizationRequestSubmissionServiceAsync = client.proofOfAuthorizationRequestSubmissions()

      val proofOfAuthorizationRequestSubmission = proofOfAuthorizationRequestSubmissionServiceAsync.create(ProofOfAuthorizationRequestSubmissionCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val proofOfAuthorizationRequestSubmission = proofOfAuthorizationRequestSubmissionServiceAsync.retrieve(ProofOfAuthorizationRequestSubmissionRetrieveParams.builder()
