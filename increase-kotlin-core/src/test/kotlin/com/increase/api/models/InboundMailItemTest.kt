...
class InboundMailItemTest {
    ...
    fun createInboundMailItem() {
      val inboundMailItem = InboundMailItem.builder()
          .id("id")
      ...
      assertThat(inboundMailItem.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(inboundMailItem.rejectionReason()).isEqualTo(InboundMailItem.RejectionReason.NO_MATCHING_LOCKBOX)
      assertThat(inboundMailItem.returnAddress()).isEqualTo(InboundMailItem.ReturnAddress.builder()
          .city("city")
          .line1("line1")
          .line2("line2")
          .name("name")
