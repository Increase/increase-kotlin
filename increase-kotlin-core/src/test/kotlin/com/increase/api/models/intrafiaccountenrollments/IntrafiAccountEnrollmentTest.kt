...
class IntrafiAccountEnrollmentTest {
    ...
    fun createIntrafiAccountEnrollment() {
      ...
      assertThat(intrafiAccountEnrollment.id()).isEqualTo("intrafi_account_enrollment_w8l97znzreopkwf2tg75")
      assertThat(intrafiAccountEnrollment.accountId()).isEqualTo("account_in71c4amph0vgo2qllky")
      assertThat(intrafiAccountEnrollment.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
