...
class FileTest {
    ...
    fun createFile() {
      val file = File.builder()
          ...
          .downloadUrl("https://api.increase.com/files/file_makxrc67oh9l6sg7w9yc/download")
      ...
      assertThat(file.downloadUrl()).isEqualTo("https://api.increase.com/files/file_makxrc67oh9l6sg7w9yc/download")
