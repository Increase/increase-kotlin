...
class BookkeepingEntrySetTest {
    ...
    fun createBookkeepingEntrySet() {
      val bookkeepingEntrySet = BookkeepingEntrySet.builder()
          ...
          .addEntry(BookkeepingEntrySet.Entry.builder()
      ...
      assertThat(bookkeepingEntrySet.createdAt()).isEqualTo(OffsetDateTime.parse("2023-02-11T02:11:59Z"))
      assertThat(bookkeepingEntrySet.date()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(bookkeepingEntrySet.entries()).containsExactly(BookkeepingEntrySet.Entry.builder()
          .id("bookkeeping_entry_ctjpajsj3ks2blx10375")
          .accountId("bookkeeping_account_e37p1f1iuocw5intf35v")
          .amount(1750L)
          .build(), BookkeepingEntrySet.Entry.builder()
          .id("bookkeeping_entry_ctjpajsj3ks2blx10375")
          .accountId("bookkeeping_account_e37p1f1iuocw5intf35v")
          .amount(-1750L)
          .build())
