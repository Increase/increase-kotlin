...
class PhysicalCardProfileTest {
    ...
    fun createPhysicalCardProfile() {
      val physicalCardProfile = PhysicalCardProfile.builder()
          .id("id")
      ...
      assertThat(physicalCardProfile.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(physicalCardProfile.status()).isEqualTo(PhysicalCardProfile.Status.PENDING_CREATING)
      assertThat(physicalCardProfile.type()).isEqualTo(PhysicalCardProfile.Type.PHYSICAL_CARD_PROFILE)
    }
}
