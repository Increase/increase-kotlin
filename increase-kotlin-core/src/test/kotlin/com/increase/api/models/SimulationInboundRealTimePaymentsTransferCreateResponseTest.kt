...
class SimulationInboundRealTimePaymentsTransferCreateResponseTest {
    ...
    fun createSimulationInboundRealTimePaymentsTransferCreateResponse() {
      val simulationInboundRealTimePaymentsTransferCreateResponse = SimulationInboundRealTimePaymentsTransferCreateResponse.builder()
          ...
          .transaction(Transaction.builder()
              ...
              .source(Transaction.Source.builder()
                      ...
                      .purchaseDetails(Transaction.Source.CardRefund.PurchaseDetails.builder()
                          ...
                          .travel(Transaction.Source.CardRefund.PurchaseDetails.Travel.builder()
                              .ancillary(Transaction.Source.CardRefund.PurchaseDetails.Travel.Ancillary.builder()
                                  ...
                                  .services(listOf(Transaction.Source.CardRefund.PurchaseDetails.Travel.Ancillary.Service.builder()
                              ...
                              .tripLegs(listOf(Transaction.Source.CardRefund.PurchaseDetails.Travel.TripLeg.builder()
                      ...
                      .purchaseDetails(Transaction.Source.CardSettlement.PurchaseDetails.builder()
                          ...
                          .travel(Transaction.Source.CardSettlement.PurchaseDetails.Travel.builder()
                              .ancillary(Transaction.Source.CardSettlement.PurchaseDetails.Travel.Ancillary.builder()
                                  ...
                                  .passengerNameOrDescription("passenger_name_or_description")
                                  .services(listOf(Transaction.Source.CardSettlement.PurchaseDetails.Travel.Ancillary.Service.builder()
                              ...
                              .travelAgencyCode("travel_agency_code")
                              .travelAgencyName("travel_agency_name")
                              .tripLegs(listOf(Transaction.Source.CardSettlement.PurchaseDetails.Travel.TripLeg.builder()
                                  .carrierCode("carrier_code")
                                  .destinationCityAirportCode("destination_city_airport_code")
                                  .fareBasisCode("fare_basis_code")
                                  .flightNumber("flight_number")
                  ...
                  .inboundAchTransfer(Transaction.Source.InboundAchTransfer.builder()
                      .addenda(Transaction.Source.InboundAchTransfer.Addenda.builder()
                          ...
                          .freeform(Transaction.Source.InboundAchTransfer.Addenda.Freeform.builder()
                              .entries(listOf(Transaction.Source.InboundAchTransfer.Addenda.Freeform.Entry.builder()
                  ...
                  .wireTransferIntention(Transaction.Source.WireTransferIntention.builder()
                      ...
                      .transferId("transfer_id")
                      .build())
                  .wireTransferRejection(Transaction.Source.WireTransferRejection.builder()
                      .transferId("transfer_id")
                      .build())
                  .build())
              .type(Transaction.Type.TRANSACTION)
              .build())
          .type(SimulationInboundRealTimePaymentsTransferCreateResponse.Type.INBOUND_REAL_TIME_PAYMENTS_TRANSFER_SIMULATION_RESULT)
          .build()
      assertThat(simulationInboundRealTimePaymentsTransferCreateResponse).isNotNull
      assertThat(simulationInboundRealTimePaymentsTransferCreateResponse.declinedTransaction()).isEqualTo(DeclinedTransaction.builder()
          .id("id")
          .accountId("account_id")
          .amount(123L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .type(DeclinedTransaction.Type.DECLINED_TRANSACTION)
          .build())
      assertThat(simulationInboundRealTimePaymentsTransferCreateResponse.transaction()).isEqualTo(Transaction.builder()
          .id("id")
          .accountId("account_id")
          .amount(123L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .type(Transaction.Type.TRANSACTION)
          .build())
      assertThat(simulationInboundRealTimePaymentsTransferCreateResponse.type()).isEqualTo(SimulationInboundRealTimePaymentsTransferCreateResponse.Type.INBOUND_REAL_TIME_PAYMENTS_TRANSFER_SIMULATION_RESULT)
    }
}
