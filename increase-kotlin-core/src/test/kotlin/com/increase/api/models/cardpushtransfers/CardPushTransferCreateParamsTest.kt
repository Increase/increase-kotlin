...
internal class CardPushTransferCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.merchantLegalBusinessName()).isEqualTo("x6")
        assertThat(body.merchantStreetAddress()).isEqualTo("merchant_street_address")
        assertThat(body.recipientAddressCity()).isEqualTo("recipient_address_city")
        assertThat(body.recipientAddressLine1()).isEqualTo("recipient_address_line1")
        assertThat(body.recipientAddressPostalCode()).isEqualTo("x6")
        assertThat(body.recipientAddressState()).isEqualTo("x6")
