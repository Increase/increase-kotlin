...
internal class CardPushTransferTest {
    ...
    fun create() {
        ...
        assertThat(cardPushTransfer.merchantLegalBusinessName()).isNull()
        ...
        assertThat(cardPushTransfer.merchantStreetAddress()).isNull()
        ...
        assertThat(cardPushTransfer.recipientAddressCity()).isNull()
        assertThat(cardPushTransfer.recipientAddressLine1()).isNull()
        assertThat(cardPushTransfer.recipientAddressPostalCode()).isNull()
        assertThat(cardPushTransfer.recipientAddressState()).isNull()
