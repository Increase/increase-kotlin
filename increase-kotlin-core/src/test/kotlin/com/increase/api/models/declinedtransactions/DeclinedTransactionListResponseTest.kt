...
internal class DeclinedTransactionListResponseTest {
    ...
    @Test
    fun create() {
        val declinedTransactionListResponse =
            DeclinedTransactionListResponse.builder()
                .addData(
        ...
        assertThat(declinedTransactionListResponse.data())
            .containsExactly(
                DeclinedTransaction.builder()
                    .id("declined_transaction_17jbn0yyhvkt4v4ooym8")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(declinedTransactionListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedDeclinedTransactionListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(declinedTransactionListResponse),
                jacksonTypeRef<DeclinedTransactionListResponse>(),
            )

        assertThat(roundtrippedDeclinedTransactionListResponse)
            .isEqualTo(declinedTransactionListResponse)
    }
}
