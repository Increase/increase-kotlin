...
internal class RealTimePaymentsTransferListResponseTest {

    @Test
    fun create() {
        val realTimePaymentsTransferListResponse =
            RealTimePaymentsTransferListResponse.builder()
                .addData(
        ...
        assertThat(realTimePaymentsTransferListResponse.data())
            .containsExactly(
                RealTimePaymentsTransfer.builder()
                    .id("real_time_payments_transfer_iyuhl5kdn7ssmup83mvq")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(realTimePaymentsTransferListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedRealTimePaymentsTransferListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(realTimePaymentsTransferListResponse),
                jacksonTypeRef<RealTimePaymentsTransferListResponse>(),
            )

        assertThat(roundtrippedRealTimePaymentsTransferListResponse)
            .isEqualTo(realTimePaymentsTransferListResponse)
    }
}
