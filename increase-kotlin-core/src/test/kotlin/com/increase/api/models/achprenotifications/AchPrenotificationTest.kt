...
class AchPrenotificationTest {
    ...
    fun createAchPrenotification() {
      val achPrenotification = AchPrenotification.builder()
          ...
          .effectiveDate(null)
          .idempotencyKey(null)
          .addNotificationsOfChange(AchPrenotification.NotificationsOfChange.builder()
      ...
      assertThat(achPrenotification.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
