...
internal class PendingTransactionListResponseTest {

    @Test
    fun create() {
        val pendingTransactionListResponse =
            PendingTransactionListResponse.builder()
                .addData(
        ...
        assertThat(pendingTransactionListResponse.data())
            .containsExactly(
                PendingTransaction.builder()
                    .id("pending_transaction_k1sfetcau2qbvjbzgju4")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(pendingTransactionListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedPendingTransactionListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(pendingTransactionListResponse),
                jacksonTypeRef<PendingTransactionListResponse>(),
            )

        assertThat(roundtrippedPendingTransactionListResponse)
            .isEqualTo(pendingTransactionListResponse)
    }
}
