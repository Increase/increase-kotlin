...
internal class InboundFednowTransferTest {
    ...
    fun create() {
        ...
        assertThat(inboundFednowTransfer.endToEndIdentification()).isEqualTo("Invoice 29582")
        ...
        assertThat(inboundFednowTransfer.transactionIdentification())
            .isEqualTo("20250308723260130GT4LAKENDXBHQCZDWS")
