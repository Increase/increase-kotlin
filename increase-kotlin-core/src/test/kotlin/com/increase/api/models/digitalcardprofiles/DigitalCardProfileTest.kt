...
class DigitalCardProfileTest {
    ...
    fun createDigitalCardProfile() {
      ...
      assertThat(digitalCardProfile.backgroundImageFileId()).isEqualTo("file_makxrc67oh9l6sg7w9yc")
      ...
      assertThat(digitalCardProfile.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
