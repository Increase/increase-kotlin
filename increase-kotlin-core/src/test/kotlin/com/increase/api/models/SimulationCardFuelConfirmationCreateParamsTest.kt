...
import com.increase.api.models.SimulationCardFuelConfirmationCreateParams.SimulationCardFuelConfirmationCreateBody
...
class SimulationCardFuelConfirmationCreateParamsTest {
    ...
    @Test
    fun getBody() {
      val params = SimulationCardFuelConfirmationCreateParams.builder()
          .amount(123L)
          .cardPaymentId("card_payment_id")
          .build()
