    ...
    fun create() {
        val program =
            Program.builder()
                ...
                .interestRate("0.01")
                .lending(Program.Lending.builder().maximumExtendableCredit(0L).build())
        ...
        assertThat(program.lending())
            .isEqualTo(Program.Lending.builder().maximumExtendableCredit(0L).build())
