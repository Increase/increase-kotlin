...
internal class AccountTransferListResponseTest {
    ...
    @Test
    fun create() {
        val accountTransferListResponse =
            AccountTransferListResponse.builder()
                .addData(
        ...
        assertThat(accountTransferListResponse.data())
            .containsExactly(
                AccountTransfer.builder()
                    .id("account_transfer_7k9qe1ysdgqztnt63l7n")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(accountTransferListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedAccountTransferListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(accountTransferListResponse),
                jacksonTypeRef<AccountTransferListResponse>(),
            )

        assertThat(roundtrippedAccountTransferListResponse).isEqualTo(accountTransferListResponse)
    }
}
