...
class InboundCheckDepositTest {
    ...
    fun createInboundCheckDeposit() {
      ...
      assertThat(inboundCheckDeposit.acceptedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(inboundCheckDeposit.bankOfFirstDepositRoutingNumber()).isEqualTo("bank_of_first_deposit_routing_number")
      ...
      assertThat(inboundCheckDeposit.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(inboundCheckDeposit.currency()).isEqualTo(InboundCheckDeposit.Currency.CAD)
      assertThat(inboundCheckDeposit.declinedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
