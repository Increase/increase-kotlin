...
class OAuthConnectionTest {
    ...
    fun createOAuthConnection() {
      ...
      assertThat(oauthConnection.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(oauthConnection.deletedAt()).isNull()
      assertThat(oauthConnection.groupId()).isEqualTo("group_1g4mhziu6kvrs3vz35um")
      assertThat(oauthConnection.oauthApplicationId()).isEqualTo("application_gj9ufmpgh5i56k4vyriy")
