...
class EventSubscriptionTest {
    ...
    fun createEventSubscription() {
      ...
      assertThat(eventSubscription.id()).isEqualTo("event_subscription_001dzz0r20rcdxgb013zqb8m04g")
      assertThat(eventSubscription.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
