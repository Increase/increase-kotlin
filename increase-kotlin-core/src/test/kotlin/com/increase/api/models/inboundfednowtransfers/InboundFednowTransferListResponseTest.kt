...
internal class InboundFednowTransferListResponseTest {

    @Test
    fun create() {
        val inboundFednowTransferListResponse =
            InboundFednowTransferListResponse.builder()
                .addData(
        ...
        assertThat(inboundFednowTransferListResponse.data())
            .containsExactly(
                InboundFednowTransfer.builder()
                    .id("inbound_fednow_transfer_ctxxbc07oh5ke5w1hk20")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(inboundFednowTransferListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInboundFednowTransferListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(inboundFednowTransferListResponse),
                jacksonTypeRef<InboundFednowTransferListResponse>(),
            )

        assertThat(roundtrippedInboundFednowTransferListResponse)
            .isEqualTo(inboundFednowTransferListResponse)
    }
}
