...
class InboundAchTransferTest {
    ...
    fun createInboundAchTransfer() {
      val inboundAchTransfer = InboundAchTransfer.builder()
          ...
          .addenda(InboundAchTransfer.Addenda.builder()
              ...
              .freeform(InboundAchTransfer.Addenda.Freeform.builder()
                  .addEntry(InboundAchTransfer.Addenda.Freeform.Entry.builder()
          ...
          .internationalAddenda(InboundAchTransfer.InternationalAddenda.builder()
              .destinationCountryCode("destination_country_code")
              .destinationCurrencyCode("destination_currency_code")
              .foreignExchangeIndicator(InboundAchTransfer.InternationalAddenda.ForeignExchangeIndicator.FIXED_TO_VARIABLE)
              .foreignExchangeReference("foreign_exchange_reference")
              .foreignExchangeReferenceIndicator(InboundAchTransfer.InternationalAddenda.ForeignExchangeReferenceIndicator.FOREIGN_EXCHANGE_RATE)
              .foreignPaymentAmount(0L)
              .foreignTraceNumber("foreign_trace_number")
              .internationalTransactionTypeCode(InboundAchTransfer.InternationalAddenda.InternationalTransactionTypeCode.ANNUITY)
              ...
              .originatingDepositoryFinancialInstitutionIdQualifier(InboundAchTransfer.InternationalAddenda.OriginatingDepositoryFinancialInstitutionIdQualifier.NATIONAL_CLEARING_SYSTEM_NUMBER)
              ...
              .receivingDepositoryFinancialInstitutionIdQualifier(InboundAchTransfer.InternationalAddenda.ReceivingDepositoryFinancialInstitutionIdQualifier.NATIONAL_CLEARING_SYSTEM_NUMBER)
      ...
      assertThat(inboundAchTransfer.accountNumberId()).isEqualTo("account_number_v18nkfqm6afpsrvy82b2")
      ...
      assertThat(inboundAchTransfer.automaticallyResolvesAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(inboundAchTransfer.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      ...
      assertThat(inboundAchTransfer.expectedSettlementSchedule()).isEqualTo(InboundAchTransfer.ExpectedSettlementSchedule.SAME_DAY)
      assertThat(inboundAchTransfer.internationalAddenda()).isEqualTo(InboundAchTransfer.InternationalAddenda.builder()
          .destinationCountryCode("destination_country_code")
          .destinationCurrencyCode("destination_currency_code")
          .foreignExchangeIndicator(InboundAchTransfer.InternationalAddenda.ForeignExchangeIndicator.FIXED_TO_VARIABLE)
          .foreignExchangeReference("foreign_exchange_reference")
