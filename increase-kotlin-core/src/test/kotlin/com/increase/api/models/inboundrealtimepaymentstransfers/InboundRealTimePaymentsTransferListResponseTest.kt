...
internal class InboundRealTimePaymentsTransferListResponseTest {

    @Test
    fun create() {
        val inboundRealTimePaymentsTransferListResponse =
            InboundRealTimePaymentsTransferListResponse.builder()
                .addData(
        ...
        assertThat(inboundRealTimePaymentsTransferListResponse.data())
            .containsExactly(
                InboundRealTimePaymentsTransfer.builder()
                    .id("inbound_real_time_payments_transfer_63hlz498vcxg644hcrzr")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(inboundRealTimePaymentsTransferListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInboundRealTimePaymentsTransferListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(inboundRealTimePaymentsTransferListResponse),
                jacksonTypeRef<InboundRealTimePaymentsTransferListResponse>(),
            )

        assertThat(roundtrippedInboundRealTimePaymentsTransferListResponse)
            .isEqualTo(inboundRealTimePaymentsTransferListResponse)
    }
}
