...
internal class FednowTransferListResponseTest {

    @Test
    fun create() {
        val fednowTransferListResponse =
            FednowTransferListResponse.builder()
                .addData(
        ...
        assertThat(fednowTransferListResponse.data())
            .containsExactly(
                FednowTransfer.builder()
                    .id("fednow_transfer_4i0mptrdu1mueg1196bg")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(fednowTransferListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedFednowTransferListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(fednowTransferListResponse),
                jacksonTypeRef<FednowTransferListResponse>(),
            )

        assertThat(roundtrippedFednowTransferListResponse).isEqualTo(fednowTransferListResponse)
    }
}
