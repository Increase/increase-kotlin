...
class ProofOfAuthorizationRequestSubmissionTest {
    ...
    fun createProofOfAuthorizationRequestSubmission() {
      ...
      assertThat(proofOfAuthorizationRequestSubmission.id()).isEqualTo("proof_of_authorization_request_submission_uqhqroiley7n0097vizn")
      assertThat(proofOfAuthorizationRequestSubmission.authorizationTerms()).isEqualTo("I agree to the terms.")
      assertThat(proofOfAuthorizationRequestSubmission.authorizedAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(proofOfAuthorizationRequestSubmission.authorizerCompany()).isEqualTo("National Phonograph Company")
      assertThat(proofOfAuthorizationRequestSubmission.authorizerEmail()).isEqualTo("user@example.com")
      assertThat(proofOfAuthorizationRequestSubmission.authorizerIpAddress()).isEqualTo("123.45.67.89")
      assertThat(proofOfAuthorizationRequestSubmission.authorizerName()).isEqualTo("Ian Crease")
      assertThat(proofOfAuthorizationRequestSubmission.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(proofOfAuthorizationRequestSubmission.customerHasBeenOffboarded()).isEqualTo(false)
      assertThat(proofOfAuthorizationRequestSubmission.idempotencyKey()).isNull()
      assertThat(proofOfAuthorizationRequestSubmission.proofOfAuthorizationRequestId()).isEqualTo("proof_of_authorization_request_iwp8no25h3rjvil6ad3b")
      ...
      assertThat(proofOfAuthorizationRequestSubmission.updatedAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(proofOfAuthorizationRequestSubmission.validatedAccountOwnershipViaCredential()).isEqualTo(false)
      assertThat(proofOfAuthorizationRequestSubmission.validatedAccountOwnershipWithAccountStatement()).isEqualTo(false)
