...
class AccountTransferTest {
    ...
    fun createAccountTransfer() {
      ...
      assertThat(accountTransfer.cancellation()).isEqualTo(AccountTransfer.Cancellation.builder()
          ...
          .canceledBy("canceled_by")
          .build())
      assertThat(accountTransfer.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      ...
      assertThat(accountTransfer.destinationTransactionId()).isEqualTo("transaction_j3itv8dtk5o8pw3p1xj4")
