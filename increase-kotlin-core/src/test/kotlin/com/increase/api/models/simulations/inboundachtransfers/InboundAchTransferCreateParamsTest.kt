...
class InboundAchTransferCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = InboundAchTransferCreateParams.builder()
          .accountNumberId("account_number_v18nkfqm6afpsrvy82b2")
          .amount(1000L)
          .companyDescriptiveDate("x")
          .companyDiscretionaryData("x")
      ...
      assertThat(body.standardEntryClassCode()).isEqualTo(InboundAchTransferCreateParams.StandardEntryClassCode.CORPORATE_CREDIT_OR_DEBIT)
    }
