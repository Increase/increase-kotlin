...
internal class PendingTransactionTest {
    ...
    fun create() {
                    ...
                    PendingTransaction.Source.builder()
                        ...
                        .cardAuthorization(
                            PendingTransaction.Source.CardAuthorization.builder()
                                ...
                                .healthcare(
                                    PendingTransaction.Source.CardAuthorization.Healthcare.builder()
                                ...
                                .addSchemeFee(
                                    PendingTransaction.Source.CardAuthorization.SchemeFee.builder()
                                        .amount("0.137465")
                                        .createdAt(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
                                        .currency(
        ...
        assertThat(pendingTransaction.routeId()).isNull()
        assertThat(pendingTransaction.routeType()).isNull()
                ...
                PendingTransaction.Source.builder()
                    ...
                    .sepaInstantTransferInstruction(
                        PendingTransaction.Source.SepaInstantTransferInstruction.builder()
                            .amount(4200L)
                            .currency(
                                PendingTransaction.Source.SepaInstantTransferInstruction.Currency
                                    .EUR
                            )
                            .build()
                    )
                    ...
                    .ukFasterPaymentSystemTransferInstruction(
                        PendingTransaction.Source.UkFasterPaymentSystemTransferInstruction.builder()
                            .amount(12500L)
                            .currency(
                                PendingTransaction.Source.UkFasterPaymentSystemTransferInstruction
                                    .Currency
