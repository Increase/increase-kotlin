...
class CheckDepositTest {
    ...
    fun createCheckDeposit() {
        ...
        assertThat(checkDeposit.description()).isEqualTo("string")
        assertThat(checkDeposit.frontImageFileId()).isEqualTo("string")
        assertThat(checkDeposit.idempotencyKey()).isEqualTo("string")
        assertThat(checkDeposit.inboundMailItemId()).isEqualTo("string")
        assertThat(checkDeposit.lockboxId()).isEqualTo("string")
