...
internal class SwiftTransferListParamsTest {

    @Test
    fun create() {
        SwiftTransferListParams.builder()
            .accountId("account_id")
            .createdAt(
                SwiftTransferListParams.CreatedAt.builder()
            ...
            .limit(1L)
            .status(
                SwiftTransferListParams.Status.builder()
                    .addIn(SwiftTransferListParams.Status.In.PENDING_APPROVAL)
                    .build()
            )
            .build()
    }
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = SwiftTransferListParams.builder().build()
