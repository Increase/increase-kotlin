...
internal class CardPurchaseSupplementListResponseTest {

    @Test
    fun create() {
        val cardPurchaseSupplementListResponse =
            CardPurchaseSupplementListResponse.builder()
                .addData(
        ...
        assertThat(cardPurchaseSupplementListResponse.data())
            .containsExactly(
                CardPurchaseSupplement.builder()
                    .id("card_purchase_supplement_ijuc45iym4jchnh2sfk3")
                    .cardPaymentId("card_payment_nd3k2kacrqjli8482ave")
        ...
        assertThat(cardPurchaseSupplementListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCardPurchaseSupplementListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(cardPurchaseSupplementListResponse),
                jacksonTypeRef<CardPurchaseSupplementListResponse>(),
            )

        assertThat(roundtrippedCardPurchaseSupplementListResponse)
            .isEqualTo(cardPurchaseSupplementListResponse)
    }
}
