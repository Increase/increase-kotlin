...
class SimulationCardAuthorizationCreateResponseTest {
    ...
    fun createSimulationCardAuthorizationCreateResponse() {
      ...
      assertThat(simulationCardAuthorizationCreateResponse.declinedTransaction()).isEqualTo(DeclinedTransaction.builder()
          .id("id")
          .accountId("account_id")
          .amount(123L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .type(DeclinedTransaction.Type.DECLINED_TRANSACTION)
          .build())
      assertThat(simulationCardAuthorizationCreateResponse.pendingTransaction()).isEqualTo(PendingTransaction.builder()
          .id("id")
          .accountId("account_id")
          .amount(123L)
          .completedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
