...
class InboundFundsHoldReleaseResponseTest {
    ...
    fun createInboundFundsHoldReleaseResponse() {
      ...
      assertThat(inboundFundsHoldReleaseResponse.id()).isEqualTo("inbound_funds_hold_9vuasmywdo7xb3zt4071")
      assertThat(inboundFundsHoldReleaseResponse.amount()).isEqualTo(100L)
      assertThat(inboundFundsHoldReleaseResponse.automaticallyReleasesAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(inboundFundsHoldReleaseResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(inboundFundsHoldReleaseResponse.currency()).isEqualTo(InboundFundsHoldReleaseResponse.Currency.CAD)
      assertThat(inboundFundsHoldReleaseResponse.heldTransactionId()).isEqualTo("transaction_uyrp7fld2ium70oa7oi")
      assertThat(inboundFundsHoldReleaseResponse.pendingTransactionId()).isEqualTo("pending_transaction_k1sfetcau2qbvjbzgju4")
