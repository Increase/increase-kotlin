...
internal class TransactionListResponseTest {
    ...
    fun create() {
                            ...
                            Transaction.Source.builder()
                                ...
                                .cardFinancial(
                                    Transaction.Source.CardFinancial.builder()
                                        ...
                                        .actioner(
                                            Transaction.Source.CardFinancial.Actioner.INCREASE
                                        )
                                        .additionalAmounts(
                                        ...
                                        .direction(
                                            Transaction.Source.CardFinancial.Direction.SETTLEMENT
                                        )
                                        ...
                                        .processingCategory(
                                            Transaction.Source.CardFinancial.ProcessingCategory
                                                .PURCHASE
                                        )
        ...
        assertThat(transactionListResponse.nextCursor()).isEqualTo("v57w5d")
    }
