...
internal class PhysicalCardListResponseTest {

    @Test
    fun create() {
        val physicalCardListResponse =
            PhysicalCardListResponse.builder()
                .addData(
        ...
        assertThat(physicalCardListResponse.data())
            .containsExactly(
                PhysicalCard.builder()
                    .id("physical_card_ode8duyq5v2ynhjoharl")
                    .cardId("card_oubs0hwk5rn6knuecxg2")
        ...
        assertThat(physicalCardListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedPhysicalCardListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(physicalCardListResponse),
                jacksonTypeRef<PhysicalCardListResponse>(),
            )

        assertThat(roundtrippedPhysicalCardListResponse).isEqualTo(physicalCardListResponse)
    }
}
