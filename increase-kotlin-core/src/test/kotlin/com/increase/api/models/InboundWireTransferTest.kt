...
class InboundWireTransferTest {
    ...
    fun createInboundWireTransfer() {
      val inboundWireTransfer = InboundWireTransfer.builder()
          .id("id")
      ...
      assertThat(inboundWireTransfer.beneficiaryAddressLine1()).isEqualTo("beneficiary_address_line1")
      assertThat(inboundWireTransfer.beneficiaryAddressLine2()).isEqualTo("beneficiary_address_line2")
      assertThat(inboundWireTransfer.beneficiaryAddressLine3()).isEqualTo("beneficiary_address_line3")
      ...
      assertThat(inboundWireTransfer.inputMessageAccountabilityData()).isEqualTo("input_message_accountability_data")
      assertThat(inboundWireTransfer.originatorAddressLine1()).isEqualTo("originator_address_line1")
      assertThat(inboundWireTransfer.originatorAddressLine2()).isEqualTo("originator_address_line2")
      assertThat(inboundWireTransfer.originatorAddressLine3()).isEqualTo("originator_address_line3")
      assertThat(inboundWireTransfer.originatorName()).isEqualTo("originator_name")
      assertThat(inboundWireTransfer.originatorRoutingNumber()).isEqualTo("originator_routing_number")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformation()).isEqualTo("originator_to_beneficiary_information")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformationLine1()).isEqualTo("originator_to_beneficiary_information_line1")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformationLine2()).isEqualTo("originator_to_beneficiary_information_line2")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformationLine3()).isEqualTo("originator_to_beneficiary_information_line3")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformationLine4()).isEqualTo("originator_to_beneficiary_information_line4")
      ...
      assertThat(inboundWireTransfer.type()).isEqualTo(InboundWireTransfer.Type.INBOUND_WIRE_TRANSFER)
    }
}
