...
import com.increase.api.models.SimulationInboundWireTransferCreateParams.SimulationInboundWireTransferCreateBody
...
class SimulationInboundWireTransferCreateParamsTest {
    ...
    @Test
    fun getBody() {
      val params = SimulationInboundWireTransferCreateParams.builder()
          .accountNumberId("account_number_id")
          .amount(123L)
          .beneficiaryAddressLine1("x")
          .beneficiaryAddressLine2("x")
