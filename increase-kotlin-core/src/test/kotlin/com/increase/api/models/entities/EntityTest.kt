...
class EntityTest {
    ...
    fun createEntity() {
      val entity = Entity.builder()
          ...
          .corporation(Entity.Corporation.builder()
              .address(Entity.Corporation.Address.builder()
                  ...
                  .zip("10045")
                  .build())
              .addBeneficialOwner(Entity.Corporation.BeneficialOwner.builder()
          ...
          .governmentAuthority(Entity.GovernmentAuthority.builder()
              .address(Entity.GovernmentAuthority.Address.builder()
                  ...
                  .zip("10045")
                  .build())
              .addAuthorizedPerson(Entity.GovernmentAuthority.AuthorizedPerson.builder()
          ...
          .joint(Entity.Joint.builder()
              .addIndividual(Entity.Joint.Individual.builder()
          ...
          .addSupplementalDocument(EntitySupplementalDocument.builder()
              .createdAt(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
              ...
              .build())
          .thirdPartyVerification(Entity.ThirdPartyVerification.builder()
              .reference("reference")
          ...
          .trust(Entity.Trust.builder()
              ...
              .name("name")
              .taxIdentifier("tax_identifier")
              .addTrustee(Entity.Trust.Trustee.builder()
      ...
      assertThat(entity.supplementalDocuments()).containsExactly(EntitySupplementalDocument.builder()
          ...
          .type(EntitySupplementalDocument.Type.ENTITY_SUPPLEMENTAL_DOCUMENT)
          .build())
      assertThat(entity.thirdPartyVerification()).isEqualTo(Entity.ThirdPartyVerification.builder()
          .reference("reference")
          .vendor(Entity.ThirdPartyVerification.Vendor.ALLOY)
          .build())
