...
internal class DeclinedTransactionTest {
                ...
                DeclinedTransaction.Source.builder()
                    ...
                    .cardDecline(
                        DeclinedTransaction.Source.CardDecline.builder()
                            ...
                            .actioner(DeclinedTransaction.Source.CardDecline.Actioner.INCREASE)
                            .additionalAmounts(
                                DeclinedTransaction.Source.CardDecline.AdditionalAmounts.builder()
                                    .clinic(
                                        DeclinedTransaction.Source.CardDecline.AdditionalAmounts
                                            .Clinic
                                            .builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedDeclinedTransaction =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(declinedTransaction),
                jacksonTypeRef<DeclinedTransaction>(),
            )

        assertThat(roundtrippedDeclinedTransaction).isEqualTo(declinedTransaction)
    }
}
