...
class InboundWireDrawdownRequestTest {
    ...
    fun createInboundWireDrawdownRequest() {
      ...
      assertThat(inboundWireDrawdownRequest.id()).isEqualTo("inbound_wire_drawdown_request_u5a92ikqhz1ytphn799e")
      ...
      assertThat(inboundWireDrawdownRequest.beneficiaryAddressLine1()).isEqualTo("33 Liberty Street")
      assertThat(inboundWireDrawdownRequest.beneficiaryAddressLine2()).isEqualTo("New York, NY, 10045")
      ...
      assertThat(inboundWireDrawdownRequest.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      ...
      assertThat(inboundWireDrawdownRequest.originatorAddressLine1()).isEqualTo("33 Liberty Street")
      assertThat(inboundWireDrawdownRequest.originatorAddressLine2()).isEqualTo("New York, NY, 10045")
      ...
      assertThat(inboundWireDrawdownRequest.recipientAccountNumberId()).isEqualTo("account_number_v18nkfqm6afpsrvy82b2")
