...
internal class WireTransferListResponseTest {

    @Test
    fun create() {
        val wireTransferListResponse =
            WireTransferListResponse.builder()
                .addData(
        ...
        assertThat(wireTransferListResponse.data())
            .containsExactly(
                WireTransfer.builder()
                    .id("wire_transfer_5akynk7dqsq25qwk9q2u")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(wireTransferListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedWireTransferListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(wireTransferListResponse),
                jacksonTypeRef<WireTransferListResponse>(),
            )

        assertThat(roundtrippedWireTransferListResponse).isEqualTo(wireTransferListResponse)
    }
}
