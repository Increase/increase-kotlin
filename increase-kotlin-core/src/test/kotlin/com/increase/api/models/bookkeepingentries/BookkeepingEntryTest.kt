...
class BookkeepingEntryTest {
    ...
    fun createBookkeepingEntry() {
      ...
      assertThat(bookkeepingEntry.accountId()).isEqualTo("bookkeeping_account_e37p1f1iuocw5intf35v")
      assertThat(bookkeepingEntry.amount()).isEqualTo(1750L)
      assertThat(bookkeepingEntry.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(bookkeepingEntry.entrySetId()).isEqualTo("bookkeeping_entry_set_n80c6wr2p8gtc6p4ingf")
