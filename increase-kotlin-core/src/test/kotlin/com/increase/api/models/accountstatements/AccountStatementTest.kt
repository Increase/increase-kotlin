...
internal class AccountStatementTest {
    ...
    fun create() {
        ...
        assertThat(accountStatement.loan())
            .isEqualTo(
                AccountStatement.Loan.builder()
                    .dueAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .dueBalance(0L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAccountStatement =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(accountStatement),
                jacksonTypeRef<AccountStatement>(),
            )

        assertThat(roundtrippedAccountStatement).isEqualTo(accountStatement)
    }
}
