...
class AccountStatementTest {
    ...
    fun createAccountStatement() {
      ...
      assertThat(accountStatement.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      ...
      assertThat(accountStatement.statementPeriodEnd()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(accountStatement.statementPeriodStart()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
