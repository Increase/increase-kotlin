...
class ExportListParamsTest {
    ...
    fun create() {
      ExportListParams.builder()
          .category(ExportListParams.Category.builder()
              .addIn(ExportListParams.Category.In.ACCOUNT_STATEMENT_OFX)
              .build())
          .createdAt(ExportListParams.CreatedAt.builder()
          ...
          .idempotencyKey("x")
          .limit(1L)
          .status(ExportListParams.Status.builder()
    ...
    @Test
    fun queryParams() {
      val params = ExportListParams.builder()
          .category(ExportListParams.Category.builder()
              .addIn(ExportListParams.Category.In.ACCOUNT_STATEMENT_OFX)
              .build())
          .createdAt(ExportListParams.CreatedAt.builder()
