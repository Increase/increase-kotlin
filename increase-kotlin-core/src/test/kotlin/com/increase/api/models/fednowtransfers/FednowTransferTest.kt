    ...
    fun create() {
        val fednowTransfer =
            FednowTransfer.builder()
                ...
                .debtorAddress(
                    FednowTransfer.DebtorAddress.builder()
                        .city("New York")
                        .line1("33 Liberty Street")
                        .postalCode("10045")
                        .state("NY")
                ...
                .addReturn(
                    FednowTransfer.Return.builder()
                        ...
                        .returnReasonCode(FednowTransfer.Return.ReturnReasonCode.UNABLE_TO_APPLY)
        ...
        assertThat(fednowTransfer.debtorAddress())
            .isEqualTo(
                FednowTransfer.DebtorAddress.builder()
                    .city("New York")
                    .line1("33 Liberty Street")
        ...
        assertThat(fednowTransfer.returns())
            .containsExactly(
                FednowTransfer.Return.builder()
                    .amount(100L)
                    .returnReasonAdditionalInformation(null)
