...
internal class CheckTransferListResponseTest {

    @Test
    fun create() {
        val checkTransferListResponse =
            CheckTransferListResponse.builder()
                .addData(
        ...
        assertThat(checkTransferListResponse.data())
            .containsExactly(
                CheckTransfer.builder()
                    .id("check_transfer_30b43acfu9vw8fyc4f5")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(checkTransferListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCheckTransferListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(checkTransferListResponse),
                jacksonTypeRef<CheckTransferListResponse>(),
            )

        assertThat(roundtrippedCheckTransferListResponse).isEqualTo(checkTransferListResponse)
    }
}
