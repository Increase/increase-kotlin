...
internal class CardPaymentTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedCardPayment =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(cardPayment),
                jacksonTypeRef<CardPayment>(),
            )

        assertThat(roundtrippedCardPayment).isEqualTo(cardPayment)
    }
}
