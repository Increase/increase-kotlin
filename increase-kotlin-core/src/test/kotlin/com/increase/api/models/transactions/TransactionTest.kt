            ...
            Transaction.builder()
                ...
                .source(
                    Transaction.Source.builder()
                            ...
                            Transaction.Source.CardDisputeFinancial.builder()
                                ...
                                .visa(
                                    Transaction.Source.CardDisputeFinancial.Visa.builder()
                                        .eventType(
                                            Transaction.Source.CardDisputeFinancial.Visa.EventType
                        ...
                        .cardFinancial(
                            Transaction.Source.CardFinancial.builder()
                                .id("card_financial_di5b98i72ppomo268zfk")
                                .actioner(Transaction.Source.CardFinancial.Actioner.INCREASE)
                                .additionalAmounts(
                                    Transaction.Source.CardFinancial.AdditionalAmounts.builder()
                                        .clinic(
                                ...
                                .currency(Transaction.Source.CardFinancial.Currency.USD)
                                .digitalWalletTokenId(null)
                                .direction(Transaction.Source.CardFinancial.Direction.SETTLEMENT)
                                ...
                                .merchantState("NY")
                                .networkDetails(
                                    Transaction.Source.CardFinancial.NetworkDetails.builder()
                                        .category(
                                ...
                                .networkIdentifiers(
                                    Transaction.Source.CardFinancial.NetworkIdentifiers.builder()
                                ...
                                .addSchemeFee(
                                    Transaction.Source.CardFinancial.SchemeFee.builder()
                                        ...
                                        .createdAt(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
                                        .currency(
                                            Transaction.Source.CardFinancial.SchemeFee.Currency.USD
                                        )
                                        .feeType(
                                ...
                                .verification(
                                    Transaction.Source.CardFinancial.Verification.builder()
                            ...
                            Transaction.Source.CardSettlement.builder()
                                ...
                                .purchaseDetails(
                                    Transaction.Source.CardSettlement.PurchaseDetails.builder()
                                        ...
                                        .customerReferenceIdentifier("51201")
                                        .fleet(
                                            Transaction.Source.CardSettlement.PurchaseDetails.Fleet
                                                .builder()
                                                .employeeNumber("employee_number")
                                                .fuelQuantity("-16699")
                                                .fuelType(
                                ...
                                .addSchemeFee(
                                    Transaction.Source.CardSettlement.SchemeFee.builder()
                                        ...
                                        .createdAt(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
                                        .currency(
                                            Transaction.Source.CardSettlement.SchemeFee.Currency.USD
                                        )
                                        .feeType(
                    ...
                    .cardFinancial(
                        Transaction.Source.CardFinancial.builder()
                            ...
                            .additionalAmounts(
                                Transaction.Source.CardFinancial.AdditionalAmounts.builder()
                                    .clinic(
                                        Transaction.Source.CardFinancial.AdditionalAmounts.Clinic
                                            .builder()
                                            .amount(0L)
                                            .currency("currency")
                                            .build()
                                    ...
                                    .dental(
                                        Transaction.Source.CardFinancial.AdditionalAmounts.Dental
                                            .builder()
                                            .amount(0L)
                                            .currency("currency")
                                            .build()
                                    ...
                                    .surcharge(
                                        Transaction.Source.CardFinancial.AdditionalAmounts.Surcharge
                                            .builder()
                                            .amount(10L)
                                            .currency("USD")
                                            .build()
                                    ...
                                    .transit(
                                        Transaction.Source.CardFinancial.AdditionalAmounts.Transit
                                            .builder()
                                            .amount(0L)
                                            .currency("currency")
                                            .build()
                                    ...
                                    .unknown(
                                        Transaction.Source.CardFinancial.AdditionalAmounts.Unknown
                                            .builder()
                                            .amount(0L)
                                            .currency("currency")
                                            .build()
                                    ...
                                    .vision(
                                        Transaction.Source.CardFinancial.AdditionalAmounts.Vision
                                            .builder()
                                            .amount(0L)
                                            .currency("currency")
                                            .build()
                        ...
                        Transaction.Source.CardRefund.builder()
                            ...
                            .addSchemeFee(
                                Transaction.Source.CardRefund.SchemeFee.builder()
                                    .amount("0.137465")
                                    .createdAt(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
                                    .currency(Transaction.Source.CardRefund.SchemeFee.Currency.USD)
                                    .feeType(
                                        Transaction.Source.CardRefund.SchemeFee.FeeType
                                            .VISA_CORPORATE_ACCEPTANCE_FEE
                                    )
