...
class AchTransferTest {
    ...
    fun createAchTransfer() {
      val achTransfer = AchTransfer.builder()
          ...
          .addenda(AchTransfer.Addenda.builder()
              ...
              .freeform(AchTransfer.Addenda.Freeform.builder()
                  .entries(listOf(AchTransfer.Addenda.Freeform.Entry.builder()
              ...
              .paymentOrderRemittanceAdvice(AchTransfer.Addenda.PaymentOrderRemittanceAdvice.builder()
                  .invoices(listOf(AchTransfer.Addenda.PaymentOrderRemittanceAdvice.Invoice.builder()
          ...
          .notificationsOfChange(listOf(AchTransfer.NotificationsOfChange.builder()
      ...
      assertThat(achTransfer.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
