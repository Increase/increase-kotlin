...
internal class CardDisputeListResponseTest {

    @Test
    fun create() {
        val cardDisputeListResponse =
            CardDisputeListResponse.builder()
                .addData(
                    CardDispute.builder()
                            ...
                            CardDispute.Visa.builder()
                                .addNetworkEvent(
                                    CardDispute.Visa.NetworkEvent.builder()
                                        ...
                                        .chargebackSubmitted(
                                            CardDispute.Visa.NetworkEvent.ChargebackSubmitted
                                                .builder()
                                                .build()
                                        )
                                        .chargebackTimedOut(
                                        ...
                                        .representmentTimedOut(
                                            CardDispute.Visa.NetworkEvent.RepresentmentTimedOut
                                                .builder()
                                                .build()
                                        )
                                        ...
                                        .userWithdrawalSubmitted(
                                            CardDispute.Visa.NetworkEvent.UserWithdrawalSubmitted
                                                .builder()
                                                .build()
                                        )
                                        .build()
                                            ...
                                            CardDispute.Visa.UserSubmission.UserPrearbitration
                                                ...
                                                .categoryChange(
                                                    CardDispute.Visa.UserSubmission
                                                        ...
                                                        .reason(
                                                            "Based on the response from the merchant."
                                                        )
                                                        .build()
                                                )
                                                .reason(
        ...
        assertThat(cardDisputeListResponse.data())
            .containsExactly(
                CardDispute.builder()
                    .id("card_dispute_h9sc95nbl1cgltpp7men")
                    .amount(1000L)
        ...
        assertThat(cardDisputeListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCardDisputeListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(cardDisputeListResponse),
                jacksonTypeRef<CardDisputeListResponse>(),
            )

        assertThat(roundtrippedCardDisputeListResponse).isEqualTo(cardDisputeListResponse)
    }
}
