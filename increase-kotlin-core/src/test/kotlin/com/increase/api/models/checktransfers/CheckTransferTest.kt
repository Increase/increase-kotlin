    ...
    fun createCheckTransfer() {
      val checkTransfer = CheckTransfer.builder()
          ...
          .physicalCheck(CheckTransfer.PhysicalCheck.builder()
              ...
              .signatureText(null)
              .addTrackingUpdate(CheckTransfer.PhysicalCheck.TrackingUpdate.builder()
                  .category(CheckTransfer.PhysicalCheck.TrackingUpdate.Category.IN_TRANSIT)
      ...
      assertThat(checkTransfer.approval()).isEqualTo(CheckTransfer.Approval.builder()
          .approvedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .approvedBy("approved_by")
          .build())
      assertThat(checkTransfer.approvedInboundCheckDepositId()).isEqualTo("inbound_check_deposit_zoshvqybq0cjjm31mra")
      assertThat(checkTransfer.cancellation()).isEqualTo(CheckTransfer.Cancellation.builder()
          .canceledAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .canceledBy("canceled_by")
          .build())
      assertThat(checkTransfer.checkNumber()).isEqualTo("123")
      assertThat(checkTransfer.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      assertThat(checkTransfer.createdBy()).isEqualTo(CheckTransfer.CreatedBy.builder()
          .apiKey(CheckTransfer.CreatedBy.ApiKey.builder()
              .description("description")
              .build())
          .category(CheckTransfer.CreatedBy.Category.API_KEY)
      ...
      assertThat(checkTransfer.mailing()).isEqualTo(CheckTransfer.Mailing.builder()
          .imageId(null)
          .mailedAt(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
          .trackingNumber(null)
          .build())
      assertThat(checkTransfer.pendingTransactionId()).isEqualTo("pending_transaction_k1sfetcau2qbvjbzgju4")
      assertThat(checkTransfer.physicalCheck()).isEqualTo(CheckTransfer.PhysicalCheck.builder()
          .mailingAddress(CheckTransfer.PhysicalCheck.MailingAddress.builder()
              .city("New York")
              .line1("33 Liberty Street")
              .line2(null)
      ...
      assertThat(checkTransfer.sourceAccountNumberId()).isEqualTo("account_number_v18nkfqm6afpsrvy82b2")
      assertThat(checkTransfer.status()).isEqualTo(CheckTransfer.Status.PENDING_APPROVAL)
      assertThat(checkTransfer.stopPaymentRequest()).isEqualTo(CheckTransfer.StopPaymentRequest.builder()
          .reason(CheckTransfer.StopPaymentRequest.Reason.MAIL_DELIVERY_FAILED)
          .requestedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .transferId("transfer_id")
          .type(CheckTransfer.StopPaymentRequest.Type.CHECK_TRANSFER_STOP_PAYMENT_REQUEST)
          .build())
      assertThat(checkTransfer.submission()).isEqualTo(CheckTransfer.Submission.builder()
          .submittedAt(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
          .build())
      assertThat(checkTransfer.thirdParty()).isEqualTo(CheckTransfer.ThirdParty.builder()
          .checkNumber("check_number")
          .build())
