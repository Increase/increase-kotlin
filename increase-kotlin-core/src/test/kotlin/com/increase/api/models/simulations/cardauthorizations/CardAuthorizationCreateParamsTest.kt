...
class CardAuthorizationCreateParamsTest {
    ...
    fun create() {
      CardAuthorizationCreateParams.builder()
          ...
          .merchantState("NY")
          .networkDetails(CardAuthorizationCreateParams.NetworkDetails.builder()
              .visa(CardAuthorizationCreateParams.NetworkDetails.Visa.builder()
                  .standInProcessingReason(CardAuthorizationCreateParams.NetworkDetails.Visa.StandInProcessingReason.ISSUER_ERROR)
                  .build())
              .build())
    ...
    @Test
    fun body() {
      val params = CardAuthorizationCreateParams.builder()
          .amount(1000L)
          .authenticatedCardPaymentId("authenticated_card_payment_id")
          .cardId("card_oubs0hwk5rn6knuecxg2")
          .declineReason(CardAuthorizationCreateParams.DeclineReason.ACCOUNT_CLOSED)
      ...
      assertThat(body.declineReason()).isEqualTo(CardAuthorizationCreateParams.DeclineReason.ACCOUNT_CLOSED)
      ...
      assertThat(body.eventSubscriptionId()).isEqualTo("event_subscription_001dzz0r20rcdxgb013zqb8m04g")
      ...
      assertThat(body.networkDetails()).isEqualTo(CardAuthorizationCreateParams.NetworkDetails.builder()
          .visa(CardAuthorizationCreateParams.NetworkDetails.Visa.builder()
              .standInProcessingReason(CardAuthorizationCreateParams.NetworkDetails.Visa.StandInProcessingReason.ISSUER_ERROR)
              .build())
          .build())
