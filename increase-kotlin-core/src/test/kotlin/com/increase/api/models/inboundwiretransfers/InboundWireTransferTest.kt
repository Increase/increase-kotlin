...
internal class InboundWireTransferTest {
    ...
    fun create() {
            ...
            InboundWireTransfer.builder()
                ...
                .acceptance(
                    InboundWireTransfer.Acceptance.builder()
                        .acceptedAt(OffsetDateTime.parse("2020-01-31T14:00:01Z"))
        ...
        assertThat(inboundWireTransfer.creditorAddressLine1()).isEqualTo("33 Liberty Street")
        assertThat(inboundWireTransfer.creditorAddressLine2()).isEqualTo("New York, NY, 10045")
        assertThat(inboundWireTransfer.creditorAddressLine3()).isNull()
        assertThat(inboundWireTransfer.creditorName()).isEqualTo("National Phonograph Company")
        assertThat(inboundWireTransfer.debtorAccountNumber()).isEqualTo("987654321")
        assertThat(inboundWireTransfer.debtorAddressLine1()).isEqualTo("33 Liberty Street")
        assertThat(inboundWireTransfer.debtorAddressLine2()).isEqualTo("New York, NY, 10045")
        assertThat(inboundWireTransfer.debtorAddressLine3()).isNull()
        assertThat(inboundWireTransfer.debtorName()).isEqualTo("Ian Crease")
        assertThat(inboundWireTransfer.debtorRoutingNumber()).isEqualTo("101050001")
        assertThat(inboundWireTransfer.description()).isEqualTo("Inbound wire transfer")
        assertThat(inboundWireTransfer.endToEndIdentification()).isEqualTo("Invoice 29582")
        assertThat(inboundWireTransfer.inputMessageAccountabilityData())
            .isEqualTo("20220118MMQFMP0P000001")
        assertThat(inboundWireTransfer.instructingAgentRoutingNumber()).isEqualTo("101050001")
        assertThat(inboundWireTransfer.instructionForCreditorAgent()).isNull()
        assertThat(inboundWireTransfer.instructionIdentification()).isEqualTo("202201180000001")
        assertThat(inboundWireTransfer.purpose()).isEqualTo("CASH")
