...
class InboundWireTransferTest {
    ...
    fun createInboundWireTransfer() {
      ...
      assertThat(inboundWireTransfer.accountNumberId()).isEqualTo("account_number_v18nkfqm6afpsrvy82b2")
      ...
      assertThat(inboundWireTransfer.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
