...
internal class DigitalWalletTokenTest {
    ...
    fun create() {
        val digitalWalletToken =
            DigitalWalletToken.builder()
                ...
                .dynamicPrimaryAccountNumber(
                    DigitalWalletToken.DynamicPrimaryAccountNumber.builder()
                        .first6("first6")
                        .last4("last4")
                        .build()
                )
        ...
        assertThat(digitalWalletToken.dynamicPrimaryAccountNumber())
            .isEqualTo(
                DigitalWalletToken.DynamicPrimaryAccountNumber.builder()
                    .first6("first6")
                    .last4("last4")
        ...
        assertThat(digitalWalletToken.primaryAccountNumberReferenceIdentifier())
            .isEqualTo("V-0000000000000000000000")
        assertThat(digitalWalletToken.status()).isEqualTo(DigitalWalletToken.Status.ACTIVE)
        assertThat(digitalWalletToken.tokenReferenceIdentifier())
