...
class DigitalWalletTokenTest {
    ...
    fun createDigitalWalletToken() {
      val digitalWalletToken = DigitalWalletToken.builder()
          ...
          .addUpdate(DigitalWalletToken.Update.builder()
      ...
      assertThat(digitalWalletToken.createdAt()).isEqualTo(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
      ...
      assertThat(digitalWalletToken.updates()).containsExactly(DigitalWalletToken.Update.builder()
          .status(DigitalWalletToken.Update.Status.ACTIVE)
          .timestamp(OffsetDateTime.parse("2020-01-31T23:59:59Z"))
          .build())
    }
