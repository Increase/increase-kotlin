                ...
                EntityCreateParams.Corporation.builder()
                    ...
                    .addBeneficialOwner(
                        EntityCreateParams.Corporation.BeneficialOwner.builder()
                            .individual(
                                EntityCreateParams.Corporation.BeneficialOwner.Individual.builder()
                                    .address(
                        ...
                        EntityCreateParams.Joint.Individual.builder()
                            ...
                            .identification(
                                EntityCreateParams.Joint.Individual.Identification.builder()
                                    .method(
                                        EntityCreateParams.Joint.Individual.Identification.Method
                                            .SOCIAL_SECURITY_NUMBER
                                    )
                                    .number("xxxx")
                                    .driversLicense(
                                    ...
                                    .passport(
                                        EntityCreateParams.Joint.Individual.Identification.Passport
                                            .builder()
                                            .country("x")
                                            .expirationDate(LocalDate.parse("2019-12-27"))
                                            .fileId("file_id")
                        ...
                        EntityCreateParams.Trust.Trustee.builder()
                            ...
                            .individual(
                                EntityCreateParams.Trust.Trustee.Individual.builder()
                                    ...
                                    .dateOfBirth(LocalDate.parse("2019-12-27"))
                                    .identification(
                                        EntityCreateParams.Trust.Trustee.Individual.Identification
                                            .builder()
                                            .method(
