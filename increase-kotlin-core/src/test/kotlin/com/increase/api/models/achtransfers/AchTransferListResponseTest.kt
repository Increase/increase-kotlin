...
internal class AchTransferListResponseTest {

    @Test
    fun create() {
        val achTransferListResponse =
            AchTransferListResponse.builder()
                .addData(
                    AchTransfer.builder()
        ...
        assertThat(achTransferListResponse.data())
            .containsExactly(
                AchTransfer.builder()
                    .id("ach_transfer_uoxatyh3lt5evrsdvo7q")
                    .accountId("account_in71c4amph0vgo2qllky")
        ...
        assertThat(achTransferListResponse.nextCursor()).isEqualTo("v57w5d")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedAchTransferListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(achTransferListResponse),
                jacksonTypeRef<AchTransferListResponse>(),
            )

        assertThat(roundtrippedAchTransferListResponse).isEqualTo(achTransferListResponse)
    }
}
