...
class CardIncrementServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CardIncrementService {

    private val withRawResponse: CardIncrementService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CardIncrementService.WithRawResponse = withRawResponse

    override fun create(params: CardIncrementCreateParams, requestOptions: RequestOptions): CardPayment =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CardIncrementCreateParams, requestOptions: RequestOptions): HttpResponseFor<CardPayment> {
