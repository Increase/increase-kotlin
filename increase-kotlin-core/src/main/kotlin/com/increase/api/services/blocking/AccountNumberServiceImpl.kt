...
class AccountNumberServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AccountNumberService {

    private val withRawResponse: AccountNumberService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: AccountNumberCreateParams, requestOptions: RequestOptions): HttpResponseFor<AccountNumber> {
        ...
        override fun retrieve(params: AccountNumberRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<AccountNumber> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: AccountNumberUpdateParams, requestOptions: RequestOptions): HttpResponseFor<AccountNumber> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<AccountNumberListPage.Response> = jsonHandler<AccountNumberListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: AccountNumberListParams, requestOptions: RequestOptions): HttpResponseFor<AccountNumberListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("account_numbers")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  AccountNumberListPage.of(AccountNumberServiceImpl(clientOptions), params, it)
              }
          }
        }
    }
