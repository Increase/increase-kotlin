...
class DocumentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : DocumentServiceAsync {
    ...
    override suspend fun create(params: SimulationDocumentCreateParams, requestOptions: RequestOptions): Document {
