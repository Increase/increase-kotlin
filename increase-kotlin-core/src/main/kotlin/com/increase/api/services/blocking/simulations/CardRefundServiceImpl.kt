...
class CardRefundServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CardRefundService {

    private val withRawResponse: CardRefundService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CardRefundService.WithRawResponse = withRawResponse

    override fun create(params: CardRefundCreateParams, requestOptions: RequestOptions): Transaction =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CardRefundCreateParams, requestOptions: RequestOptions): HttpResponseFor<Transaction> {
