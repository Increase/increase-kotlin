...
class CheckTransferServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: CheckTransferCreateParams, requestOptions: RequestOptions): HttpResponseFor<CheckTransfer> {
        ...
        override suspend fun retrieve(params: CheckTransferRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CheckTransfer> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<CheckTransferListPageAsync.Response> = jsonHandler<CheckTransferListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: CheckTransferListParams, requestOptions: RequestOptions): HttpResponseFor<CheckTransferListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("check_transfers")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  CheckTransferListPageAsync.of(CheckTransferServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override suspend fun approve(params: CheckTransferApproveParams, requestOptions: RequestOptions): HttpResponseFor<CheckTransfer> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun cancel(params: CheckTransferCancelParams, requestOptions: RequestOptions): HttpResponseFor<CheckTransfer> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun stopPayment(params: CheckTransferStopPaymentParams, requestOptions: RequestOptions): HttpResponseFor<CheckTransfer> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
