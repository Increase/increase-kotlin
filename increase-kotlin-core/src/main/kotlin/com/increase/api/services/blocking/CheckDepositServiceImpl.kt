...
class CheckDepositServiceImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CheckDepositCreateParams, requestOptions: RequestOptions): HttpResponseFor<CheckDeposit> {
        ...
        override fun retrieve(params: CheckDepositRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CheckDeposit> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<CheckDepositListPage.Response> = jsonHandler<CheckDepositListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: CheckDepositListParams, requestOptions: RequestOptions): HttpResponseFor<CheckDepositListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("check_deposits")
            .build()
