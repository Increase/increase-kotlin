...
interface CardDisputeService {
     ...
     */
    fun action(params: CardDisputeActionParams, requestOptions: RequestOptions = RequestOptions.none()): CardDispute
    ...
    interface WithRawResponse {
         ...
         * same as [CardDisputeService.action].
         */
        @MustBeClosed
        fun action(params: CardDisputeActionParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CardDispute>
    }
}
