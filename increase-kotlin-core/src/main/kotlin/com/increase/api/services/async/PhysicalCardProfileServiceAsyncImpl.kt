...
class PhysicalCardProfileServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: PhysicalCardProfileCreateParams, requestOptions: RequestOptions): HttpResponseFor<PhysicalCardProfile> {
        ...
        override suspend fun retrieve(params: PhysicalCardProfileRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<PhysicalCardProfile> {
          val request = HttpRequest.builder()
        ...
        override suspend fun list(params: PhysicalCardProfileListParams, requestOptions: RequestOptions): HttpResponseFor<PhysicalCardProfileListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("physical_card_profiles")
            .build()
        ...
        override suspend fun archive(params: PhysicalCardProfileArchiveParams, requestOptions: RequestOptions): HttpResponseFor<PhysicalCardProfile> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun clone(params: PhysicalCardProfileCloneParams, requestOptions: RequestOptions): HttpResponseFor<PhysicalCardProfile> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
