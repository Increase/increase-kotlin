...
class CardPurchaseSupplementServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CardPurchaseSupplementService {

    private val withRawResponse: CardPurchaseSupplementService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: CardPurchaseSupplementRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CardPurchaseSupplement> {
        ...
        private val listHandler: Handler<CardPurchaseSupplementListPage.Response> = jsonHandler<CardPurchaseSupplementListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: CardPurchaseSupplementListParams, requestOptions: RequestOptions): HttpResponseFor<CardPurchaseSupplementListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return response.parseable {
              ...
              .let {
                  CardPurchaseSupplementListPage.of(CardPurchaseSupplementServiceImpl(clientOptions), params, it)
              }
          }
        }
    }
