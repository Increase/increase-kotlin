...
class ExportServiceImpl internal constructor(
    ...
    private val withRawResponse: ExportService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: ExportCreateParams, requestOptions: RequestOptions): HttpResponseFor<Export> {
        ...
        override fun retrieve(params: ExportRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Export> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<ExportListPage.Response> = jsonHandler<ExportListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: ExportListParams, requestOptions: RequestOptions): HttpResponseFor<ExportListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("exports")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  ExportListPage.of(ExportServiceImpl(clientOptions), params, it)
              }
          }
        }
    }
