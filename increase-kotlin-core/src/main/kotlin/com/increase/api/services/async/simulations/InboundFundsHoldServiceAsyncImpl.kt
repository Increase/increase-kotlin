...
class InboundFundsHoldServiceAsyncImpl internal constructor(
    ...
    override suspend fun release(params: InboundFundsHoldReleaseParams, requestOptions: RequestOptions): InboundFundsHoldReleaseResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun release(params: InboundFundsHoldReleaseParams, requestOptions: RequestOptions): HttpResponseFor<InboundFundsHoldReleaseResponse> {
