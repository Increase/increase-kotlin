...
class CardReversalServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CardReversalService {

    private val withRawResponse: CardReversalService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CardReversalService.WithRawResponse = withRawResponse

    override fun create(params: CardReversalCreateParams, requestOptions: RequestOptions): CardPayment =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CardReversalCreateParams, requestOptions: RequestOptions): HttpResponseFor<CardPayment> {
