...
class RealTimePaymentsTransferServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: RealTimePaymentsTransferCreateParams, requestOptions: RequestOptions): HttpResponseFor<RealTimePaymentsTransfer> {
        ...
        override suspend fun retrieve(params: RealTimePaymentsTransferRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<RealTimePaymentsTransfer> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<RealTimePaymentsTransferListPageAsync.Response> = jsonHandler<RealTimePaymentsTransferListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: RealTimePaymentsTransferListParams, requestOptions: RequestOptions): HttpResponseFor<RealTimePaymentsTransferListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("real_time_payments_transfers")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  RealTimePaymentsTransferListPageAsync.of(RealTimePaymentsTransferServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
    }
