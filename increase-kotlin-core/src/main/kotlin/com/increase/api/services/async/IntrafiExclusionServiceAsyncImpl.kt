...
class IntrafiExclusionServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : IntrafiExclusionServiceAsync {
    ...
    override suspend fun list(params: IntrafiExclusionListParams, requestOptions: RequestOptions): IntrafiExclusionListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              IntrafiExclusionListPageAsync.of(this, params, it)
          }
      }
    }
