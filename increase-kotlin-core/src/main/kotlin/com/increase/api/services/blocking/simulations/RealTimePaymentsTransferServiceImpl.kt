...
class RealTimePaymentsTransferServiceImpl internal constructor(
    ...
    override fun complete(params: RealTimePaymentsTransferCompleteParams, requestOptions: RequestOptions): RealTimePaymentsTransfer =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun complete(params: RealTimePaymentsTransferCompleteParams, requestOptions: RequestOptions): HttpResponseFor<RealTimePaymentsTransfer> {
