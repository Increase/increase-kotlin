...
class SimulationServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SimulationServiceAsync {

    private val withRawResponse: SimulationServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    private val inboundMailItems: InboundMailItemServiceAsync by lazy { InboundMailItemServiceAsyncImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val interestPayments: InterestPaymentServiceAsync.WithRawResponse by lazy { InterestPaymentServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val cardAuthorizations: CardAuthorizationServiceAsync.WithRawResponse by lazy { CardAuthorizationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val cardAuthorizationExpirations: CardAuthorizationExpirationServiceAsync.WithRawResponse by lazy { CardAuthorizationExpirationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val cardSettlements: CardSettlementServiceAsync.WithRawResponse by lazy { CardSettlementServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val cardReversals: CardReversalServiceAsync.WithRawResponse by lazy { CardReversalServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val cardIncrements: CardIncrementServiceAsync.WithRawResponse by lazy { CardIncrementServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val cardFuelConfirmations: CardFuelConfirmationServiceAsync.WithRawResponse by lazy { CardFuelConfirmationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val cardRefunds: CardRefundServiceAsync.WithRawResponse by lazy { CardRefundServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        private val digitalWalletTokenRequests: DigitalWalletTokenRequestServiceAsync.WithRawResponse by lazy { DigitalWalletTokenRequestServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val inboundFundsHolds: InboundFundsHoldServiceAsync.WithRawResponse by lazy { InboundFundsHoldServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun interestPayments(): InterestPaymentServiceAsync.WithRawResponse = interestPayments

        override fun cardAuthorizations(): CardAuthorizationServiceAsync.WithRawResponse = cardAuthorizations

        override fun cardAuthorizationExpirations(): CardAuthorizationExpirationServiceAsync.WithRawResponse = cardAuthorizationExpirations
        ...
        override fun cardFuelConfirmations(): CardFuelConfirmationServiceAsync.WithRawResponse = cardFuelConfirmations
        ...
        override fun digitalWalletTokenRequests(): DigitalWalletTokenRequestServiceAsync.WithRawResponse = digitalWalletTokenRequests

        override fun inboundFundsHolds(): InboundFundsHoldServiceAsync.WithRawResponse = inboundFundsHolds
