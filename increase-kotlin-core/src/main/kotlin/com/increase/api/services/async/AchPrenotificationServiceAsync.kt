...
interface AchPrenotificationServiceAsync {
    ...
    suspend fun list(params: AchPrenotificationListParams = AchPrenotificationListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): AchPrenotificationListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): AchPrenotificationListPageAsync = list(AchPrenotificationListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: AchPrenotificationCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AchPrenotification>
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: AchPrenotificationRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AchPrenotification>
         ...
         */
        @MustBeClosed
        suspend fun list(params: AchPrenotificationListParams = AchPrenotificationListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AchPrenotificationListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<AchPrenotificationListPageAsync> = list(AchPrenotificationListParams.none(), requestOptions)
    }
}
