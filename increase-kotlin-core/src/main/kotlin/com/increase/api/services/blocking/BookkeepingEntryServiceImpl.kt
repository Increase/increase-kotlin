...
class BookkeepingEntryServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BookkeepingEntryService {

    private val withRawResponse: BookkeepingEntryService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: BookkeepingEntryRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<BookkeepingEntry> {
        ...
        private val listHandler: Handler<BookkeepingEntryListPage.Response> = jsonHandler<BookkeepingEntryListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: BookkeepingEntryListParams, requestOptions: RequestOptions): HttpResponseFor<BookkeepingEntryListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return response.parseable {
              ...
              .let {
                  BookkeepingEntryListPage.of(BookkeepingEntryServiceImpl(clientOptions), params, it)
              }
          }
        }
    }
