...
class CardDisputeServiceImpl internal constructor(
    ...
    override fun action(params: CardDisputeActionParams, requestOptions: RequestOptions): CardDispute =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun action(params: CardDisputeActionParams, requestOptions: RequestOptions): HttpResponseFor<CardDispute> {
