...
class ProofOfAuthorizationRequestServiceImpl constructor(private val clientOptions: ClientOptions, ) : ProofOfAuthorizationRequestService {
    ...
    override fun list(params: ProofOfAuthorizationRequestListParams, requestOptions: RequestOptions): ProofOfAuthorizationRequestListPage {
      ...
      .let { response -> 
          ...
          .let {
              ProofOfAuthorizationRequestListPage.of(this, params, it)
          }
      }
    }
}
