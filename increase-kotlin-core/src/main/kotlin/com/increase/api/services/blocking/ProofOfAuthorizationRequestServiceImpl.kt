...
internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: ProofOfAuthorizationRequestService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): ProofOfAuthorizationRequestService.WithRawResponse =
        withRawResponse
