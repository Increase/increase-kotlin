...
interface EntityServiceAsync {
    ...
    /** List Entities */
    suspend fun list(params: EntityListParams = EntityListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): EntityListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): EntityListPageAsync = list(EntityListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: EntityCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Entity>
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: EntityRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Entity>
         ...
         */
        @MustBeClosed
        suspend fun list(params: EntityListParams = EntityListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EntityListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<EntityListPageAsync> = list(EntityListParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        suspend fun archive(params: EntityArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Entity>
         ...
         */
        @MustBeClosed
        suspend fun archiveBeneficialOwner(params: EntityArchiveBeneficialOwnerParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Entity>
         ...
         */
        @MustBeClosed
        suspend fun confirm(params: EntityConfirmParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Entity>
         ...
         */
        @MustBeClosed
        suspend fun createBeneficialOwner(params: EntityCreateBeneficialOwnerParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Entity>
         ...
         */
        @MustBeClosed
        suspend fun updateAddress(params: EntityUpdateAddressParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Entity>
         ...
         */
        @MustBeClosed
        suspend fun updateBeneficialOwnerAddress(params: EntityUpdateBeneficialOwnerAddressParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Entity>
         ...
         */
        @MustBeClosed
        suspend fun updateIndustryCode(params: EntityUpdateIndustryCodeParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Entity>
    }
}
