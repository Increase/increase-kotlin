...
class IntrafiBalanceServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : IntrafiBalanceServiceAsync {
    ...
    override suspend fun retrieve(params: IntrafiBalanceRetrieveParams, requestOptions: RequestOptions): IntrafiBalance {
