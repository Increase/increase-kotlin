...
interface RoutingNumberServiceAsync {
     ...
     */
    suspend fun list(params: RoutingNumberListParams, requestOptions: RequestOptions = RequestOptions.none()): RoutingNumberListPageAsync
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun list(params: RoutingNumberListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<RoutingNumberListPageAsync>
    }
}
