...
class OAuthApplicationServiceAsyncImpl internal constructor(
    ...
    override suspend fun retrieve(params: OAuthApplicationRetrieveParams, requestOptions: RequestOptions): OAuthApplication =
        // get /oauth_applications/{oauth_application_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun list(params: OAuthApplicationListParams, requestOptions: RequestOptions): OAuthApplicationListPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun retrieve(params: OAuthApplicationRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<OAuthApplication> {
        ...
        override suspend fun list(params: OAuthApplicationListParams, requestOptions: RequestOptions): HttpResponseFor<OAuthApplicationListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
