...
class CardFuelConfirmationServiceImpl constructor(private val clientOptions: ClientOptions, ) : CardFuelConfirmationService {
     ...
     */
    override fun create(params: SimulationCardFuelConfirmationCreateParams, requestOptions: RequestOptions): CardPayment {
