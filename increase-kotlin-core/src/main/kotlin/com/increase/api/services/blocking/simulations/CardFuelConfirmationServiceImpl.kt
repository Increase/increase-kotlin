...
class CardFuelConfirmationServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CardFuelConfirmationService {

    private val withRawResponse: CardFuelConfirmationService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CardFuelConfirmationService.WithRawResponse = withRawResponse

    override fun create(params: CardFuelConfirmationCreateParams, requestOptions: RequestOptions): CardPayment =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CardFuelConfirmationCreateParams, requestOptions: RequestOptions): HttpResponseFor<CardPayment> {
