...
class CardFuelConfirmationServiceAsyncImpl internal constructor(
    ...
    override suspend fun create(params: CardFuelConfirmationCreateParams, requestOptions: RequestOptions): CardPayment =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: CardFuelConfirmationCreateParams, requestOptions: RequestOptions): HttpResponseFor<CardPayment> {
