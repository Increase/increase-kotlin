...
class CardFuelConfirmationServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : CardFuelConfirmationServiceAsync {
     ...
     */
    override suspend fun create(params: SimulationCardFuelConfirmationCreateParams, requestOptions: RequestOptions): CardPayment {
