...
class InterestPaymentServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : InterestPaymentServiceAsync {

    private val withRawResponse: InterestPaymentServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): InterestPaymentServiceAsync.WithRawResponse = withRawResponse

    override suspend fun create(params: InterestPaymentCreateParams, requestOptions: RequestOptions): Transaction =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: InterestPaymentCreateParams, requestOptions: RequestOptions): HttpResponseFor<Transaction> {
