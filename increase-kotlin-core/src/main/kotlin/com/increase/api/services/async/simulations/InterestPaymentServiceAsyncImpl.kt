...
class InterestPaymentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : InterestPaymentServiceAsync {
     ...
     */
    override suspend fun create(params: SimulationInterestPaymentCreateParams, requestOptions: RequestOptions): Transaction {
