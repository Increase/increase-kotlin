...
interface LockboxServiceAsync {
    ...
    /** List Lockboxes */
    suspend fun list(params: LockboxListParams = LockboxListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): LockboxListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): LockboxListPageAsync = list(LockboxListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: LockboxCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Lockbox>
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: LockboxRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Lockbox>
         ...
         */
        @MustBeClosed
        suspend fun update(params: LockboxUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Lockbox>
         ...
         */
        @MustBeClosed
        suspend fun list(params: LockboxListParams = LockboxListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<LockboxListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<LockboxListPageAsync> = list(LockboxListParams.none(), requestOptions)
    }
}
