...
class CardBalanceInquiryServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CardBalanceInquiryService =
        CardBalanceInquiryServiceImpl(clientOptions.toBuilder().apply(modifier).build())
