...
interface WireTransferServiceAsync {
     ...
     */
    suspend fun reverse(params: WireTransferReverseParams, requestOptions: RequestOptions = RequestOptions.none()): WireTransfer
     ...
     * `pending_creating`.
     */
    suspend fun submit(params: WireTransferSubmitParams, requestOptions: RequestOptions = RequestOptions.none()): WireTransfer
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun reverse(params: WireTransferReverseParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<WireTransfer>
         ...
         */
        @MustBeClosed
        suspend fun submit(params: WireTransferSubmitParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<WireTransfer>
    }
}
