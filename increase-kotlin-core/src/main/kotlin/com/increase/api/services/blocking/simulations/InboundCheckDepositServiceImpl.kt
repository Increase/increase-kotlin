...
class InboundCheckDepositServiceImpl internal constructor(
    ...
    override fun create(params: InboundCheckDepositCreateParams, requestOptions: RequestOptions): InboundCheckDeposit =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: InboundCheckDepositCreateParams, requestOptions: RequestOptions): HttpResponseFor<InboundCheckDeposit> {
