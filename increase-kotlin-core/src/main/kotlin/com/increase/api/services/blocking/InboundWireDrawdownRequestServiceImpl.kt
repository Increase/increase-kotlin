...
class InboundWireDrawdownRequestServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : InboundWireDrawdownRequestService {

    private val withRawResponse: InboundWireDrawdownRequestService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): InboundWireDrawdownRequestService.WithRawResponse = withRawResponse
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: InboundWireDrawdownRequestRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<InboundWireDrawdownRequest> {
        ...
        private val listHandler: Handler<InboundWireDrawdownRequestListPage.Response> = jsonHandler<InboundWireDrawdownRequestListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: InboundWireDrawdownRequestListParams, requestOptions: RequestOptions): HttpResponseFor<InboundWireDrawdownRequestListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return response.parseable {
              ...
              .let {
                  InboundWireDrawdownRequestListPage.of(InboundWireDrawdownRequestServiceImpl(clientOptions), params, it)
              }
          }
        }
    }
