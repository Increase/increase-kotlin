...
class CardReversalServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : CardReversalServiceAsync {
     ...
     * reversed.
     */
    override suspend fun create(params: SimulationCardReversalCreateParams, requestOptions: RequestOptions): CardPayment {
