...
class BookkeepingEntryServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : BookkeepingEntryServiceAsync {
    ...
    override suspend fun list(params: BookkeepingEntryListParams, requestOptions: RequestOptions): BookkeepingEntryListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              BookkeepingEntryListPageAsync.of(this, params, it)
          }
      }
    }
}
