...
interface CardAuthorizationServiceAsync {
     ...
     */
    suspend fun create(params: CardAuthorizationCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CardAuthorizationCreateResponse
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: CardAuthorizationCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CardAuthorizationCreateResponse>
    }
}
