...
interface InboundCheckDepositService {
     ...
     */
    fun create(params: InboundCheckDepositCreateParams, requestOptions: RequestOptions = RequestOptions.none()): InboundCheckDeposit
    ...
    interface WithRawResponse {
         ...
         * is otherwise the same as [InboundCheckDepositService.create].
         */
        @MustBeClosed
        fun create(params: InboundCheckDepositCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<InboundCheckDeposit>
    }
}
