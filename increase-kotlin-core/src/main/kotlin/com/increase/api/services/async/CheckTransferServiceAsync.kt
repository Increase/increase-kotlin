...
interface CheckTransferServiceAsync {
    ...
    suspend fun list(params: CheckTransferListParams = CheckTransferListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CheckTransferListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): CheckTransferListPageAsync = list(CheckTransferListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: CheckTransferCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CheckTransfer>
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: CheckTransferRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CheckTransfer>
         ...
         */
        @MustBeClosed
        suspend fun list(params: CheckTransferListParams = CheckTransferListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CheckTransferListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<CheckTransferListPageAsync> = list(CheckTransferListParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        suspend fun approve(params: CheckTransferApproveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CheckTransfer>
         ...
         */
        @MustBeClosed
        suspend fun cancel(params: CheckTransferCancelParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CheckTransfer>
         ...
         */
        @MustBeClosed
        suspend fun stopPayment(params: CheckTransferStopPaymentParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CheckTransfer>
    }
}
