...
class EventSubscriptionServiceImpl constructor(private val clientOptions: ClientOptions, ) : EventSubscriptionService {
    ...
    override fun list(params: EventSubscriptionListParams, requestOptions: RequestOptions): EventSubscriptionListPage {
      ...
      .let { response -> 
          ...
          .let {
              EventSubscriptionListPage.of(this, params, it)
          }
      }
    }
}
