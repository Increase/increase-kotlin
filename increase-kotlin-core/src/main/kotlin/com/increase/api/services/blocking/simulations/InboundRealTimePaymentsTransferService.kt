...
interface InboundRealTimePaymentsTransferService {
     ...
     */
    fun create(params: SimulationInboundRealTimePaymentsTransferCreateParams, requestOptions: RequestOptions = RequestOptions.none()): SimulationInboundRealTimePaymentsTransferCreateResponse
}
