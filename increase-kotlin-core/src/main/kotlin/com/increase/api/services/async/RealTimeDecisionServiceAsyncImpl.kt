...
class RealTimeDecisionServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : RealTimeDecisionServiceAsync {

    private val withRawResponse: RealTimeDecisionServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): RealTimeDecisionServiceAsync.WithRawResponse = withRawResponse

    override suspend fun retrieve(params: RealTimeDecisionRetrieveParams, requestOptions: RequestOptions): RealTimeDecision =
        // get /real_time_decisions/{real_time_decision_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun action(params: RealTimeDecisionActionParams, requestOptions: RequestOptions): RealTimeDecision =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun retrieve(params: RealTimeDecisionRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<RealTimeDecision> {
        ...
        override suspend fun action(params: RealTimeDecisionActionParams, requestOptions: RequestOptions): HttpResponseFor<RealTimeDecision> {
          val request = HttpRequest.builder()
