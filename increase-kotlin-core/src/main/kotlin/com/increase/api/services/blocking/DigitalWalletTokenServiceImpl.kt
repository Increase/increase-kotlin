...
class DigitalWalletTokenServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : DigitalWalletTokenService {

    private val withRawResponse: DigitalWalletTokenService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: DigitalWalletTokenRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<DigitalWalletToken> {
        ...
        private val listHandler: Handler<DigitalWalletTokenListPage.Response> = jsonHandler<DigitalWalletTokenListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: DigitalWalletTokenListParams, requestOptions: RequestOptions): HttpResponseFor<DigitalWalletTokenListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return response.parseable {
              ...
              .let {
                  DigitalWalletTokenListPage.of(DigitalWalletTokenServiceImpl(clientOptions), params, it)
              }
          }
        }
    }
