...
class IntrafiBalanceServiceImpl constructor(private val clientOptions: ClientOptions, ) : IntrafiBalanceService {
    ...
    override fun retrieve(params: IntrafiBalanceRetrieveParams, requestOptions: RequestOptions): IntrafiBalance {
