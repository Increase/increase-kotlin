...
interface InboundFundsHoldService {
     ...
     */
    fun release(params: SimulationInboundFundsHoldReleaseParams, requestOptions: RequestOptions = RequestOptions.none()): SimulationInboundFundsHoldReleaseResponse
}
