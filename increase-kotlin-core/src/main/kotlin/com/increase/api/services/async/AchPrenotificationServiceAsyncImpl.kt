...
class AchPrenotificationServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AchPrenotificationServiceAsync {

    private val withRawResponse: AchPrenotificationServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val createHandler: Handler<AchPrenotification> = jsonHandler<AchPrenotification>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun create(params: AchPrenotificationCreateParams, requestOptions: RequestOptions): HttpResponseFor<AchPrenotification> {
        ...
        private val retrieveHandler: Handler<AchPrenotification> = jsonHandler<AchPrenotification>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun retrieve(params: AchPrenotificationRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<AchPrenotification> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<AchPrenotificationListPageAsync.Response> = jsonHandler<AchPrenotificationListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: AchPrenotificationListParams, requestOptions: RequestOptions): HttpResponseFor<AchPrenotificationListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("ach_prenotifications")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  AchPrenotificationListPageAsync.of(AchPrenotificationServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
    }
