...
interface RealTimePaymentsTransferService {
     ...
     */
    fun complete(params: RealTimePaymentsTransferCompleteParams, requestOptions: RequestOptions = RequestOptions.none()): RealTimePaymentsTransfer
    ...
    interface WithRawResponse {
         ...
         * but is otherwise the same as [RealTimePaymentsTransferService.complete].
         */
        @MustBeClosed
        fun complete(params: RealTimePaymentsTransferCompleteParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<RealTimePaymentsTransfer>
    }
}
