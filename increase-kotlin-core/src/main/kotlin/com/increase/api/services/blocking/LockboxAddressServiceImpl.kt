...
class LockboxAddressServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): LockboxAddressService =
        LockboxAddressServiceImpl(clientOptions.toBuilder().apply(modifier).build())
