...
class InboundAchTransferServiceImpl internal constructor(
    ...
    override fun createNotificationOfChange(params: InboundAchTransferCreateNotificationOfChangeParams, requestOptions: RequestOptions): InboundAchTransfer =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: InboundAchTransferRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<InboundAchTransfer> {
        ...
        private val listHandler: Handler<InboundAchTransferListPage.Response> = jsonHandler<InboundAchTransferListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: InboundAchTransferListParams, requestOptions: RequestOptions): HttpResponseFor<InboundAchTransferListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return response.parseable {
              ...
              .let {
                  InboundAchTransferListPage.of(InboundAchTransferServiceImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override fun createNotificationOfChange(params: InboundAchTransferCreateNotificationOfChangeParams, requestOptions: RequestOptions): HttpResponseFor<InboundAchTransfer> {
          val request = HttpRequest.builder()
        ...
        override fun decline(params: InboundAchTransferDeclineParams, requestOptions: RequestOptions): HttpResponseFor<InboundAchTransfer> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun transferReturn(params: InboundAchTransferTransferReturnParams, requestOptions: RequestOptions): HttpResponseFor<InboundAchTransfer> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
