...
class IntrafiAccountEnrollmentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : IntrafiAccountEnrollmentServiceAsync {
    ...
    override suspend fun list(params: IntrafiAccountEnrollmentListParams, requestOptions: RequestOptions): IntrafiAccountEnrollmentListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              IntrafiAccountEnrollmentListPageAsync.of(this, params, it)
          }
      }
    }
