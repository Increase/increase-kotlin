...
class InboundMailItemServiceImpl internal constructor(
    ...
    override fun create(params: InboundMailItemCreateParams, requestOptions: RequestOptions): InboundMailItem =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: InboundMailItemCreateParams, requestOptions: RequestOptions): HttpResponseFor<InboundMailItem> {
