...
class PhysicalCardProfileServiceImpl constructor(private val clientOptions: ClientOptions, ) : PhysicalCardProfileService {
    ...
    override fun list(params: PhysicalCardProfileListParams, requestOptions: RequestOptions): PhysicalCardProfileListPage {
      ...
      .let { response -> 
          ...
          .let {
              PhysicalCardProfileListPage.of(this, params, it)
          }
      }
    }
