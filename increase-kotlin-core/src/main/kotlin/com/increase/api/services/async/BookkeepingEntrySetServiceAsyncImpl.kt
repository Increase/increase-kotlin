...
class BookkeepingEntrySetServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: BookkeepingEntrySetCreateParams, requestOptions: RequestOptions): HttpResponseFor<BookkeepingEntrySet> {
        ...
        override suspend fun retrieve(params: BookkeepingEntrySetRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<BookkeepingEntrySet> {
          val request = HttpRequest.builder()
        ...
        override suspend fun list(params: BookkeepingEntrySetListParams, requestOptions: RequestOptions): HttpResponseFor<BookkeepingEntrySetListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("bookkeeping_entry_sets")
            .build()
