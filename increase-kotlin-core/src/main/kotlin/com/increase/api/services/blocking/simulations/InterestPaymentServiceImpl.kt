...
class InterestPaymentServiceImpl constructor(private val clientOptions: ClientOptions, ) : InterestPaymentService {
     ...
     */
    override fun create(params: SimulationInterestPaymentCreateParams, requestOptions: RequestOptions): Transaction {
