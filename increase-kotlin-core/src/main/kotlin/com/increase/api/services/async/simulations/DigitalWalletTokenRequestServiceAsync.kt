...
interface DigitalWalletTokenRequestServiceAsync {
     ...
     * Apple Pay.
     */
    suspend fun create(params: SimulationDigitalWalletTokenRequestCreateParams, requestOptions: RequestOptions = RequestOptions.none()): SimulationDigitalWalletTokenRequestCreateResponse
}
