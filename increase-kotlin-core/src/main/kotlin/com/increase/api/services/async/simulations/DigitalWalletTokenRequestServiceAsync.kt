...
interface DigitalWalletTokenRequestServiceAsync {
     ...
     * Apple Pay.
     */
    suspend fun create(params: DigitalWalletTokenRequestCreateParams, requestOptions: RequestOptions = RequestOptions.none()): DigitalWalletTokenRequestCreateResponse
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: DigitalWalletTokenRequestCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<DigitalWalletTokenRequestCreateResponse>
    }
}
