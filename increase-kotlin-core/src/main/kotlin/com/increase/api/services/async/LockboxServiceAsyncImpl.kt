...
class LockboxServiceAsyncImpl internal constructor(
    ...
    override suspend fun create(params: LockboxCreateParams, requestOptions: RequestOptions): Lockbox =
        // post /lockboxes
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: LockboxRetrieveParams, requestOptions: RequestOptions): Lockbox =
        // get /lockboxes/{lockbox_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun update(params: LockboxUpdateParams, requestOptions: RequestOptions): Lockbox =
        // patch /lockboxes/{lockbox_id}
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun list(params: LockboxListParams, requestOptions: RequestOptions): LockboxListPageAsync =
        // get /lockboxes
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: LockboxCreateParams, requestOptions: RequestOptions): HttpResponseFor<Lockbox> {
        ...
        override suspend fun retrieve(params: LockboxRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Lockbox> {
          val request = HttpRequest.builder()
        ...
        override suspend fun update(params: LockboxUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Lockbox> {
          val request = HttpRequest.builder()
        ...
        override suspend fun list(params: LockboxListParams, requestOptions: RequestOptions): HttpResponseFor<LockboxListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("lockboxes")
            .build()
