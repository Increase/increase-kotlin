...
class InboundMailItemServiceAsyncImpl internal constructor(
    ...
    override suspend fun create(params: InboundMailItemCreateParams, requestOptions: RequestOptions): InboundMailItem =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: InboundMailItemCreateParams, requestOptions: RequestOptions): HttpResponseFor<InboundMailItem> {
