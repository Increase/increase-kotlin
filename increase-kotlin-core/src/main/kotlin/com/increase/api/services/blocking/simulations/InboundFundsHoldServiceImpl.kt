...
class InboundFundsHoldServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : InboundFundsHoldService {

    private val withRawResponse: InboundFundsHoldService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): InboundFundsHoldService.WithRawResponse = withRawResponse

    override fun release(params: InboundFundsHoldReleaseParams, requestOptions: RequestOptions): InboundFundsHoldReleaseResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun release(params: InboundFundsHoldReleaseParams, requestOptions: RequestOptions): HttpResponseFor<InboundFundsHoldReleaseResponse> {
