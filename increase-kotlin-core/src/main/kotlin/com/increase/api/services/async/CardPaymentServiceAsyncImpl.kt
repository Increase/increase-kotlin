...
class CardPaymentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : CardPaymentServiceAsync {
    ...
    override suspend fun list(params: CardPaymentListParams, requestOptions: RequestOptions): CardPaymentListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              CardPaymentListPageAsync.of(this, params, it)
          }
      }
    }
}
