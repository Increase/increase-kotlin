...
class CardPaymentServiceAsyncImpl internal constructor(
    ...
    override suspend fun retrieve(params: CardPaymentRetrieveParams, requestOptions: RequestOptions): CardPayment =
        // get /card_payments/{card_payment_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun list(params: CardPaymentListParams, requestOptions: RequestOptions): CardPaymentListPageAsync =
        // get /card_payments
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun retrieve(params: CardPaymentRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CardPayment> {
        ...
        override suspend fun list(params: CardPaymentListParams, requestOptions: RequestOptions): HttpResponseFor<CardPaymentListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
