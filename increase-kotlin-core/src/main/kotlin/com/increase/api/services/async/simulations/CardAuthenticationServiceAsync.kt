...
interface CardAuthenticationServiceAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CardAuthenticationServiceAsync
    ...
    /** @see challenges */
    suspend fun challenges(cardPaymentId: String, requestOptions: RequestOptions): CardPayment =
