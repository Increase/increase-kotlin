...
class AccountTransferServiceImpl internal constructor(
    ...
    override fun complete(params: AccountTransferCompleteParams, requestOptions: RequestOptions): AccountTransfer =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun complete(params: AccountTransferCompleteParams, requestOptions: RequestOptions): HttpResponseFor<AccountTransfer> {
