...
class DigitalCardProfileServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : DigitalCardProfileServiceAsync {

    private val withRawResponse: DigitalCardProfileServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: DigitalCardProfileCreateParams, requestOptions: RequestOptions): HttpResponseFor<DigitalCardProfile> {
        ...
        override suspend fun retrieve(params: DigitalCardProfileRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<DigitalCardProfile> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<DigitalCardProfileListPageAsync.Response> = jsonHandler<DigitalCardProfileListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: DigitalCardProfileListParams, requestOptions: RequestOptions): HttpResponseFor<DigitalCardProfileListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("digital_card_profiles")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  DigitalCardProfileListPageAsync.of(DigitalCardProfileServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override suspend fun archive(params: DigitalCardProfileArchiveParams, requestOptions: RequestOptions): HttpResponseFor<DigitalCardProfile> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun clone(params: DigitalCardProfileCloneParams, requestOptions: RequestOptions): HttpResponseFor<DigitalCardProfile> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
