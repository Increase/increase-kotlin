...
class AchTransferServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: AchTransferCreateParams, requestOptions: RequestOptions): HttpResponseFor<AchTransfer> {
        ...
        override suspend fun retrieve(params: AchTransferRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<AchTransfer> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<AchTransferListPageAsync.Response> = jsonHandler<AchTransferListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: AchTransferListParams, requestOptions: RequestOptions): HttpResponseFor<AchTransferListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("ach_transfers")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  AchTransferListPageAsync.of(AchTransferServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override suspend fun approve(params: AchTransferApproveParams, requestOptions: RequestOptions): HttpResponseFor<AchTransfer> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun cancel(params: AchTransferCancelParams, requestOptions: RequestOptions): HttpResponseFor<AchTransfer> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
