...
class BookkeepingAccountServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BookkeepingAccountServiceAsync {

    private val withRawResponse: BookkeepingAccountServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): BookkeepingAccountServiceAsync.WithRawResponse = withRawResponse

    override suspend fun create(params: BookkeepingAccountCreateParams, requestOptions: RequestOptions): BookkeepingAccount =
        // post /bookkeeping_accounts
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun update(params: BookkeepingAccountUpdateParams, requestOptions: RequestOptions): BookkeepingAccount =
        // patch /bookkeeping_accounts/{bookkeeping_account_id}
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun list(params: BookkeepingAccountListParams, requestOptions: RequestOptions): BookkeepingAccountListPageAsync =
        // get /bookkeeping_accounts
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun balance(params: BookkeepingAccountBalanceParams, requestOptions: RequestOptions): BookkeepingBalanceLookup =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: BookkeepingAccountCreateParams, requestOptions: RequestOptions): HttpResponseFor<BookkeepingAccount> {
        ...
        override suspend fun update(params: BookkeepingAccountUpdateParams, requestOptions: RequestOptions): HttpResponseFor<BookkeepingAccount> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<BookkeepingAccountListPageAsync.Response> = jsonHandler<BookkeepingAccountListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: BookkeepingAccountListParams, requestOptions: RequestOptions): HttpResponseFor<BookkeepingAccountListPageAsync> {
          val request = HttpRequest.builder()
          ...
          return response.parseable {
              ...
              .let {
                  BookkeepingAccountListPageAsync.of(BookkeepingAccountServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override suspend fun balance(params: BookkeepingAccountBalanceParams, requestOptions: RequestOptions): HttpResponseFor<BookkeepingBalanceLookup> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
