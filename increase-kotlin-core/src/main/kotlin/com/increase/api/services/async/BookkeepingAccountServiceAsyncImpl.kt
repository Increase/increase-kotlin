...
class BookkeepingAccountServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : BookkeepingAccountServiceAsync {
    ...
    override suspend fun list(params: BookkeepingAccountListParams, requestOptions: RequestOptions): BookkeepingAccountListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              BookkeepingAccountListPageAsync.of(this, params, it)
          }
      }
    }
