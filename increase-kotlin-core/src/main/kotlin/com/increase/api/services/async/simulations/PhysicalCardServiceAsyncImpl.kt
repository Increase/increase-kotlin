...
class PhysicalCardServiceAsyncImpl internal constructor(
    ...
    override suspend fun advanceShipment(params: PhysicalCardAdvanceShipmentParams, requestOptions: RequestOptions): PhysicalCard =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun advanceShipment(params: PhysicalCardAdvanceShipmentParams, requestOptions: RequestOptions): HttpResponseFor<PhysicalCard> {
