...
class CardDisputeServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CardDisputeService {

    private val withRawResponse: CardDisputeService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CardDisputeCreateParams, requestOptions: RequestOptions): HttpResponseFor<CardDispute> {
        ...
        override fun retrieve(params: CardDisputeRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CardDispute> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<CardDisputeListPage.Response> = jsonHandler<CardDisputeListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: CardDisputeListParams, requestOptions: RequestOptions): HttpResponseFor<CardDisputeListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("card_disputes")
            .build()
