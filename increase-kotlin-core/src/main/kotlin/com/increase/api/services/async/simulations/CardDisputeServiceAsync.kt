...
interface CardDisputeServiceAsync {
     ...
     */
    suspend fun action(params: CardDisputeActionParams, requestOptions: RequestOptions = RequestOptions.none()): CardDispute
    ...
    interface WithRawResponse {
         ...
         * `post /simulations/card_disputes/{card_dispute_id}/action`, but is otherwise the
         * same as [CardDisputeServiceAsync.action].
         */
        @MustBeClosed
        suspend fun action(params: CardDisputeActionParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CardDispute>
    }
}
