...
class InboundWireDrawdownRequestServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun retrieve(params: InboundWireDrawdownRequestRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<InboundWireDrawdownRequest> {
        ...
        override suspend fun list(params: InboundWireDrawdownRequestListParams, requestOptions: RequestOptions): HttpResponseFor<InboundWireDrawdownRequestListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
