...
class RoutingNumberServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : RoutingNumberServiceAsync {
    ...
    override suspend fun list(params: RoutingNumberListParams, requestOptions: RequestOptions): RoutingNumberListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              RoutingNumberListPageAsync.of(this, params, it)
          }
      }
    }
}
