...
interface DocumentServiceAsync {
    ...
    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): DocumentListPageAsync = list(DocumentListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /documents/{document_id}`, but is otherwise
         * the same as [DocumentServiceAsync.retrieve].
         */
        @MustBeClosed
        ...
        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<DocumentListPageAsync> = list(DocumentListParams.none(), requestOptions)
    }
}
