...
interface PhysicalCardServiceAsync {
     ...
     * failed delivery.
     */
    suspend fun advanceShipment(params: PhysicalCardAdvanceShipmentParams, requestOptions: RequestOptions = RequestOptions.none()): PhysicalCard
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun advanceShipment(params: PhysicalCardAdvanceShipmentParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PhysicalCard>
    }
}
