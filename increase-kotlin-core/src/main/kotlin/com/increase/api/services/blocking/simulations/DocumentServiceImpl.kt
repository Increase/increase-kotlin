...
class DocumentServiceImpl constructor(private val clientOptions: ClientOptions, ) : DocumentService {
    ...
    override fun create(params: SimulationDocumentCreateParams, requestOptions: RequestOptions): Document {
