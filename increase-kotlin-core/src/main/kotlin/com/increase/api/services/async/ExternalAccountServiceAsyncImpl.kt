...
class ExternalAccountServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ExternalAccountServiceAsync {
    ...
    override suspend fun list(params: ExternalAccountListParams, requestOptions: RequestOptions): ExternalAccountListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              ExternalAccountListPageAsync.of(this, params, it)
          }
      }
    }
}
