...
class InboundMailItemServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : InboundMailItemServiceAsync {
    ...
    override suspend fun list(params: InboundMailItemListParams, requestOptions: RequestOptions): InboundMailItemListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              InboundMailItemListPageAsync.of(this, params, it)
          }
      }
    }
}
