...
class InboundMailItemServiceAsyncImpl internal constructor(
    ...
    override suspend fun retrieve(params: InboundMailItemRetrieveParams, requestOptions: RequestOptions): InboundMailItem =
        // get /inbound_mail_items/{inbound_mail_item_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun list(params: InboundMailItemListParams, requestOptions: RequestOptions): InboundMailItemListPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun retrieve(params: InboundMailItemRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<InboundMailItem> {
        ...
        private val listHandler: Handler<InboundMailItemListPageAsync.Response> = jsonHandler<InboundMailItemListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: InboundMailItemListParams, requestOptions: RequestOptions): HttpResponseFor<InboundMailItemListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return response.parseable {
              ...
              .let {
                  InboundMailItemListPageAsync.of(InboundMailItemServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
    }
