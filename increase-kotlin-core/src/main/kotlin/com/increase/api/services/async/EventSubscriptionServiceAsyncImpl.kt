...
class EventSubscriptionServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : EventSubscriptionServiceAsync {

    private val withRawResponse: EventSubscriptionServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: EventSubscriptionCreateParams, requestOptions: RequestOptions): HttpResponseFor<EventSubscription> {
        ...
        override suspend fun retrieve(params: EventSubscriptionRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<EventSubscription> {
          val request = HttpRequest.builder()
        ...
        override suspend fun update(params: EventSubscriptionUpdateParams, requestOptions: RequestOptions): HttpResponseFor<EventSubscription> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<EventSubscriptionListPageAsync.Response> = jsonHandler<EventSubscriptionListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: EventSubscriptionListParams, requestOptions: RequestOptions): HttpResponseFor<EventSubscriptionListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("event_subscriptions")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  EventSubscriptionListPageAsync.of(EventSubscriptionServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
    }
