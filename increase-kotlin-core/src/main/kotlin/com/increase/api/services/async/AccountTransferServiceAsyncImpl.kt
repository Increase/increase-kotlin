...
class AccountTransferServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AccountTransferServiceAsync {

    private val withRawResponse: AccountTransferServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: AccountTransferCreateParams, requestOptions: RequestOptions): HttpResponseFor<AccountTransfer> {
        ...
        override suspend fun retrieve(params: AccountTransferRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<AccountTransfer> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<AccountTransferListPageAsync.Response> = jsonHandler<AccountTransferListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: AccountTransferListParams, requestOptions: RequestOptions): HttpResponseFor<AccountTransferListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("account_transfers")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  AccountTransferListPageAsync.of(AccountTransferServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override suspend fun approve(params: AccountTransferApproveParams, requestOptions: RequestOptions): HttpResponseFor<AccountTransfer> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun cancel(params: AccountTransferCancelParams, requestOptions: RequestOptions): HttpResponseFor<AccountTransfer> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
