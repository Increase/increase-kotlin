...
class InboundCheckDepositServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : InboundCheckDepositServiceAsync {
    ...
    override suspend fun list(params: InboundCheckDepositListParams, requestOptions: RequestOptions): InboundCheckDepositListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              InboundCheckDepositListPageAsync.of(this, params, it)
          }
      }
    }
