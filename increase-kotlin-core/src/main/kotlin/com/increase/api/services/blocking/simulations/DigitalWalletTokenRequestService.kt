...
interface DigitalWalletTokenRequestService {
     ...
     * Apple Pay.
     */
    fun create(params: SimulationDigitalWalletTokenRequestCreateParams, requestOptions: RequestOptions = RequestOptions.none()): SimulationDigitalWalletTokenRequestCreateResponse
}
