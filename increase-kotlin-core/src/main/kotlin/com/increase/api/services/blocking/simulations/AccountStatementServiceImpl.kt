...
class AccountStatementServiceImpl internal constructor(
    ...
    override fun create(params: AccountStatementCreateParams, requestOptions: RequestOptions): AccountStatement =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: AccountStatementCreateParams, requestOptions: RequestOptions): HttpResponseFor<AccountStatement> {
