...
/**
 * A client for interacting with the Increase REST API asynchronously. You can also
...
interface IncreaseClientAsync {
    ...
    /**
     * A view of [IncreaseClientAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
        ...
        fun proofOfAuthorizationRequestSubmissions(): ProofOfAuthorizationRequestSubmissionServiceAsync.WithRawResponse
