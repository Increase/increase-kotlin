...
/**
 * A client for interacting with the Increase REST API synchronously. You can also
...
interface IncreaseClient {
    ...
    /**
     * A view of [IncreaseClient] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        fun proofOfAuthorizationRequestSubmissions(): ProofOfAuthorizationRequestSubmissionService.WithRawResponse
