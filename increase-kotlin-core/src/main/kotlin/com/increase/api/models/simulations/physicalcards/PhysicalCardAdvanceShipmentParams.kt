 ...
 * failed delivery.
 */
class PhysicalCardAdvanceShipmentParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("shipment_status") @ExcludeMissing private val shipmentStatus: JsonField<ShipmentStatus> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** The shipment status to move the Physical Card to. */
            fun shipmentStatus(shipmentStatus: ShipmentStatus) = shipmentStatus(JsonField.of(shipmentStatus))

            /** The shipment status to move the Physical Card to. */
            fun shipmentStatus(shipmentStatus: JsonField<ShipmentStatus>) =
                apply {
        ...
        override fun toString() = "Body{shipmentStatus=$shipmentStatus, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(physicalCardAdvanceShipmentParams: PhysicalCardAdvanceShipmentParams) =
            apply {
                ...
                additionalQueryParams = physicalCardAdvanceShipmentParams.additionalQueryParams.toBuilder()
            }
    ...
    /** The shipment status to move the Physical Card to. */
    class ShipmentStatus @JsonCreator private constructor(
        ...
        /**
         * An enum containing [ShipmentStatus]'s known values, as well as an [_UNKNOWN]
         * member.
         *
         * An instance of [ShipmentStatus] can contain an unknown value in a couple of
         * cases:
         *
    ...
    override fun toString() = "PhysicalCardAdvanceShipmentParams{physicalCardId=$physicalCardId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
