...
class CardPaymentListPage private constructor(private val cardPaymentsService: CardPaymentService, private val params: CardPaymentListParams, private val response: Response, ) {
    ...
    override fun toString() = "CardPaymentListPage{cardPaymentsService=$cardPaymentsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(cardPaymentsService: CardPaymentService, params: CardPaymentListParams, response: Response) = CardPaymentListPage(
            cardPaymentsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<CardPayment>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "CardPaymentListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: CardPaymentListPage, ) : Sequence<CardPayment> {
