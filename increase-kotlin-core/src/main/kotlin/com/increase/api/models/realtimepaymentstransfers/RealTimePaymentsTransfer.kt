 ...
 */
@NoAutoDetect
class RealTimePaymentsTransfer @JsonCreator private constructor(
    ...
    @JsonProperty("destination_account_number") @ExcludeMissing private val destinationAccountNumber: JsonField<String> = JsonMissing.of(),
    @JsonProperty("destination_routing_number") @ExcludeMissing private val destinationRoutingNumber: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("ultimate_creditor_name") @ExcludeMissing private val ultimateCreditorName: JsonField<String> = JsonMissing.of(),
    @JsonProperty("ultimate_debtor_name") @ExcludeMissing private val ultimateDebtorName: JsonField<String> = JsonMissing.of(),
    ...
    fun validate(): RealTimePaymentsTransfer =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(realTimePaymentsTransfer: RealTimePaymentsTransfer) =
            apply {
         ...
         * an intermediary receiving the payment for someone else.
         */
        fun ultimateCreditorName(ultimateCreditorName: String?) = ultimateCreditorName(JsonField.ofNullable(ultimateCreditorName))

        /**
         * The name of the ultimate recipient of the transfer. Set this if the creditor is
         * an intermediary receiving the payment for someone else.
         */
        fun ultimateCreditorName(ultimateCreditorName: JsonField<String>) =
            apply {
         ...
         * sent on behalf of someone who is not the account holder at Increase.
         */
        fun ultimateDebtorName(ultimateDebtorName: String?) = ultimateDebtorName(JsonField.ofNullable(ultimateDebtorName))

        /**
         * The name of the ultimate sender of the transfer. Set this if the funds are being
         * sent on behalf of someone who is not the account holder at Increase.
         */
        fun ultimateDebtorName(ultimateDebtorName: JsonField<String>) =
            apply {
    ...
    class Acknowledgement @JsonCreator private constructor(
        @JsonProperty("acknowledged_at") @ExcludeMissing private val acknowledgedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        class Builder internal constructor() {
            ...
            /** When the transfer was acknowledged. */
            fun acknowledgedAt(acknowledgedAt: OffsetDateTime) = acknowledgedAt(JsonField.of(acknowledgedAt))

            /** When the transfer was acknowledged. */
            fun acknowledgedAt(acknowledgedAt: JsonField<OffsetDateTime>) =
                apply {
    ...
    class Rejection @JsonCreator private constructor(
        @JsonProperty("reject_reason_additional_information") @ExcludeMissing private val rejectReasonAdditionalInformation: JsonField<String> = JsonMissing.of(),
         ...
         */
        fun rejectReasonAdditionalInformation(): String? = rejectReasonAdditionalInformation.getNullable("reject_reason_additional_information")
        ...
        @ExcludeMissing
        fun _rejectReasonAdditionalInformation(): JsonField<String> = rejectReasonAdditionalInformation
        ...
        class Builder internal constructor() {
             ...
             * the `reject_reason_code` is `NARRATIVE`.
             */
            fun rejectReasonAdditionalInformation(rejectReasonAdditionalInformation: String?) = rejectReasonAdditionalInformation(JsonField.ofNullable(rejectReasonAdditionalInformation))

            /**
             * Additional information about the rejection provided by the recipient bank when
             * the `reject_reason_code` is `NARRATIVE`.
             */
            fun rejectReasonAdditionalInformation(rejectReasonAdditionalInformation: JsonField<String>) =
                apply {
            ...
            fun build(): Rejection =
                Rejection(
                  checkRequired(
                    "rejectReasonAdditionalInformation", rejectReasonAdditionalInformation
                  ),
                  checkRequired(
        ...
        override fun toString() = "Rejection{rejectReasonAdditionalInformation=$rejectReasonAdditionalInformation, rejectReasonCode=$rejectReasonCode, rejectedAt=$rejectedAt, additionalProperties=$additionalProperties}"
    }
    ...
    class Submission @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
             ...
             * the transfer was submitted to The Clearing House.
             */
            fun submittedAt(submittedAt: OffsetDateTime?) = submittedAt(JsonField.ofNullable(submittedAt))
        ...
        override fun toString() = "Submission{submittedAt=$submittedAt, transactionIdentification=$transactionIdentification, additionalProperties=$additionalProperties}"
    }
