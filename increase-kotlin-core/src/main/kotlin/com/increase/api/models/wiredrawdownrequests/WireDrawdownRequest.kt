 ...
 */
@NoAutoDetect
class WireDrawdownRequest @JsonCreator private constructor(
    ...
    @JsonProperty("fulfillment_inbound_wire_transfer_id") @ExcludeMissing private val fulfillmentInboundWireTransferId: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("recipient_account_number") @ExcludeMissing private val recipientAccountNumber: JsonField<String> = JsonMissing.of(),
    @JsonProperty("recipient_address_line1") @ExcludeMissing private val recipientAddressLine1: JsonField<String> = JsonMissing.of(),
    @JsonProperty("recipient_address_line2") @ExcludeMissing private val recipientAddressLine2: JsonField<String> = JsonMissing.of(),
    @JsonProperty("recipient_address_line3") @ExcludeMissing private val recipientAddressLine3: JsonField<String> = JsonMissing.of(),
    @JsonProperty("recipient_name") @ExcludeMissing private val recipientName: JsonField<String> = JsonMissing.of(),
    @JsonProperty("recipient_routing_number") @ExcludeMissing private val recipientRoutingNumber: JsonField<String> = JsonMissing.of(),
     ...
     */
    fun fulfillmentInboundWireTransferId(): String? = fulfillmentInboundWireTransferId.getNullable("fulfillment_inbound_wire_transfer_id")
    ...
    fun recipientAddressLine1(): String? = recipientAddressLine1.getNullable("recipient_address_line1")

    /** Line 2 of the drawdown request's recipient's address. */
    fun recipientAddressLine2(): String? = recipientAddressLine2.getNullable("recipient_address_line2")

    /** Line 3 of the drawdown request's recipient's address. */
    fun recipientAddressLine3(): String? = recipientAddressLine3.getNullable("recipient_address_line3")
    ...
    fun validate(): WireDrawdownRequest =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(wireDrawdownRequest: WireDrawdownRequest) =
            apply {
         ...
         * be the identifier of the corresponding Transaction.
         */
        fun fulfillmentInboundWireTransferId(fulfillmentInboundWireTransferId: String?) = fulfillmentInboundWireTransferId(JsonField.ofNullable(fulfillmentInboundWireTransferId))
        ...
        /** The drawdown request's recipient's account number. */
        fun recipientAccountNumber(recipientAccountNumber: JsonField<String>) =
            apply {
                this.recipientAccountNumber = recipientAccountNumber
            }

        /** Line 1 of the drawdown request's recipient's address. */
        fun recipientAddressLine1(recipientAddressLine1: String?) = recipientAddressLine1(JsonField.ofNullable(recipientAddressLine1))

        /** Line 1 of the drawdown request's recipient's address. */
        fun recipientAddressLine1(recipientAddressLine1: JsonField<String>) =
            apply {
                this.recipientAddressLine1 = recipientAddressLine1
            }

        /** Line 2 of the drawdown request's recipient's address. */
        fun recipientAddressLine2(recipientAddressLine2: String?) = recipientAddressLine2(JsonField.ofNullable(recipientAddressLine2))

        /** Line 2 of the drawdown request's recipient's address. */
        fun recipientAddressLine2(recipientAddressLine2: JsonField<String>) =
            apply {
                this.recipientAddressLine2 = recipientAddressLine2
            }

        /** Line 3 of the drawdown request's recipient's address. */
        fun recipientAddressLine3(recipientAddressLine3: String?) = recipientAddressLine3(JsonField.ofNullable(recipientAddressLine3))

        /** Line 3 of the drawdown request's recipient's address. */
        fun recipientAddressLine3(recipientAddressLine3: JsonField<String>) =
            apply {
        ...
        /** The drawdown request's recipient's routing number. */
        fun recipientRoutingNumber(recipientRoutingNumber: JsonField<String>) =
            apply {
        ...
        fun build(): WireDrawdownRequest =
            WireDrawdownRequest(
              ...
              checkRequired(
                "fulfillmentInboundWireTransferId", fulfillmentInboundWireTransferId
              ),
              checkRequired(
              ...
              checkRequired(
                "recipientAddressLine3", recipientAddressLine3
              ),
              checkRequired(
