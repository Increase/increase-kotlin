...
private constructor(
    private val data: JsonField<List<CardToken>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<CardToken>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CardToken> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CardToken>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<CardToken>>? = null
        ...
        /** The contents of the list. */
        fun data(data: List<CardToken>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CardToken>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<CardToken>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CardToken] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CardToken) = apply {
            this.data =
