...
class AccountStatementListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "AccountStatementListParams{accountId=$accountId, cursor=$cursor, limit=$limit, statementPeriodStart=$statementPeriodStart, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): AccountStatementListParams = AccountStatementListParams(
            accountId,
            cursor,
            limit,
            statementPeriodStart,
    ...
    class StatementPeriodStart private constructor(
      ...
      private val additionalProperties: Map<String, List<String>>,
        ...
        class Builder {
            ...
            fun build(): StatementPeriodStart = StatementPeriodStart(
                after,
                before,
                onOrAfter,
                onOrBefore,
