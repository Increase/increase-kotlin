...
class PhysicalCardListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.cardId?.let {
          params.put("card_id", listOf(it.toString()))
      }
    ...
    override fun toString() = "PhysicalCardListParams{cardId=$cardId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(physicalCardListParams: PhysicalCardListParams) = apply {
            ...
            additionalBodyProperties(physicalCardListParams.additionalBodyProperties)
        }
        ...
        fun build(): PhysicalCardListParams = PhysicalCardListParams(
            cardId,
            createdAt,
            cursor,
            idempotencyKey,
