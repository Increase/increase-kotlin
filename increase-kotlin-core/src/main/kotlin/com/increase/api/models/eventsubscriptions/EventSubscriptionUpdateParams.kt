...
class EventSubscriptionUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventSubscriptionUpdateParams: EventSubscriptionUpdateParams) =
            apply {
    ...
    override fun toString() = "EventSubscriptionUpdateParams{eventSubscriptionId=$eventSubscriptionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
