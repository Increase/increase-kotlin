...
class BookkeepingAccountUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class BookkeepingAccountUpdateBody internal constructor(private val name: String?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "BookkeepingAccountUpdateBody{name=$name, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): BookkeepingAccountUpdateBody = BookkeepingAccountUpdateBody(checkNotNull(name) {
    ...
    override fun toString() = "BookkeepingAccountUpdateParams{bookkeepingAccountId=$bookkeepingAccountId, name=$name, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): BookkeepingAccountUpdateParams = BookkeepingAccountUpdateParams(
