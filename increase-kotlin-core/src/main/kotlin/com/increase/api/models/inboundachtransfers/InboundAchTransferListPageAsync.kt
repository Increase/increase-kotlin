...
class InboundAchTransferListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(inboundAchTransfersService: InboundAchTransferServiceAsync, params: InboundAchTransferListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<InboundAchTransfer>> = JsonMissing.of(),
    ...
    class AutoPager(
        private val firstPage: InboundAchTransferListPageAsync,
