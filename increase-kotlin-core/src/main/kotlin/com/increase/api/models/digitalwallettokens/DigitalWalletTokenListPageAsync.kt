...
class DigitalWalletTokenListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(digitalWalletTokensService: DigitalWalletTokenServiceAsync, params: DigitalWalletTokenListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<DigitalWalletToken>> = JsonMissing.of(),
