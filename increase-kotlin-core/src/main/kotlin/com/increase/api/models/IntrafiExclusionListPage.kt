...
class IntrafiExclusionListPage private constructor(private val intrafiExclusionsService: IntrafiExclusionService, private val params: IntrafiExclusionListParams, private val response: Response, ) {
    ...
    override fun toString() = "IntrafiExclusionListPage{intrafiExclusionsService=$intrafiExclusionsService, params=$params, response=$response}"
    ...
    fun getNextPage(): IntrafiExclusionListPage? {
      return getNextPageParams()?.let {
          intrafiExclusionsService.list(it)
      }
    }
    ...
    companion object {
        ...
        fun of(intrafiExclusionsService: IntrafiExclusionService, params: IntrafiExclusionListParams, response: Response) = IntrafiExclusionListPage(
            intrafiExclusionsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<IntrafiExclusion>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "IntrafiExclusionListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: IntrafiExclusionListPage, ) : Sequence<IntrafiExclusion> {
