 ...
 */
class EntityConfirmParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                  confirmedAt, additionalProperties.toImmutable()
                )
        }
        ...
        override fun toString() = "Body{confirmedAt=$confirmedAt, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(entityConfirmParams: EntityConfirmParams) =
            apply {
         ...
         * will be used.
         */
        fun confirmedAt(confirmedAt: OffsetDateTime) =
            apply {
    ...
    override fun toString() = "EntityConfirmParams{entityId=$entityId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
