...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardTokenListParams: CardTokenListParams) = apply {
            createdAt = cardTokenListParams.createdAt
            cursor = cardTokenListParams.cursor
            limit = cardTokenListParams.limit
            additionalHeaders = cardTokenListParams.additionalHeaders.toBuilder()
            additionalQueryParams = cardTokenListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CardTokenListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CardTokenListParams =
            CardTokenListParams(
                createdAt,
                cursor,
                limit,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardTokenListParams &&
    ...
    override fun toString() =
        "CardTokenListParams{createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
