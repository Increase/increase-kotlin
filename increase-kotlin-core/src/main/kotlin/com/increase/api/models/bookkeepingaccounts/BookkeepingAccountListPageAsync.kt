...
class BookkeepingAccountListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(bookkeepingAccountsService: BookkeepingAccountServiceAsync, params: BookkeepingAccountListParams, response: Response) =
