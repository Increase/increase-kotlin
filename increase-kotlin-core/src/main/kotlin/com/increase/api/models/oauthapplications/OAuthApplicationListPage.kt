...
class OAuthApplicationListPage private constructor(
    ...
    override fun toString() = "OAuthApplicationListPage{oauthApplicationsService=$oauthApplicationsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): OAuthApplicationListParams? {
      ...
      return OAuthApplicationListParams.builder().from(params).apply {nextCursor()?.let{ this.cursor(it) } }.build()
    }

    fun getNextPage(): OAuthApplicationListPage? {
      return getNextPageParams()?.let {
          oauthApplicationsService.list(it)
      }
    }
    ...
    companion object {
        ...
        fun of(oauthApplicationsService: OAuthApplicationService, params: OAuthApplicationListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<OAuthApplication>> = JsonMissing.of(),
        ...
        @JsonProperty("data")
        fun _data(): JsonField<List<OAuthApplication>>? = data
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<OAuthApplication> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
