...
class BookkeepingEntrySetCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{entries=$entries, date=$date, transactionId=$transactionId, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bookkeepingEntrySetCreateParams: BookkeepingEntrySetCreateParams) =
            apply {
                ...
                additionalQueryParams = bookkeepingEntrySetCreateParams.additionalQueryParams.toBuilder()
            }

        /** The bookkeeping entries. */
        fun entries(entries: List<Entry>) =
            apply {
    ...
    override fun toString() = "BookkeepingEntrySetCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
