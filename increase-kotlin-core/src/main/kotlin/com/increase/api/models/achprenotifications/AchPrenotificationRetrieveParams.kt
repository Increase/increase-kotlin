...
class AchPrenotificationRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(achPrenotificationRetrieveParams: AchPrenotificationRetrieveParams) =
            apply {
                ...
                additionalQueryParams = achPrenotificationRetrieveParams.additionalQueryParams.toBuilder()
            }

        /** The identifier of the ACH Prenotification to retrieve. */
        fun achPrenotificationId(achPrenotificationId: String) =
            apply {
    ...
    override fun toString() = "AchPrenotificationRetrieveParams{achPrenotificationId=$achPrenotificationId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
