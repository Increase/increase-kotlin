...
private constructor(
    ...
    companion object {
        ...
        fun none(): SwiftTransferListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SwiftTransferListParams]. */
        fun builder() = Builder()
    }

    /** A builder for [SwiftTransferListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(swiftTransferListParams: SwiftTransferListParams) = apply {
            accountId = swiftTransferListParams.accountId
            createdAt = swiftTransferListParams.createdAt
            cursor = swiftTransferListParams.cursor
            idempotencyKey = swiftTransferListParams.idempotencyKey
            limit = swiftTransferListParams.limit
            status = swiftTransferListParams.status
            additionalHeaders = swiftTransferListParams.additionalHeaders.toBuilder()
            additionalQueryParams = swiftTransferListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SwiftTransferListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SwiftTransferListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SwiftTransferListParams &&
    ...
    override fun toString() =
        "SwiftTransferListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
