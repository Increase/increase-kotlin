...
class SimulationsRealTimePaymentsTransferCompleteParams
constructor(
    ...
    internal fun getBody(): SimulationsRealTimePaymentsTransferCompleteBody {
        return SimulationsRealTimePaymentsTransferCompleteBody(rejection, additionalBodyProperties)
    }
    ...
    @JsonDeserialize(builder = SimulationsRealTimePaymentsTransferCompleteBody.Builder::class)
    @NoAutoDetect
    class SimulationsRealTimePaymentsTransferCompleteBody
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is SimulationsRealTimePaymentsTransferCompleteBody &&
        ...
        override fun toString() =
            "SimulationsRealTimePaymentsTransferCompleteBody{rejection=$rejection, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(
                simulationsRealTimePaymentsTransferCompleteBody:
                    SimulationsRealTimePaymentsTransferCompleteBody
            ) = apply {
                this.rejection = simulationsRealTimePaymentsTransferCompleteBody.rejection
                additionalProperties(
                    simulationsRealTimePaymentsTransferCompleteBody.additionalProperties
                )
            }
            ...
            fun build(): SimulationsRealTimePaymentsTransferCompleteBody =
                SimulationsRealTimePaymentsTransferCompleteBody(
                    rejection,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SimulationsRealTimePaymentsTransferCompleteParams &&
    ...
    override fun toString() =
        "SimulationsRealTimePaymentsTransferCompleteParams{realTimePaymentsTransferId=$realTimePaymentsTransferId, rejection=$rejection, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            simulationsRealTimePaymentsTransferCompleteParams:
                SimulationsRealTimePaymentsTransferCompleteParams
        ) = apply {
            this.realTimePaymentsTransferId =
                simulationsRealTimePaymentsTransferCompleteParams.realTimePaymentsTransferId
            this.rejection = simulationsRealTimePaymentsTransferCompleteParams.rejection
            additionalQueryParams(
                simulationsRealTimePaymentsTransferCompleteParams.additionalQueryParams
            )
            additionalHeaders(simulationsRealTimePaymentsTransferCompleteParams.additionalHeaders)
            additionalBodyProperties(
                simulationsRealTimePaymentsTransferCompleteParams.additionalBodyProperties
            )
        }
        ...
        fun build(): SimulationsRealTimePaymentsTransferCompleteParams =
            SimulationsRealTimePaymentsTransferCompleteParams(
