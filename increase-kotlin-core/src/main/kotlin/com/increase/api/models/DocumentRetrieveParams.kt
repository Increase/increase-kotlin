...
class DocumentRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "DocumentRetrieveParams{documentId=$documentId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun documentId(documentId: String) = apply {
        ...
        fun build(): DocumentRetrieveParams = DocumentRetrieveParams(
            checkNotNull(documentId) {
                "`documentId` is required but was not set"
            },
