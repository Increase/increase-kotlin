...
class BookkeepingEntryListPage private constructor(
    ...
    companion object {
        ...
        fun of(bookkeepingEntriesService: BookkeepingEntryService, params: BookkeepingEntryListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<BookkeepingEntry>> = JsonMissing.of(),
    ...
    class AutoPager(
        private val firstPage: BookkeepingEntryListPage,

    ) : Sequence<BookkeepingEntry> {

        override fun iterator(): Iterator<BookkeepingEntry> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
