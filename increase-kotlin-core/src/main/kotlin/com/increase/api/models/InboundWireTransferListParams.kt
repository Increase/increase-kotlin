...
class InboundWireTransferListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "InboundWireTransferListParams{accountId=$accountId, accountNumberId=$accountNumberId, createdAt=$createdAt, cursor=$cursor, limit=$limit, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(inboundWireTransferListParams: InboundWireTransferListParams) = apply {
            ...
            additionalBodyProperties(inboundWireTransferListParams.additionalBodyProperties)
        }
        ...
        fun build(): InboundWireTransferListParams = InboundWireTransferListParams(
            accountId,
            accountNumberId,
            createdAt,
            cursor,
