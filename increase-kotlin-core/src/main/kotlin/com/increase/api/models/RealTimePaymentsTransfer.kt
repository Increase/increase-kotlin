...
@NoAutoDetect
class RealTimePaymentsTransfer private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
         ...
         * an intermediary receiving the payment for someone else.
         */
        fun ultimateCreditorName(ultimateCreditorName: String) = ultimateCreditorName(JsonField.of(ultimateCreditorName))
         ...
         * sent on behalf of someone who is not the account holder at Increase.
         */
        fun ultimateDebtorName(ultimateDebtorName: String) = ultimateDebtorName(JsonField.of(ultimateDebtorName))
        ...
        fun build(): RealTimePaymentsTransfer = RealTimePaymentsTransfer(
            accountId,
            amount,
            approval,
            cancellation,
    ...
    @NoAutoDetect
    class Rejection private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
             ...
             * the `reject_reason_code` is `NARRATIVE`.
             */
            fun rejectReasonAdditionalInformation(rejectReasonAdditionalInformation: String) = rejectReasonAdditionalInformation(JsonField.of(rejectReasonAdditionalInformation))
            ...
            @JsonProperty("reject_reason_additional_information")
            @ExcludeMissing
            fun rejectReasonAdditionalInformation(rejectReasonAdditionalInformation: JsonField<String>) = apply {
    ...
    @NoAutoDetect
    class Submission private constructor(private val submittedAt: JsonField<OffsetDateTime>, private val transactionIdentification: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
