 ...
 */
class InboundWireDrawdownRequestCreateParams private constructor(
     ...
     * beneficiary.
     */
    fun originatorToBeneficiaryInformationLine1(): String? = body.originatorToBeneficiaryInformationLine1()

    /**
     * Line 2 of the information conveyed from the originator of the message to the
     * beneficiary.
     */
    fun originatorToBeneficiaryInformationLine2(): String? = body.originatorToBeneficiaryInformationLine2()

    /**
     * Line 3 of the information conveyed from the originator of the message to the
     * beneficiary.
     */
    fun originatorToBeneficiaryInformationLine3(): String? = body.originatorToBeneficiaryInformationLine3()

    /**
     * Line 4 of the information conveyed from the originator of the message to the
     * beneficiary.
     */
    fun originatorToBeneficiaryInformationLine4(): String? = body.originatorToBeneficiaryInformationLine4()
     ...
     * beneficiary.
     */
    fun _originatorToBeneficiaryInformationLine1(): JsonField<String> = body._originatorToBeneficiaryInformationLine1()

    /**
     * Line 2 of the information conveyed from the originator of the message to the
     * beneficiary.
     */
    fun _originatorToBeneficiaryInformationLine2(): JsonField<String> = body._originatorToBeneficiaryInformationLine2()

    /**
     * Line 3 of the information conveyed from the originator of the message to the
     * beneficiary.
     */
    fun _originatorToBeneficiaryInformationLine3(): JsonField<String> = body._originatorToBeneficiaryInformationLine3()

    /**
     * Line 4 of the information conveyed from the originator of the message to the
     * beneficiary.
     */
    fun _originatorToBeneficiaryInformationLine4(): JsonField<String> = body._originatorToBeneficiaryInformationLine4()
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    originatorToBeneficiaryInformationLine1 = body.originatorToBeneficiaryInformationLine1
                    originatorToBeneficiaryInformationLine2 = body.originatorToBeneficiaryInformationLine2
                    originatorToBeneficiaryInformationLine3 = body.originatorToBeneficiaryInformationLine3
                    originatorToBeneficiaryInformationLine4 = body.originatorToBeneficiaryInformationLine4
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundWireDrawdownRequestCreateParams: InboundWireDrawdownRequestCreateParams) =
            apply {
                ...
                additionalQueryParams = inboundWireDrawdownRequestCreateParams.additionalQueryParams.toBuilder()
            }
         ...
         * beneficiary.
         */
        fun originatorToBeneficiaryInformationLine1(originatorToBeneficiaryInformationLine1: String) =
            apply {
         ...
         * beneficiary.
         */
        fun originatorToBeneficiaryInformationLine2(originatorToBeneficiaryInformationLine2: String) =
            apply {
         ...
         * beneficiary.
         */
        fun originatorToBeneficiaryInformationLine3(originatorToBeneficiaryInformationLine3: String) =
            apply {
         ...
         * beneficiary.
         */
        fun originatorToBeneficiaryInformationLine4(originatorToBeneficiaryInformationLine4: String) =
            apply {
    ...
    override fun toString() = "InboundWireDrawdownRequestCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
