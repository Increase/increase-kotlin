...
class AccountTransferRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "AccountTransferRetrieveParams{accountTransferId=$accountTransferId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(accountTransferRetrieveParams: AccountTransferRetrieveParams) = apply {
            ...
            additionalBodyProperties(accountTransferRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): AccountTransferRetrieveParams = AccountTransferRetrieveParams(
