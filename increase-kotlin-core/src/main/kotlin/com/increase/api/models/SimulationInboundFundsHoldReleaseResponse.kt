...
@NoAutoDetect
class SimulationInboundFundsHoldReleaseResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        internal fun from(simulationInboundFundsHoldReleaseResponse: SimulationInboundFundsHoldReleaseResponse) = apply {
            this.amount = simulationInboundFundsHoldReleaseResponse.amount
            this.automaticallyReleasesAt = simulationInboundFundsHoldReleaseResponse.automaticallyReleasesAt
            ...
            this.pendingTransactionId = simulationInboundFundsHoldReleaseResponse.pendingTransactionId
        ...
        fun build(): SimulationInboundFundsHoldReleaseResponse = SimulationInboundFundsHoldReleaseResponse(
            amount,
            automaticallyReleasesAt,
            createdAt,
            currency,
