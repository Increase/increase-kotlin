...
class AccountStatementRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountStatementRetrieveParams: AccountStatementRetrieveParams) =
            apply {
        ...
        /** The identifier of the Account Statement to retrieve. */
        fun accountStatementId(accountStatementId: String) =
            apply {
    ...
    override fun toString() = "AccountStatementRetrieveParams{accountStatementId=$accountStatementId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
