...
class AchPrenotificationListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "AchPrenotificationListParams{createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(achPrenotificationListParams: AchPrenotificationListParams) = apply {
            ...
            additionalBodyProperties(achPrenotificationListParams.additionalBodyProperties)
        }
        ...
        fun build(): AchPrenotificationListParams = AchPrenotificationListParams(
            createdAt,
            cursor,
            idempotencyKey,
            limit,
