...
class InboundMailItemListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(inboundMailItemsService: InboundMailItemServiceAsync, params: InboundMailItemListParams, response: Response) =
