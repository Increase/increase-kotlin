...
class InboundWireDrawdownRequestListPageAsync private constructor(private val inboundWireDrawdownRequestsService: InboundWireDrawdownRequestServiceAsync, private val params: InboundWireDrawdownRequestListParams, private val response: Response, ) {
    ...
    override fun toString() = "InboundWireDrawdownRequestListPageAsync{inboundWireDrawdownRequestsService=$inboundWireDrawdownRequestsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(inboundWireDrawdownRequestsService: InboundWireDrawdownRequestServiceAsync, params: InboundWireDrawdownRequestListParams, response: Response) = InboundWireDrawdownRequestListPageAsync(
            inboundWireDrawdownRequestsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<InboundWireDrawdownRequest>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "InboundWireDrawdownRequestListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: InboundWireDrawdownRequestListPageAsync, ) : Flow<InboundWireDrawdownRequest> {
