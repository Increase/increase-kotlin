...
class FednowTransferListParams
private constructor(
    ...
    companion object {
        ...
        fun none(): FednowTransferListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FednowTransferListParams]. */
        fun builder() = Builder()
    }

    /** A builder for [FednowTransferListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(fednowTransferListParams: FednowTransferListParams) = apply {
            accountId = fednowTransferListParams.accountId
            createdAt = fednowTransferListParams.createdAt
            cursor = fednowTransferListParams.cursor
            externalAccountId = fednowTransferListParams.externalAccountId
            idempotencyKey = fednowTransferListParams.idempotencyKey
            limit = fednowTransferListParams.limit
            status = fednowTransferListParams.status
            additionalHeaders = fednowTransferListParams.additionalHeaders.toBuilder()
            additionalQueryParams = fednowTransferListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FednowTransferListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FednowTransferListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FednowTransferListParams &&
    ...
    override fun toString() =
        "FednowTransferListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, externalAccountId=$externalAccountId, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
