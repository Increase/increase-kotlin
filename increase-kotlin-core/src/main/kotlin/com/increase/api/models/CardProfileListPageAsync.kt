...
private constructor(
    ...
    fun getNextPageParams(): CardProfileListParams? {
        ...
        return CardProfileListParams.builder()
            .from(params)
            .apply { nextCursor()?.let { this.cursor(it) } }
            .build()
    }

    suspend fun getNextPage(): CardProfileListPageAsync? {
    ...
    constructor(
        ...
        fun data(): List<CardProfile> = data.getNullable("data") ?: listOf()
    ...
    constructor(
        ...
        override suspend fun collect(collector: FlowCollector<CardProfile>) {
            var page = firstPage
            var index = 0
            while (true) {
