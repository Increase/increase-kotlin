...
private constructor(
    ...
    fun getNextPageParams(): TransactionListParams? {
        ...
        return TransactionListParams.builder().from(params).cursor(nextCursor()).build()
    }
    ...
    constructor(
        ...
        override fun toString() =
            "TransactionListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
