...
class File private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    @ExcludeMissing
    fun _downloadUrl() = downloadUrl

    /** The filename that was provided upon upload or generated by Increase. */
    @JsonProperty("filename")
    @ExcludeMissing
    fun _filename() = filename
    ...
    override fun toString() = "File{createdAt=$createdAt, description=$description, direction=$direction, downloadUrl=$downloadUrl, filename=$filename, id=$id, idempotencyKey=$idempotencyKey, mimeType=$mimeType, purpose=$purpose, type=$type, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JsonProperty("purpose")
        @ExcludeMissing
        fun purpose(purpose: JsonField<Purpose>) = apply {
    ...
    class Purpose @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            val DEPOSIT_ACCOUNT_CONTROL_AGREEMENT = Purpose(JsonField.of("deposit_account_control_agreement"))
