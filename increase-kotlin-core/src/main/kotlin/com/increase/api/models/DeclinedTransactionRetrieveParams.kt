...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DeclinedTransactionRetrieveParams && this.declinedTransactionId == other.declinedTransactionId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(declinedTransactionId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }
