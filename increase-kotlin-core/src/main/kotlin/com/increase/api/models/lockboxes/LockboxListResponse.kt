...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LockboxListResponse].
         *
    ...
    /** A builder for [LockboxListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(lockboxListResponse: LockboxListResponse) = apply {
            data = lockboxListResponse.data.map { it.toMutableList() }
            nextCursor = lockboxListResponse.nextCursor
            additionalProperties = lockboxListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LockboxListResponse].
         *
    ...
    fun validate(): LockboxListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LockboxListResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "LockboxListResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
