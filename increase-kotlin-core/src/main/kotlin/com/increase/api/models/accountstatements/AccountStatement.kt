 ...
 */
@NoAutoDetect
class AccountStatement @JsonCreator private constructor(
    ...
    @JsonProperty("ending_balance") @ExcludeMissing private val endingBalance: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("file_id") @ExcludeMissing private val fileId: JsonField<String> = JsonMissing.of(),
    @JsonProperty("starting_balance") @ExcludeMissing private val startingBalance: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("statement_period_end") @ExcludeMissing private val statementPeriodEnd: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("statement_period_start") @ExcludeMissing private val statementPeriodStart: JsonField<OffsetDateTime> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountStatement: AccountStatement) =
            apply {
        ...
        /** The Account's balance at the start of its statement period. */
        fun endingBalance(endingBalance: JsonField<Long>) =
            apply {
         ...
         * of the period the Account Statement covers.
         */
        fun statementPeriodEnd(statementPeriodEnd: JsonField<OffsetDateTime>) =
            apply {
         ...
         * start of the period the Account Statement covers.
         */
        fun statementPeriodStart(statementPeriodStart: JsonField<OffsetDateTime>) =
            apply {
    ...
    override fun toString() = "AccountStatement{id=$id, accountId=$accountId, createdAt=$createdAt, endingBalance=$endingBalance, fileId=$fileId, startingBalance=$startingBalance, statementPeriodEnd=$statementPeriodEnd, statementPeriodStart=$statementPeriodStart, type=$type, additionalProperties=$additionalProperties}"
}
