...
class CardPurchaseSupplementListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.cardPaymentId?.let {
          queryParams.put(
            "card_payment_id", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardPurchaseSupplementListParams: CardPurchaseSupplementListParams) =
            apply {
                cardPaymentId = cardPurchaseSupplementListParams.cardPaymentId
                createdAt = cardPurchaseSupplementListParams.createdAt
                cursor = cardPurchaseSupplementListParams.cursor
                limit = cardPurchaseSupplementListParams.limit
                additionalHeaders = cardPurchaseSupplementListParams.additionalHeaders.toBuilder()
                additionalQueryParams = cardPurchaseSupplementListParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "CardPurchaseSupplementListParams{cardPaymentId=$cardPaymentId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
