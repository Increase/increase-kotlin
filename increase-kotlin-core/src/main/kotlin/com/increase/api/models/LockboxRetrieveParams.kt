...
class LockboxRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "LockboxRetrieveParams{lockboxId=$lockboxId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(lockboxRetrieveParams: LockboxRetrieveParams) = apply {
            ...
            additionalBodyProperties(lockboxRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): LockboxRetrieveParams = LockboxRetrieveParams(
