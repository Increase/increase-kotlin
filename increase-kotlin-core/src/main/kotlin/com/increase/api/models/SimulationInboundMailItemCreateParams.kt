...
constructor(
    ...
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is SimulationInboundMailItemCreateBody && this.amount == other.amount && this.lockboxId == other.lockboxId && this.contentsFileId == other.contentsFileId && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun hashCode(): Int {
            if (hashCode == 0) {
                hashCode = /* spotless:off */ Objects.hash(amount, lockboxId, contentsFileId, additionalProperties) /* spotless:on */
            }
            return hashCode
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SimulationInboundMailItemCreateParams && this.amount == other.amount && this.lockboxId == other.lockboxId && this.contentsFileId == other.contentsFileId && this.additionalHeaders == other.additionalHeaders && this.additionalQueryParams == other.additionalQueryParams && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(amount, lockboxId, contentsFileId, additionalHeaders, additionalQueryParams, additionalBodyProperties) /* spotless:on */
    }
