...
class SimulationCheckDepositSubmitParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SimulationCheckDepositSubmitParams &&
    ...
    override fun toString() = "SimulationCheckDepositSubmitParams{checkDepositId=$checkDepositId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(simulationCheckDepositSubmitParams: SimulationCheckDepositSubmitParams) = apply {
            ...
            additionalBodyProperties(simulationCheckDepositSubmitParams.additionalBodyProperties)
        }
        ...
        fun build(): SimulationCheckDepositSubmitParams = SimulationCheckDepositSubmitParams(
