 ...
 * purchases can be made. The response will contain either a `pending_transaction` or a
 * `declined_transaction`; the other attribute will be null. If the authorization is declined, the
 * reason is available on the Declined Transaction at `source.card_decline.reason`.
 */
...
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Body &&
                amount == other.amount &&
                authenticatedCardPaymentId == other.authenticatedCardPaymentId &&
                cardId == other.cardId &&
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                terminalEntryCapability: JsonField<TerminalEntryCapability> = JsonMissing.of(),
            ) : this(
            ...
            /**
             * For electronic commerce transactions, this identifies the level of security used in
             * obtaining the customer's payment credential. For mail or telephone order
            ...
            /**
             * The method used to enter the cardholder's primary account number and card expiration
             * date.
             *
             * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g.
             *   if the server responded with an unexpected value).
             ...
             *
             * Unlike [electronicCommerceIndicator], this method doesn't throw if the JSON field has
             * an unexpected type.
             */
            @JsonProperty("electronic_commerce_indicator")
            @ExcludeMissing
             ...
             *
             * Unlike [pointOfServiceEntryMode], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("point_of_service_entry_mode")
            @ExcludeMissing
             ...
             *
             * Unlike [terminalEntryCapability], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("terminal_entry_capability")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                private var electronicCommerceIndicator: JsonField<ElectronicCommerceIndicator> =
                    JsonMissing.of()
                 ...
                 *
                 * You should usually call [Builder.electronicCommerceIndicator] with a well-typed
                 * [ElectronicCommerceIndicator] value instead. This method is primarily for setting
                 ...
                 * [PointOfServiceEntryMode] value instead. This method is primarily for setting the
                 ...
                 * chip-capable.
                 */
                fun terminalEntryCapability(terminalEntryCapability: TerminalEntryCapability) =
                    terminalEntryCapability(JsonField.of(terminalEntryCapability))

                /**
                 * Sets [Builder.terminalEntryCapability] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.terminalEntryCapability] with a well-typed
                 * [TerminalEntryCapability] value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                     ...
                     * transaction is a mail/phone order purchase, not a recurring transaction or
                     * installment payment. For domestic transactions in the US region, this value
                     * may also indicate one bill payment transaction in the card-present or
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    /**
                     * Transaction initiated using a credential that has previously been stored on
                     * file
                     */
                 ...
                 * [_UNKNOWN] member.
                 *
                 * An instance of [PointOfServiceEntryMode] can contain an unknown value in a couple
                 * of cases:
                 * - It was deserialized from data that doesn't match any known member. For example,
                 *   if the SDK is on an older version than the API, then the API may respond with
                 *   new members that the SDK is unaware of.
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    /**
                     * The terminal supports contact chip cards and can also read the magnetic
                     * stripe. If contact chip is supported, this value is used regardless of
                     * whether contactless is also supported.
                     */
                ...
                /**
                 * An enum containing [TerminalEntryCapability]'s known values, as well as an
                 * [_UNKNOWN] member.
                 *
                 * An instance of [TerminalEntryCapability] can contain an unknown value in a couple
                 * of cases:
                 * - It was deserialized from data that doesn't match any known member. For example,
                 *   if the SDK is on an older version than the API, then the API may respond with
                 *   new members that the SDK is unaware of.
                ...
                enum class Value {
                    ...
                    NO_CAPABILITY,
                    /**
                     * An enum member indicating that [TerminalEntryCapability] was instantiated
                     * with an unknown value.
                     */
                    _UNKNOWN,
                }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardAuthorizationCreateParams &&
            body == other.body &&
