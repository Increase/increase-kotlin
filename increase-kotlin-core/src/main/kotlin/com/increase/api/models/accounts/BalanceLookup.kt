 ...
 */
@NoAutoDetect
class BalanceLookup @JsonCreator private constructor(
    @JsonProperty("account_id") @ExcludeMissing private val accountId: JsonField<String> = JsonMissing.of(),
    @JsonProperty("available_balance") @ExcludeMissing private val availableBalance: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("current_balance") @ExcludeMissing private val currentBalance: JsonField<Long> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(balanceLookup: BalanceLookup) =
            apply {
         ...
         * Pending Transactions on the Account.
         */
        fun availableBalance(availableBalance: JsonField<Long>) =
            apply {
         ...
         * on the Account.
         */
        fun currentBalance(currentBalance: JsonField<Long>) =
            apply {
