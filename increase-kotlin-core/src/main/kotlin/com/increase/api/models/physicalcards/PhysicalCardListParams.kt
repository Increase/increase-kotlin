...
/** List Physical Cards */
class PhysicalCardListParams private constructor(
    ...
    /** A builder for [PhysicalCardListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(physicalCardListParams: PhysicalCardListParams) =
            apply {
    ...
    override fun toString() = "PhysicalCardListParams{cardId=$cardId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
