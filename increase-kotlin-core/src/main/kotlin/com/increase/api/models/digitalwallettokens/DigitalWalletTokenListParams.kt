...
class DigitalWalletTokenListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(digitalWalletTokenListParams: DigitalWalletTokenListParams) =
            apply {
    ...
    override fun toString() = "DigitalWalletTokenListParams{cardId=$cardId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
