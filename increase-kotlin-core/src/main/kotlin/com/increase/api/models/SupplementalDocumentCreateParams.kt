...
class SupplementalDocumentCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class SupplementalDocumentCreateBody internal constructor(private val entityId: String?, private val fileId: String?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "SupplementalDocumentCreateBody{entityId=$entityId, fileId=$fileId, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(supplementalDocumentCreateBody: SupplementalDocumentCreateBody) = apply {
            ...
            fun build(): SupplementalDocumentCreateBody = SupplementalDocumentCreateBody(
    ...
    override fun toString() = "SupplementalDocumentCreateParams{entityId=$entityId, fileId=$fileId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(supplementalDocumentCreateParams: SupplementalDocumentCreateParams) = apply {
        ...
        fun build(): SupplementalDocumentCreateParams = SupplementalDocumentCreateParams(
            checkNotNull(entityId) {
                "`entityId` is required but was not set"
            },
            checkNotNull(fileId) {
