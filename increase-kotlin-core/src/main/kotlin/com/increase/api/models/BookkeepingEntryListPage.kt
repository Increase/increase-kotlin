...
private constructor(
    ...
    fun getNextPageParams(): BookkeepingEntryListParams? {
        ...
        return BookkeepingEntryListParams.builder().from(params).cursor(nextCursor()).build()
    }
    ...
    constructor(
        ...
        override fun toString() =
            "BookkeepingEntryListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
