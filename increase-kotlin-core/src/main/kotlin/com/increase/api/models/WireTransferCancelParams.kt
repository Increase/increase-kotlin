...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WireTransferCancelParams && this.wireTransferId == other.wireTransferId && this.additionalHeaders == other.additionalHeaders && this.additionalQueryParams == other.additionalQueryParams && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    class Builder {
        ...
        internal fun from(wireTransferCancelParams: WireTransferCancelParams) = apply {
            ...
            additionalHeaders(wireTransferCancelParams.additionalHeaders)
            additionalQueryParams(wireTransferCancelParams.additionalQueryParams)
            additionalBodyProperties(wireTransferCancelParams.additionalBodyProperties)
        }
