...
class PhysicalCardProfileListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PhysicalCardProfileListParams &&
    ...
    override fun toString() = "PhysicalCardProfileListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(physicalCardProfileListParams: PhysicalCardProfileListParams) = apply {
            ...
            additionalBodyProperties(physicalCardProfileListParams.additionalBodyProperties)
        }
        ...
        fun build(): PhysicalCardProfileListParams = PhysicalCardProfileListParams(
            cursor,
            idempotencyKey,
            limit,
            status,
