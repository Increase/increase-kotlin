...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PhysicalCardProfileListParams && this.cursor == other.cursor && this.idempotencyKey == other.idempotencyKey && this.limit == other.limit && this.status == other.status && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(cursor, idempotencyKey, limit, status, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "PhysicalCardProfileListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(physicalCardProfileListParams: PhysicalCardProfileListParams) = apply {
            this.cursor = physicalCardProfileListParams.cursor
            this.idempotencyKey = physicalCardProfileListParams.idempotencyKey
            this.limit = physicalCardProfileListParams.limit
            this.status = physicalCardProfileListParams.status
            additionalQueryParams(physicalCardProfileListParams.additionalQueryParams)
            additionalHeaders(physicalCardProfileListParams.additionalHeaders)
        }
