...
private constructor(
    ...
    companion object {
        ...
        fun none(): EntityOnboardingSessionListParams = builder().build()
    ...
    /** A builder for [EntityOnboardingSessionListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(entityOnboardingSessionListParams: EntityOnboardingSessionListParams) =
            apply {
                cursor = entityOnboardingSessionListParams.cursor
                idempotencyKey = entityOnboardingSessionListParams.idempotencyKey
                limit = entityOnboardingSessionListParams.limit
                status = entityOnboardingSessionListParams.status
                additionalHeaders = entityOnboardingSessionListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    entityOnboardingSessionListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EntityOnboardingSessionListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EntityOnboardingSessionListParams =
            EntityOnboardingSessionListParams(
                cursor,
                idempotencyKey,
                limit,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityOnboardingSessionListParams &&
            cursor == other.cursor &&
    ...
    override fun toString() =
        "EntityOnboardingSessionListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
