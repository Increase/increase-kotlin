...
class PhysicalCardProfileListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(physicalCardProfileListParams: PhysicalCardProfileListParams) =
            apply {
    ...
    override fun toString() = "PhysicalCardProfileListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
