...
class CardDisputeRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CardDisputeRetrieveParams &&
    ...
    override fun toString() = "CardDisputeRetrieveParams{cardDisputeId=$cardDisputeId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(cardDisputeRetrieveParams: CardDisputeRetrieveParams) = apply {
            ...
            additionalBodyProperties(cardDisputeRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): CardDisputeRetrieveParams = CardDisputeRetrieveParams(
