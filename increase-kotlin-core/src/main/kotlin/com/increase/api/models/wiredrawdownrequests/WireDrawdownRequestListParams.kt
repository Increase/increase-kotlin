...
class WireDrawdownRequestListParams private constructor(
    ...
    /** A builder for [WireDrawdownRequestListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(wireDrawdownRequestListParams: WireDrawdownRequestListParams) =
            apply {
    ...
    override fun toString() = "WireDrawdownRequestListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
