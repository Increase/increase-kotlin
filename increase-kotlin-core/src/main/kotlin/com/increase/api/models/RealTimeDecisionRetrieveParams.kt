...
class RealTimeDecisionRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RealTimeDecisionRetrieveParams &&
    ...
    override fun toString() = "RealTimeDecisionRetrieveParams{realTimeDecisionId=$realTimeDecisionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(realTimeDecisionRetrieveParams: RealTimeDecisionRetrieveParams) = apply {
            ...
            additionalBodyProperties(realTimeDecisionRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): RealTimeDecisionRetrieveParams = RealTimeDecisionRetrieveParams(
