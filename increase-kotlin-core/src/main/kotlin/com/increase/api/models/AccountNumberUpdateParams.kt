...
class AccountNumberUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class AccountNumberUpdateBody internal constructor(
      private val inboundAch: InboundAch?,
      private val inboundChecks: InboundChecks?,
      private val name: String?,
      private val status: Status?,
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "AccountNumberUpdateBody{inboundAch=$inboundAch, inboundChecks=$inboundChecks, name=$name, status=$status, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): AccountNumberUpdateBody = AccountNumberUpdateBody(
                inboundAch,
                inboundChecks,
                name,
                status,
    ...
    override fun toString() = "AccountNumberUpdateParams{accountNumberId=$accountNumberId, inboundAch=$inboundAch, inboundChecks=$inboundChecks, name=$name, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): AccountNumberUpdateParams = AccountNumberUpdateParams(
