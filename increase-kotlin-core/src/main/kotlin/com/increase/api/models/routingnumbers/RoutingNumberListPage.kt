...
private constructor(
...
) : Page<RoutingNumberListResponse> {
    ...
    override fun nextPage(): RoutingNumberListPage = service.list(nextPageParams())

    fun autoPager(): AutoPager<RoutingNumberListResponse> = AutoPager.from(this)
