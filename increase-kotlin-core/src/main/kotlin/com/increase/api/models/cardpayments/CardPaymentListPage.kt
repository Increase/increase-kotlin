...
/** List Card Payments */
class CardPaymentListPage private constructor(
    ...
    companion object {
        ...
        fun of(cardPaymentsService: CardPaymentService, params: CardPaymentListParams, response: Response) =
            CardPaymentListPage(
              cardPaymentsService,
              params,
              response,
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<CardPayment> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
