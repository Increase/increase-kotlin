...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CardPurchaseSupplement>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CardPurchaseSupplement> = data.getRequired("data")
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<CardPurchaseSupplement>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<CardPurchaseSupplement>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<CardPurchaseSupplement>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CardPurchaseSupplement] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CardPurchaseSupplement) = apply {
            this.data =
