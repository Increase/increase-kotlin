...
class WireDrawdownRequestListPageAsync private constructor(private val wireDrawdownRequestsService: WireDrawdownRequestServiceAsync, private val params: WireDrawdownRequestListParams, private val response: Response, ) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is WireDrawdownRequestListPageAsync &&
    ...
    companion object {
        ...
        fun of(wireDrawdownRequestsService: WireDrawdownRequestServiceAsync, params: WireDrawdownRequestListParams, response: Response) = WireDrawdownRequestListPageAsync(
            wireDrawdownRequestsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<WireDrawdownRequest>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "WireDrawdownRequestListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: WireDrawdownRequestListPageAsync, ) : Flow<WireDrawdownRequest> {
