...
/** List Card Disputes */
class CardDisputeListPage private constructor(
    ...
    companion object {
        ...
        fun of(cardDisputesService: CardDisputeService, params: CardDisputeListParams, response: Response) =
            CardDisputeListPage(
              cardDisputesService,
              params,
              response,
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<CardDispute> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
