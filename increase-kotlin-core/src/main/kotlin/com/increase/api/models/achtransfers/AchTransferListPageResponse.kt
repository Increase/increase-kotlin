...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<AchTransfer>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<AchTransfer>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<AchTransfer>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<AchTransfer>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<AchTransfer>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AchTransfer] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AchTransfer) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AchTransferListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
