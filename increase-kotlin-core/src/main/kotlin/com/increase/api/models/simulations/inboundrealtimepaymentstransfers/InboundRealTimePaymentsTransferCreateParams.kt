 ...
 */
class InboundRealTimePaymentsTransferCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("request_for_payment_id") @ExcludeMissing private val requestForPaymentId: JsonField<String> = JsonMissing.of(),
        ...
        /** The account number of the account that sent the transfer. */
        fun debtorAccountNumber(): String? = debtorAccountNumber.getNullable("debtor_account_number")

        /** The name provided by the sender of the transfer. */
        fun debtorName(): String? = debtorName.getNullable("debtor_name")

        /** The routing number of the account that sent the transfer. */
        fun debtorRoutingNumber(): String? = debtorRoutingNumber.getNullable("debtor_routing_number")

        /** Additional information included with the transfer. */
        fun remittanceInformation(): String? = remittanceInformation.getNullable("remittance_information")

        /** The identifier of a pending Request for Payment that this transfer will fulfill. */
        fun requestForPaymentId(): String? = requestForPaymentId.getNullable("request_for_payment_id")
        ...
        class Builder internal constructor() {
            ...
            /** The identifier of a pending Request for Payment that this transfer will fulfill. */
            fun requestForPaymentId(requestForPaymentId: String) = requestForPaymentId(JsonField.of(requestForPaymentId))

            /** The identifier of a pending Request for Payment that this transfer will fulfill. */
            fun requestForPaymentId(requestForPaymentId: JsonField<String>) =
                apply {
        ...
        override fun toString() = "Body{accountNumberId=$accountNumberId, amount=$amount, debtorAccountNumber=$debtorAccountNumber, debtorName=$debtorName, debtorRoutingNumber=$debtorRoutingNumber, remittanceInformation=$remittanceInformation, requestForPaymentId=$requestForPaymentId, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundRealTimePaymentsTransferCreateParams: InboundRealTimePaymentsTransferCreateParams) =
            apply {
                body = inboundRealTimePaymentsTransferCreateParams.body.toBuilder()
                additionalHeaders = inboundRealTimePaymentsTransferCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = inboundRealTimePaymentsTransferCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "InboundRealTimePaymentsTransferCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
