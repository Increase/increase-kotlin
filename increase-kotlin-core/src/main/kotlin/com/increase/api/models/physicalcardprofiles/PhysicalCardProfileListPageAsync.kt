...
class PhysicalCardProfileListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(physicalCardProfilesService: PhysicalCardProfileServiceAsync, params: PhysicalCardProfileListParams, response: Response) =
