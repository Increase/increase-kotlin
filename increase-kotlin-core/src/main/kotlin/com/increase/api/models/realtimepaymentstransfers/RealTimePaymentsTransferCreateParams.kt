...
class RealTimePaymentsTransferCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        /** The destination account number. */
        fun destinationAccountNumber(): String? = destinationAccountNumber.getNullable("destination_account_number")

        /**
         * The destination American Bankers' Association (ABA) Routing Transit Number
         * (RTN).
         */
        fun destinationRoutingNumber(): String? = destinationRoutingNumber.getNullable("destination_routing_number")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(realTimePaymentsTransferCreateParams: RealTimePaymentsTransferCreateParams) =
            apply {
                ...
                additionalQueryParams = realTimePaymentsTransferCreateParams.additionalQueryParams.toBuilder()
            }
         ...
         * account's entity.
         */
        fun debtorName(debtorName: String) =
            apply {
    ...
    override fun toString() = "RealTimePaymentsTransferCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
