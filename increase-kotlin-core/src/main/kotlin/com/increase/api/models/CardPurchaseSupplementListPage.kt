...
class CardPurchaseSupplementListPage private constructor(private val cardPurchaseSupplementsService: CardPurchaseSupplementService, private val params: CardPurchaseSupplementListParams, private val response: Response, ) {
    ...
    override fun toString() = "CardPurchaseSupplementListPage{cardPurchaseSupplementsService=$cardPurchaseSupplementsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(cardPurchaseSupplementsService: CardPurchaseSupplementService, params: CardPurchaseSupplementListParams, response: Response) = CardPurchaseSupplementListPage(
            cardPurchaseSupplementsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<CardPurchaseSupplement>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "CardPurchaseSupplementListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: CardPurchaseSupplementListPage, ) : Sequence<CardPurchaseSupplement> {
