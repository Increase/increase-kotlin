...
class WireDrawdownRequestListPage private constructor(
    ...
    companion object {
        ...
        fun of(wireDrawdownRequestsService: WireDrawdownRequestService, params: WireDrawdownRequestListParams, response: Response) =
