...
class CardPaymentListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "CardPaymentListParams{accountId=$accountId, cardId=$cardId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(cardPaymentListParams: CardPaymentListParams) = apply {
            ...
            additionalBodyProperties(cardPaymentListParams.additionalBodyProperties)
        }
        ...
        fun build(): CardPaymentListParams = CardPaymentListParams(
            accountId,
            cardId,
            createdAt,
            cursor,
