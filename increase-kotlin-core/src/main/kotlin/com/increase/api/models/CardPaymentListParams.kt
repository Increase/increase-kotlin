...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardPaymentListParams && this.accountId == other.accountId && this.cardId == other.cardId && this.createdAt == other.createdAt && this.cursor == other.cursor && this.limit == other.limit && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(accountId, cardId, createdAt, cursor, limit, additionalQueryParams, additionalHeaders) /* spotless:on */
    }
