...
private constructor(
    ...
    fun getNextPageParams(): AccountStatementListParams? {
        ...
        return AccountStatementListParams.builder().from(params).cursor(nextCursor()).build()
    }
    ...
    constructor(
        ...
        override fun toString() =
            "AccountStatementListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
