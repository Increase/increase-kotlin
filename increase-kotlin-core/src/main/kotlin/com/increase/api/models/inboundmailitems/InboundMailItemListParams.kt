...
class InboundMailItemListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundMailItemListParams: InboundMailItemListParams) =
            apply {
    ...
    override fun toString() = "InboundMailItemListParams{createdAt=$createdAt, cursor=$cursor, limit=$limit, lockboxId=$lockboxId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
