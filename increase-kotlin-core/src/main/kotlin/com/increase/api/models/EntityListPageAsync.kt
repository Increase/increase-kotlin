...
class EntityListPageAsync private constructor(private val entitiesService: EntityServiceAsync, private val params: EntityListParams, private val response: Response, ) {
    ...
    override fun toString() = "EntityListPageAsync{entitiesService=$entitiesService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(entitiesService: EntityServiceAsync, params: EntityListParams, response: Response) = EntityListPageAsync(
            entitiesService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<Entity>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "EntityListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: EntityListPageAsync, ) : Flow<Entity> {
