 ...
 */
class RoutingNumberListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.routingNumber.let {
          queryParams.put(
            "routing_number", listOf(it.toString())
          )
      }
      this.cursor?.let {
          queryParams.put(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(routingNumberListParams: RoutingNumberListParams) =
            apply {
    ...
    override fun toString() = "RoutingNumberListParams{routingNumber=$routingNumber, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
