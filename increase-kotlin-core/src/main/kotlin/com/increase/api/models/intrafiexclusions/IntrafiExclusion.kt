 ...
 */
@NoAutoDetect
class IntrafiExclusion @JsonCreator private constructor(
    @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
    @JsonProperty("bank_name") @ExcludeMissing private val bankName: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("excluded_at") @ExcludeMissing private val excludedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(intrafiExclusion: IntrafiExclusion) =
            apply {
        ...
        /** When this was exclusion was confirmed by IntraFi. */
        fun excludedAt(excludedAt: JsonField<OffsetDateTime>) =
            apply {
         ...
         * institution.
         */
        fun fdicCertificateNumber(fdicCertificateNumber: String?) = fdicCertificateNumber(JsonField.ofNullable(fdicCertificateNumber))
    ...
    override fun toString() = "IntrafiExclusion{id=$id, bankName=$bankName, createdAt=$createdAt, entityId=$entityId, excludedAt=$excludedAt, fdicCertificateNumber=$fdicCertificateNumber, idempotencyKey=$idempotencyKey, status=$status, submittedAt=$submittedAt, type=$type, additionalProperties=$additionalProperties}"
}
