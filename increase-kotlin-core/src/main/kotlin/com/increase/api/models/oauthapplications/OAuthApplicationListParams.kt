...
class OAuthApplicationListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(oauthApplicationListParams: OAuthApplicationListParams) =
            apply {
    ...
    override fun toString() = "OAuthApplicationListParams{createdAt=$createdAt, cursor=$cursor, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
