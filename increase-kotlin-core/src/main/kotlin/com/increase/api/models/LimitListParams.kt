...
constructor(
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.modelId?.let { params.put("model_id", listOf(it.toString())) }
    ...
    override fun toString() =
        "LimitListParams{cursor=$cursor, limit=$limit, modelId=$modelId, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
