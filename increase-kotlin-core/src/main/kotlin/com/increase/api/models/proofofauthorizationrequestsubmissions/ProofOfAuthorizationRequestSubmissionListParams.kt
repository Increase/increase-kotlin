...
class ProofOfAuthorizationRequestSubmissionListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.proofOfAuthorizationRequestId?.let {
          queryParams.put(
            "proof_of_authorization_request_id", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(proofOfAuthorizationRequestSubmissionListParams: ProofOfAuthorizationRequestSubmissionListParams) =
            apply {
                ...
                proofOfAuthorizationRequestId = proofOfAuthorizationRequestSubmissionListParams.proofOfAuthorizationRequestId
                additionalHeaders = proofOfAuthorizationRequestSubmissionListParams.additionalHeaders.toBuilder()
                additionalQueryParams = proofOfAuthorizationRequestSubmissionListParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "ProofOfAuthorizationRequestSubmissionListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, proofOfAuthorizationRequestId=$proofOfAuthorizationRequestId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
