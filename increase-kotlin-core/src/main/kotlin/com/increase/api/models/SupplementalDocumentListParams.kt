...
class SupplementalDocumentListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SupplementalDocumentListParams &&
    ...
    override fun toString() = "SupplementalDocumentListParams{entityId=$entityId, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(supplementalDocumentListParams: SupplementalDocumentListParams) = apply {
            ...
            additionalBodyProperties(supplementalDocumentListParams.additionalBodyProperties)
        }
        ...
        fun build(): SupplementalDocumentListParams = SupplementalDocumentListParams(
