...
class IntrafiExclusionArchiveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(intrafiExclusionArchiveParams: IntrafiExclusionArchiveParams) =
            apply {
                ...
                additionalBodyProperties = intrafiExclusionArchiveParams.additionalBodyProperties.toMutableMap()
            }
         ...
         * does not guarantee that funds will be swept to the previously-excluded bank.
         */
        fun intrafiExclusionId(intrafiExclusionId: String) =
            apply {
    ...
    override fun toString() = "IntrafiExclusionArchiveParams{intrafiExclusionId=$intrafiExclusionId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
