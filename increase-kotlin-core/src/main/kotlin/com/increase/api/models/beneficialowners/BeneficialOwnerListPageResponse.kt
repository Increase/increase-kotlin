...
private constructor(
    private val data: JsonField<List<EntityBeneficialOwner>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EntityBeneficialOwner>> = JsonMissing.of(),
     ...
     */
    fun data(): List<EntityBeneficialOwner> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EntityBeneficialOwner>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<EntityBeneficialOwner>>? = null
        ...
        /** The contents of the list. */
        fun data(data: List<EntityBeneficialOwner>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EntityBeneficialOwner>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<EntityBeneficialOwner>>) = apply {
