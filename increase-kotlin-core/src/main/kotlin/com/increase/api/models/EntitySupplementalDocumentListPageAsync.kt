...
private constructor(
    ...
    suspend fun getNextPage(): EntitySupplementalDocumentListPageAsync? {
    ...
    ) : Flow<SupplementalDocument> {

        override suspend fun collect(collector: FlowCollector<SupplementalDocument>) {
            var page = firstPage
            var index = 0
            while (true) {
