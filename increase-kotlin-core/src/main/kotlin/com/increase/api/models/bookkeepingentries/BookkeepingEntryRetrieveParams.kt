...
class BookkeepingEntryRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bookkeepingEntryRetrieveParams: BookkeepingEntryRetrieveParams) =
            apply {
        ...
        /** The identifier of the Bookkeeping Entry. */
        fun bookkeepingEntryId(bookkeepingEntryId: String) =
            apply {
    ...
    override fun toString() = "BookkeepingEntryRetrieveParams{bookkeepingEntryId=$bookkeepingEntryId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
