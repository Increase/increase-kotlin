...
class InboundFednowTransferCreateParams
private constructor(
    ...
    /** A builder for [InboundFednowTransferCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(inboundFednowTransferCreateParams: InboundFednowTransferCreateParams) =
            apply {
                body = inboundFednowTransferCreateParams.body.toBuilder()
                additionalHeaders = inboundFednowTransferCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    inboundFednowTransferCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [InboundFednowTransferCreateParams].
         *
         ...
         */
        fun build(): InboundFednowTransferCreateParams =
            InboundFednowTransferCreateParams(
                body.build(),
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{accountNumberId=$accountNumberId, amount=$amount, debtorAccountNumber=$debtorAccountNumber, debtorName=$debtorName, debtorRoutingNumber=$debtorRoutingNumber, unstructuredRemittanceInformation=$unstructuredRemittanceInformation, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InboundFednowTransferCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "InboundFednowTransferCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
