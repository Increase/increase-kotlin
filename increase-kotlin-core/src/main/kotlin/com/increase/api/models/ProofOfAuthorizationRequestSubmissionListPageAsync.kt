...
class ProofOfAuthorizationRequestSubmissionListPageAsync private constructor(private val proofOfAuthorizationRequestSubmissionsService: ProofOfAuthorizationRequestSubmissionServiceAsync, private val params: ProofOfAuthorizationRequestSubmissionListParams, private val response: Response, ) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProofOfAuthorizationRequestSubmissionListPageAsync &&
    ...
    override fun toString() = "ProofOfAuthorizationRequestSubmissionListPageAsync{proofOfAuthorizationRequestSubmissionsService=$proofOfAuthorizationRequestSubmissionsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(proofOfAuthorizationRequestSubmissionsService: ProofOfAuthorizationRequestSubmissionServiceAsync, params: ProofOfAuthorizationRequestSubmissionListParams, response: Response) = ProofOfAuthorizationRequestSubmissionListPageAsync(
            proofOfAuthorizationRequestSubmissionsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<ProofOfAuthorizationRequestSubmission>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "ProofOfAuthorizationRequestSubmissionListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: ProofOfAuthorizationRequestSubmissionListPageAsync, ) : Flow<ProofOfAuthorizationRequestSubmission> {

        override suspend fun collect(collector: FlowCollector<ProofOfAuthorizationRequestSubmission>) {
          var page = firstPage
          var index = 0
          while (true) {
