...
class OAuthTokenCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("grant_type") @ExcludeMissing private val grantType: JsonField<GrantType> = JsonMissing.of(),
        @JsonProperty("client_id") @ExcludeMissing private val clientId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("client_secret") @ExcludeMissing private val clientSecret: JsonField<String> = JsonMissing.of(),
        @JsonProperty("code") @ExcludeMissing private val code: JsonField<String> = JsonMissing.of(),
        @JsonProperty("production_token") @ExcludeMissing private val productionToken: JsonField<String> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             * always `authorization_code`. In Sandbox, you can pass either enum value.
             */
            fun grantType(grantType: JsonField<GrantType>) =
                apply {
             ...
             * parameter.
             */
            fun productionToken(productionToken: String) = productionToken(JsonField.of(productionToken))
             ...
             * parameter.
             */
            fun productionToken(productionToken: JsonField<String>) =
                apply {
        ...
        override fun toString() = "Body{grantType=$grantType, clientId=$clientId, clientSecret=$clientSecret, code=$code, productionToken=$productionToken, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(oauthTokenCreateParams: OAuthTokenCreateParams) =
            apply {
     ...
     * always `authorization_code`. In Sandbox, you can pass either enum value.
     */
    class GrantType @JsonCreator private constructor(
        ...
        enum class Value {
            ...
            PRODUCTION_TOKEN,
            /**
             * An enum member indicating that [GrantType] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
    ...
    override fun toString() = "OAuthTokenCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
