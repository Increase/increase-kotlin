...
/** List Physical Cards */
class PhysicalCardListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(physicalCardsService: PhysicalCardServiceAsync, params: PhysicalCardListParams, response: Response) =
