...
class SimulationAchTransferReturnParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class SimulationAchTransferReturnBody internal constructor(private val reason: Reason?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "SimulationAchTransferReturnBody{reason=$reason, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(simulationAchTransferReturnBody: SimulationAchTransferReturnBody) = apply {
            ...
            fun build(): SimulationAchTransferReturnBody = SimulationAchTransferReturnBody(reason, additionalProperties.toUnmodifiable())
        }
    }
    ...
    override fun toString() = "SimulationAchTransferReturnParams{achTransferId=$achTransferId, reason=$reason, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(simulationAchTransferReturnParams: SimulationAchTransferReturnParams) = apply {
        ...
        fun build(): SimulationAchTransferReturnParams = SimulationAchTransferReturnParams(
    ...
    class Reason @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            val INVALID_ACCOUNT_NUMBER_STRUCTURE = Reason(JsonField.of("invalid_account_number_structure"))

            val ACCOUNT_FROZEN_ENTRY_RETURNED_PER_OFAC_INSTRUCTION = Reason(JsonField.of("account_frozen_entry_returned_per_ofac_instruction"))

            val CREDIT_ENTRY_REFUSED_BY_RECEIVER = Reason(JsonField.of("credit_entry_refused_by_receiver"))

            val UNAUTHORIZED_DEBIT_TO_CONSUMER_ACCOUNT_USING_CORPORATE_SEC_CODE = Reason(JsonField.of("unauthorized_debit_to_consumer_account_using_corporate_sec_code"))
            ...
            val ROUTING_NUMBER_CHECK_DIGIT_ERROR = Reason(JsonField.of("routing_number_check_digit_error"))
            ...
            val INCORRECTLY_CODED_OUTBOUND_INTERNATIONAL_PAYMENT = Reason(JsonField.of("incorrectly_coded_outbound_international_payment"))
            ...
            val CUSTOMER_ADVISED_NOT_WITHIN_AUTHORIZATION_TERMS = Reason(JsonField.of("customer_advised_not_within_authorization_terms"))
            ...
            val ENR_INVALID_DFI_ACCOUNT_NUMBER = Reason(JsonField.of("enr_invalid_dfi_account_number"))

            val ENR_INVALID_INDIVIDUAL_ID_NUMBER = Reason(JsonField.of("enr_invalid_individual_id_number"))

            val ENR_INVALID_REPRESENTATIVE_PAYEE_INDICATOR = Reason(JsonField.of("enr_invalid_representative_payee_indicator"))
            ...
            val ENR_ROUTING_NUMBER_CHECK_DIGIT_ERROR = Reason(JsonField.of("enr_routing_number_check_digit_error"))

            val ENTRY_NOT_PROCESSED_BY_GATEWAY = Reason(JsonField.of("entry_not_processed_by_gateway"))

            val FIELD_ERROR = Reason(JsonField.of("field_error"))

            val FOREIGN_RECEIVING_DFI_UNABLE_TO_SETTLE = Reason(JsonField.of("foreign_receiving_dfi_unable_to_settle"))

            val IAT_ENTRY_CODING_ERROR = Reason(JsonField.of("iat_entry_coding_error"))

            val IMPROPER_EFFECTIVE_ENTRY_DATE = Reason(JsonField.of("improper_effective_entry_date"))

            val IMPROPER_SOURCE_DOCUMENT_SOURCE_DOCUMENT_PRESENTED = Reason(JsonField.of("improper_source_document_source_document_presented"))

            val INVALID_COMPANY_ID = Reason(JsonField.of("invalid_company_id"))

            val INVALID_FOREIGN_RECEIVING_DFI_IDENTIFICATION = Reason(JsonField.of("invalid_foreign_receiving_dfi_identification"))

            val INVALID_INDIVIDUAL_ID_NUMBER = Reason(JsonField.of("invalid_individual_id_number"))

            val ITEM_AND_RCK_ENTRY_PRESENTED_FOR_PAYMENT = Reason(JsonField.of("item_and_rck_entry_presented_for_payment"))

            val ITEM_RELATED_TO_RCK_ENTRY_IS_INELIGIBLE = Reason(JsonField.of("item_related_to_rck_entry_is_ineligible"))
            ...
            val NON_ACCEPTANCE_OF_R62_DISHONORED_RETURN = Reason(JsonField.of("non_acceptance_of_r62_dishonored_return"))

            val NON_PARTICIPANT_IN_IAT_PROGRAM = Reason(JsonField.of("non_participant_in_iat_program"))

            val PERMISSIBLE_RETURN_ENTRY = Reason(JsonField.of("permissible_return_entry"))

            val PERMISSIBLE_RETURN_ENTRY_NOT_ACCEPTED = Reason(JsonField.of("permissible_return_entry_not_accepted"))

            val RDFI_NON_SETTLEMENT = Reason(JsonField.of("rdfi_non_settlement"))

            val RDFI_PARTICIPANT_IN_CHECK_TRUNCATION_PROGRAM = Reason(JsonField.of("rdfi_participant_in_check_truncation_program"))
            ...
            val RETURN_OF_IMPROPER_CREDIT_ENTRY = Reason(JsonField.of("return_of_improper_credit_entry"))

            val RETURN_OF_IMPROPER_DEBIT_ENTRY = Reason(JsonField.of("return_of_improper_debit_entry"))

            val RETURN_OF_XCK_ENTRY = Reason(JsonField.of("return_of_xck_entry"))

            val SOURCE_DOCUMENT_PRESENTED_FOR_PAYMENT = Reason(JsonField.of("source_document_presented_for_payment"))

            val STATE_LAW_AFFECTING_RCK_ACCEPTANCE = Reason(JsonField.of("state_law_affecting_rck_acceptance"))

            val STOP_PAYMENT_ON_ITEM_RELATED_TO_RCK_ENTRY = Reason(JsonField.of("stop_payment_on_item_related_to_rck_entry"))

            val STOP_PAYMENT_ON_SOURCE_DOCUMENT = Reason(JsonField.of("stop_payment_on_source_document"))
