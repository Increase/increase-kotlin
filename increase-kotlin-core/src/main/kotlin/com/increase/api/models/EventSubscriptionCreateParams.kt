...
class EventSubscriptionCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class EventSubscriptionCreateBody internal constructor(
      private val url: String?,
      private val oauthConnectionId: String?,
      private val selectedEventCategory: SelectedEventCategory?,
      private val sharedSecret: String?,
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "EventSubscriptionCreateBody{url=$url, oauthConnectionId=$oauthConnectionId, selectedEventCategory=$selectedEventCategory, sharedSecret=$sharedSecret, additionalProperties=$additionalProperties}"
        ...
        class Builder {
             ...
             */
            @JsonProperty("shared_secret")
            fun sharedSecret(sharedSecret: String) = apply {
            ...
            fun build(): EventSubscriptionCreateBody = EventSubscriptionCreateBody(
                checkNotNull(url) {
    ...
    override fun toString() = "EventSubscriptionCreateParams{url=$url, oauthConnectionId=$oauthConnectionId, selectedEventCategory=$selectedEventCategory, sharedSecret=$sharedSecret, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): EventSubscriptionCreateParams = EventSubscriptionCreateParams(
            checkNotNull(url) {
                "`url` is required but was not set"
            },
            oauthConnectionId,
    ...
    class SelectedEventCategory @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            val ACCOUNT_NUMBER_CREATED = SelectedEventCategory(JsonField.of("account_number.created"))

            val ACCOUNT_NUMBER_UPDATED = SelectedEventCategory(JsonField.of("account_number.updated"))

            val ACCOUNT_STATEMENT_CREATED = SelectedEventCategory(JsonField.of("account_statement.created"))

            val ACCOUNT_TRANSFER_CREATED = SelectedEventCategory(JsonField.of("account_transfer.created"))

            val ACCOUNT_TRANSFER_UPDATED = SelectedEventCategory(JsonField.of("account_transfer.updated"))

            val ACH_PRENOTIFICATION_CREATED = SelectedEventCategory(JsonField.of("ach_prenotification.created"))

            val ACH_PRENOTIFICATION_UPDATED = SelectedEventCategory(JsonField.of("ach_prenotification.updated"))
            ...
            val BOOKKEEPING_ACCOUNT_CREATED = SelectedEventCategory(JsonField.of("bookkeeping_account.created"))

            val BOOKKEEPING_ACCOUNT_UPDATED = SelectedEventCategory(JsonField.of("bookkeeping_account.updated"))

            val BOOKKEEPING_ENTRY_SET_UPDATED = SelectedEventCategory(JsonField.of("bookkeeping_entry_set.updated"))
            ...
            val CHECK_TRANSFER_CREATED = SelectedEventCategory(JsonField.of("check_transfer.created"))

            val CHECK_TRANSFER_UPDATED = SelectedEventCategory(JsonField.of("check_transfer.updated"))

            val DECLINED_TRANSACTION_CREATED = SelectedEventCategory(JsonField.of("declined_transaction.created"))

            val DIGITAL_CARD_PROFILE_CREATED = SelectedEventCategory(JsonField.of("digital_card_profile.created"))

            val DIGITAL_CARD_PROFILE_UPDATED = SelectedEventCategory(JsonField.of("digital_card_profile.updated"))

            val DIGITAL_WALLET_TOKEN_CREATED = SelectedEventCategory(JsonField.of("digital_wallet_token.created"))

            val DIGITAL_WALLET_TOKEN_UPDATED = SelectedEventCategory(JsonField.of("digital_wallet_token.updated"))
            ...
            val EVENT_SUBSCRIPTION_CREATED = SelectedEventCategory(JsonField.of("event_subscription.created"))

            val EVENT_SUBSCRIPTION_UPDATED = SelectedEventCategory(JsonField.of("event_subscription.updated"))
            ...
            val EXTERNAL_ACCOUNT_CREATED = SelectedEventCategory(JsonField.of("external_account.created"))

            val EXTERNAL_ACCOUNT_UPDATED = SelectedEventCategory(JsonField.of("external_account.updated"))
            ...
            val INBOUND_ACH_TRANSFER_CREATED = SelectedEventCategory(JsonField.of("inbound_ach_transfer.created"))

            val INBOUND_ACH_TRANSFER_UPDATED = SelectedEventCategory(JsonField.of("inbound_ach_transfer.updated"))

            val INBOUND_ACH_TRANSFER_RETURN_CREATED = SelectedEventCategory(JsonField.of("inbound_ach_transfer_return.created"))

            val INBOUND_ACH_TRANSFER_RETURN_UPDATED = SelectedEventCategory(JsonField.of("inbound_ach_transfer_return.updated"))

            val INBOUND_CHECK_DEPOSIT_CREATED = SelectedEventCategory(JsonField.of("inbound_check_deposit.created"))

            val INBOUND_CHECK_DEPOSIT_UPDATED = SelectedEventCategory(JsonField.of("inbound_check_deposit.updated"))

            val INBOUND_MAIL_ITEM_CREATED = SelectedEventCategory(JsonField.of("inbound_mail_item.created"))

            val INBOUND_MAIL_ITEM_UPDATED = SelectedEventCategory(JsonField.of("inbound_mail_item.updated"))

            val INBOUND_WIRE_DRAWDOWN_REQUEST_CREATED = SelectedEventCategory(JsonField.of("inbound_wire_drawdown_request.created"))

            val INBOUND_WIRE_TRANSFER_CREATED = SelectedEventCategory(JsonField.of("inbound_wire_transfer.created"))

            val INBOUND_WIRE_TRANSFER_UPDATED = SelectedEventCategory(JsonField.of("inbound_wire_transfer.updated"))

            val INTRAFI_ACCOUNT_ENROLLMENT_CREATED = SelectedEventCategory(JsonField.of("intrafi_account_enrollment.created"))

            val INTRAFI_ACCOUNT_ENROLLMENT_UPDATED = SelectedEventCategory(JsonField.of("intrafi_account_enrollment.updated"))

            val INTRAFI_EXCLUSION_CREATED = SelectedEventCategory(JsonField.of("intrafi_exclusion.created"))

            val INTRAFI_EXCLUSION_UPDATED = SelectedEventCategory(JsonField.of("intrafi_exclusion.updated"))
            ...
            val OAUTH_CONNECTION_CREATED = SelectedEventCategory(JsonField.of("oauth_connection.created"))

            val OAUTH_CONNECTION_DEACTIVATED = SelectedEventCategory(JsonField.of("oauth_connection.deactivated"))

            val PENDING_TRANSACTION_CREATED = SelectedEventCategory(JsonField.of("pending_transaction.created"))

            val PENDING_TRANSACTION_UPDATED = SelectedEventCategory(JsonField.of("pending_transaction.updated"))
            ...
            val PHYSICAL_CARD_PROFILE_CREATED = SelectedEventCategory(JsonField.of("physical_card_profile.created"))

            val PHYSICAL_CARD_PROFILE_UPDATED = SelectedEventCategory(JsonField.of("physical_card_profile.updated"))

            val PROOF_OF_AUTHORIZATION_REQUEST_CREATED = SelectedEventCategory(JsonField.of("proof_of_authorization_request.created"))

            val PROOF_OF_AUTHORIZATION_REQUEST_UPDATED = SelectedEventCategory(JsonField.of("proof_of_authorization_request.updated"))

            val PROOF_OF_AUTHORIZATION_REQUEST_SUBMISSION_CREATED = SelectedEventCategory(JsonField.of("proof_of_authorization_request_submission.created"))

            val PROOF_OF_AUTHORIZATION_REQUEST_SUBMISSION_UPDATED = SelectedEventCategory(JsonField.of("proof_of_authorization_request_submission.updated"))

            val REAL_TIME_DECISION_CARD_AUTHORIZATION_REQUESTED = SelectedEventCategory(JsonField.of("real_time_decision.card_authorization_requested"))

            val REAL_TIME_DECISION_DIGITAL_WALLET_TOKEN_REQUESTED = SelectedEventCategory(JsonField.of("real_time_decision.digital_wallet_token_requested"))

            val REAL_TIME_DECISION_DIGITAL_WALLET_AUTHENTICATION_REQUESTED = SelectedEventCategory(JsonField.of("real_time_decision.digital_wallet_authentication_requested"))

            val REAL_TIME_PAYMENTS_TRANSFER_CREATED = SelectedEventCategory(JsonField.of("real_time_payments_transfer.created"))

            val REAL_TIME_PAYMENTS_TRANSFER_UPDATED = SelectedEventCategory(JsonField.of("real_time_payments_transfer.updated"))

            val REAL_TIME_PAYMENTS_REQUEST_FOR_PAYMENT_CREATED = SelectedEventCategory(JsonField.of("real_time_payments_request_for_payment.created"))

            val REAL_TIME_PAYMENTS_REQUEST_FOR_PAYMENT_UPDATED = SelectedEventCategory(JsonField.of("real_time_payments_request_for_payment.updated"))

            val TRANSACTION_CREATED = SelectedEventCategory(JsonField.of("transaction.created"))

            val WIRE_DRAWDOWN_REQUEST_CREATED = SelectedEventCategory(JsonField.of("wire_drawdown_request.created"))

            val WIRE_DRAWDOWN_REQUEST_UPDATED = SelectedEventCategory(JsonField.of("wire_drawdown_request.updated"))
