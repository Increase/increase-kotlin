...
class Account private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    @ExcludeMissing
    fun _interestAccrued() = interestAccrued
    ...
    @ExcludeMissing
    fun _interestRate() = interestRate
    ...
    override fun toString() = "Account{bank=$bank, closedAt=$closedAt, createdAt=$createdAt, currency=$currency, entityId=$entityId, id=$id, idempotencyKey=$idempotencyKey, informationalEntityId=$informationalEntityId, interestAccrued=$interestAccrued, interestAccruedAt=$interestAccruedAt, interestRate=$interestRate, name=$name, programId=$programId, status=$status, type=$type, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JsonProperty("bank")
        @ExcludeMissing
        fun bank(bank: JsonField<Bank>) = apply {
            this.bank = bank
        }
        ...
        @JsonProperty("closed_at")
        @ExcludeMissing
        fun closedAt(closedAt: JsonField<OffsetDateTime>) = apply {
         ...
         * with its activity.
         */
        fun informationalEntityId(informationalEntityId: String) = informationalEntityId(JsonField.of(informationalEntityId))
         ...
         * interest was accrued.
         */
        fun interestAccruedAt(interestAccruedAt: LocalDate) = interestAccruedAt(JsonField.of(interestAccruedAt))
        ...
        @JsonProperty("program_id")
        @ExcludeMissing
        fun programId(programId: JsonField<String>) = apply {
