...
constructor(
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.lockboxId?.let { params.put("lockbox_id", listOf(it.toString())) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InboundMailItemListParams && this.createdAt == other.createdAt && this.cursor == other.cursor && this.limit == other.limit && this.lockboxId == other.lockboxId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(createdAt, cursor, limit, lockboxId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }
