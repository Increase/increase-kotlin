...
private constructor(
    ...
    fun getNextPageParams(): ExternalAccountListParams? {
        ...
        return ExternalAccountListParams.builder().from(params).cursor(nextCursor()).build()
    }
    ...
    constructor(
        ...
        override fun toString() =
            "ExternalAccountListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
