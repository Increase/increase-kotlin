...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Account>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Account>` value instead.
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
