...
class BookkeepingEntrySetListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.transactionId?.let {
          params.put("transaction_id", listOf(it.toString()))
      }
    ...
    override fun toString() = "BookkeepingEntrySetListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, transactionId=$transactionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(bookkeepingEntrySetListParams: BookkeepingEntrySetListParams) = apply {
            ...
            additionalBodyProperties(bookkeepingEntrySetListParams.additionalBodyProperties)
        }
        ...
        fun build(): BookkeepingEntrySetListParams = BookkeepingEntrySetListParams(
            cursor,
            idempotencyKey,
            limit,
            transactionId,
