...
class AchPrenotificationListPage private constructor(
    ...
    companion object {
        ...
        fun of(achPrenotificationsService: AchPrenotificationService, params: AchPrenotificationListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<AchPrenotification>> = JsonMissing.of(),
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<AchPrenotification> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
