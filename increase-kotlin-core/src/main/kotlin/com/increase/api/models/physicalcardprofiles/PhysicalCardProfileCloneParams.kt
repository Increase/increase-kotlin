...
class PhysicalCardProfileCloneParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("front_text") @ExcludeMissing private val frontText: JsonField<FrontText> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             * [support@increase.com](mailto:support@increase.com) for more information.
             */
            fun frontText(frontText: JsonField<FrontText>) =
                apply {
        ...
        override fun toString() = "Body{carrierImageFileId=$carrierImageFileId, contactPhone=$contactPhone, description=$description, frontImageFileId=$frontImageFileId, frontText=$frontText, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(physicalCardProfileCloneParams: PhysicalCardProfileCloneParams) =
            apply {
     ...
     */
    @NoAutoDetect
    class FrontText @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(frontText: FrontText) =
                apply {
    ...
    override fun toString() = "PhysicalCardProfileCloneParams{physicalCardProfileId=$physicalCardProfileId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
