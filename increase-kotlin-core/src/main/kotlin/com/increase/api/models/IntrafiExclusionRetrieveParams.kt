...
class IntrafiExclusionRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "IntrafiExclusionRetrieveParams{intrafiExclusionId=$intrafiExclusionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(intrafiExclusionRetrieveParams: IntrafiExclusionRetrieveParams) = apply {
            ...
            additionalBodyProperties(intrafiExclusionRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): IntrafiExclusionRetrieveParams = IntrafiExclusionRetrieveParams(
