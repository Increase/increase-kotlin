...
class AccountNumberListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.achDebitStatus?.forEachQueryParam { key, values ->
          queryParams.put(
            "ach_debit_status.$key", values
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountNumberListParams: AccountNumberListParams) =
            apply {
    ...
    class AchDebitStatus private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(achDebitStatus: AchDebitStatus) =
                apply {
        ...
        override fun toString() = "AchDebitStatus{in_=$in_, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "AccountNumberListParams{accountId=$accountId, achDebitStatus=$achDebitStatus, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
