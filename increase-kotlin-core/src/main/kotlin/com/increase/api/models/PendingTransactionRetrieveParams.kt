...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PendingTransactionRetrieveParams && this.pendingTransactionId == other.pendingTransactionId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(pendingTransactionId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "PendingTransactionRetrieveParams{pendingTransactionId=$pendingTransactionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
