 ...
 */
@NoAutoDetect
class IntrafiAccountEnrollment @JsonCreator private constructor(
    ...
    @JsonProperty("intrafi_id") @ExcludeMissing private val intrafiId: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _intrafiId(): JsonField<String> = intrafiId
    ...
    fun validate(): IntrafiAccountEnrollment =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(intrafiAccountEnrollment: IntrafiAccountEnrollment) =
            apply {
         ...
         * printed on any IntraFi statements or documents.
         */
        fun intrafiId(intrafiId: JsonField<String>) =
            apply {
    ...
    override fun toString() = "IntrafiAccountEnrollment{id=$id, accountId=$accountId, createdAt=$createdAt, idempotencyKey=$idempotencyKey, intrafiId=$intrafiId, status=$status, type=$type, additionalProperties=$additionalProperties}"
}
