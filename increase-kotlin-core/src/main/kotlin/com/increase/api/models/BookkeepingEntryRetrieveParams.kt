...
class BookkeepingEntryRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BookkeepingEntryRetrieveParams &&
          this.bookkeepingEntryId == other.bookkeepingEntryId &&
    ...
    override fun toString() = "BookkeepingEntryRetrieveParams{bookkeepingEntryId=$bookkeepingEntryId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(bookkeepingEntryRetrieveParams: BookkeepingEntryRetrieveParams) = apply {
            ...
            additionalBodyProperties(bookkeepingEntryRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): BookkeepingEntryRetrieveParams = BookkeepingEntryRetrieveParams(
