 ...
 */
class InboundFundsHoldReleaseParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundFundsHoldReleaseParams: InboundFundsHoldReleaseParams) =
            apply {
                ...
                additionalBodyProperties = inboundFundsHoldReleaseParams.additionalBodyProperties.toMutableMap()
            }

        /** The inbound funds hold to release. */
        fun inboundFundsHoldId(inboundFundsHoldId: String) =
            apply {
        ...
        fun build(): InboundFundsHoldReleaseParams =
            InboundFundsHoldReleaseParams(
              checkRequired(
                "inboundFundsHoldId", inboundFundsHoldId
              ),
    ...
    override fun toString() = "InboundFundsHoldReleaseParams{inboundFundsHoldId=$inboundFundsHoldId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
