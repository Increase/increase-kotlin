...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InboundWireDrawdownRequestListPage && this.inboundWireDrawdownRequestsService == other.inboundWireDrawdownRequestsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
