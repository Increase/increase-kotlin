...
class LockboxRecipientUpdateParams
private constructor(
    ...
    companion object {
        ...
        fun none(): LockboxRecipientUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [LockboxRecipientUpdateParams].
         */
        fun builder() = Builder()
    }

    /** A builder for [LockboxRecipientUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(lockboxRecipientUpdateParams: LockboxRecipientUpdateParams) = apply {
            lockboxRecipientId = lockboxRecipientUpdateParams.lockboxRecipientId
            body = lockboxRecipientUpdateParams.body.toBuilder()
            additionalHeaders = lockboxRecipientUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = lockboxRecipientUpdateParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun build(): LockboxRecipientUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LockboxRecipientUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(lockboxRecipientId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "LockboxRecipientUpdateParams{lockboxRecipientId=$lockboxRecipientId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
