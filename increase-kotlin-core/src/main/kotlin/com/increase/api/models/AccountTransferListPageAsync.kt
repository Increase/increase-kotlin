...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountTransferListPageAsync && this.accountTransfersService == other.accountTransfersService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    fun getNextPageParams(): AccountTransferListParams? {
        ...
        return AccountTransferListParams.builder()
            .from(params)
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<AccountTransfer>>? = data
