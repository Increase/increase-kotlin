...
class ProofOfAuthorizationRequestListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "ProofOfAuthorizationRequestListParams{createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(proofOfAuthorizationRequestListParams: ProofOfAuthorizationRequestListParams) = apply {
        ...
        fun build(): ProofOfAuthorizationRequestListParams = ProofOfAuthorizationRequestListParams(
            createdAt,
            cursor,
            limit,
