...
class BookkeepingEntrySetListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.transactionId?.let {
          queryParams.put(
            "transaction_id", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bookkeepingEntrySetListParams: BookkeepingEntrySetListParams) =
            apply {
    ...
    override fun toString() = "BookkeepingEntrySetListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, transactionId=$transactionId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
