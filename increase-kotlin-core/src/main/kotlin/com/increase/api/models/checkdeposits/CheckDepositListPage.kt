...
/** List Check Deposits */
class CheckDepositListPage private constructor(
    ...
    companion object {
        ...
        fun of(checkDepositsService: CheckDepositService, params: CheckDepositListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<CheckDeposit> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
