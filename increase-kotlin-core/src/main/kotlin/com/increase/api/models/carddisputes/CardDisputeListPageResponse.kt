...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<CardDispute>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CardDispute>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<CardDispute>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<CardDispute>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CardDispute>>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardDisputeListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
