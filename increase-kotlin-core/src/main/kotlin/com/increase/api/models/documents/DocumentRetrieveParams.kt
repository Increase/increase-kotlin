...
class DocumentRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** The identifier of the Document to retrieve. */
        fun documentId(documentId: String) =
            apply {
    ...
    override fun toString() = "DocumentRetrieveParams{documentId=$documentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
