...
class PhysicalCardRetrieveParams private constructor(
    ...
    /** A builder for [PhysicalCardRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(physicalCardRetrieveParams: PhysicalCardRetrieveParams) =
            apply {
                physicalCardId = physicalCardRetrieveParams.physicalCardId
                additionalHeaders = physicalCardRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = physicalCardRetrieveParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "PhysicalCardRetrieveParams{physicalCardId=$physicalCardId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
