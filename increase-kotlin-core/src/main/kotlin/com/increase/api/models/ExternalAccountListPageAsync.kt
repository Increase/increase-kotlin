...
class ExternalAccountListPageAsync private constructor(private val externalAccountsService: ExternalAccountServiceAsync, private val params: ExternalAccountListParams, private val response: Response, ) {
    ...
    override fun toString() = "ExternalAccountListPageAsync{externalAccountsService=$externalAccountsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): ExternalAccountListParams? {
      ...
      return ExternalAccountListParams.builder().from(params).apply {nextCursor()?.let{ this.cursor(it) } }.build()
    }

    suspend fun getNextPage(): ExternalAccountListPageAsync? {
      return getNextPageParams()?.let {
          externalAccountsService.list(it)
      }
    }
    ...
    companion object {
        ...
        fun of(externalAccountsService: ExternalAccountServiceAsync, params: ExternalAccountListParams, response: Response) = ExternalAccountListPageAsync(
            externalAccountsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<ExternalAccount>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        @JsonProperty("data")
        fun _data(): JsonField<List<ExternalAccount>>? = data
        ...
        override fun toString() = "ExternalAccountListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: ExternalAccountListPageAsync, ) : Flow<ExternalAccount> {
