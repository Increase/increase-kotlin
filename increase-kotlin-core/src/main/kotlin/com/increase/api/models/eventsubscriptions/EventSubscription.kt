...
private constructor(
    ...
    private val selectedEventCategories: JsonField<List<SelectedEventCategory>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        selectedEventCategories: JsonField<List<SelectedEventCategory>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun selectedEventCategories(): List<SelectedEventCategory>? =
        selectedEventCategories.getNullable("selected_event_categories")
    ...
    @JsonProperty("selected_event_categories")
    @ExcludeMissing
    fun _selectedEventCategories(): JsonField<List<SelectedEventCategory>> = selectedEventCategories
    ...
    class Builder internal constructor() {
        ...
        private var selectedEventCategories: JsonField<MutableList<SelectedEventCategory>>? = null
        ...
        internal fun from(eventSubscription: EventSubscription) = apply {
            ...
            selectedEventCategories =
                eventSubscription.selectedEventCategories.map { it.toMutableList() }
         ...
         * `category`.
         */
        fun selectedEventCategories(selectedEventCategories: List<SelectedEventCategory>?) =
            selectedEventCategories(JsonField.ofNullable(selectedEventCategories))
         ...
         * `List<SelectedEventCategory>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun selectedEventCategories(
            selectedEventCategories: JsonField<List<SelectedEventCategory>>
        ) = apply {
        ...
        fun build(): EventSubscription =
            EventSubscription(
                ...
                checkRequired("selectedEventCategories", selectedEventCategories).map {
                    it.toImmutable()
                },
    ...
    fun validate(): EventSubscription = apply {
        ...
        idempotencyKey()
        oauthConnectionId()
        selectedEventCategories()?.forEach { it.validate() }
        status().validate()
        type().validate()
        url()
        validated = true
    ...
    internal fun validity(): Int =
        (if (id.asKnown() == null) 0 else 1) +
            ...
            (selectedEventCategories.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val eventCategory: JsonField<EventCategory>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            eventCategory: JsonField<EventCategory> = JsonMissing.of()
         ...
         */
        fun eventCategory(): EventCategory? = eventCategory.getNullable("event_category")
        ...
        @JsonProperty("event_category")
        @ExcludeMissing
        fun _eventCategory(): JsonField<EventCategory> = eventCategory
        ...
        class Builder internal constructor() {
            ...
            private var eventCategory: JsonField<EventCategory>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            fun eventCategory(eventCategory: EventCategory?) =
                eventCategory(JsonField.ofNullable(eventCategory))
             ...
             */
            fun eventCategory(eventCategory: JsonField<EventCategory>) = apply {
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (eventCategory.asKnown()?.validity() ?: 0)

        /** The category of the Event. */
        class EventCategory @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
            ...
            companion object {
                ...
                val FEDNOW_TRANSFER_CREATED = of("fednow_transfer.created")

                /** Occurs whenever a FedNow Transfer is updated. */
                val FEDNOW_TRANSFER_UPDATED = of("fednow_transfer.updated")
                ...
                val LOAN_PURCHASE_CREATED = of("loan_purchase.created")
                ...
                val PHYSICAL_CHECK_CREATED = of("physical_check.created")
                ...
                val PHYSICAL_CHECK_BOOK_CREATED = of("physical_check_book.created")

                /** Occurs whenever a Physical Check Book is updated. */
                val PHYSICAL_CHECK_BOOK_UPDATED = of("physical_check_book.updated")
                ...
                fun of(value: String) = EventCategory(JsonField.of(value))
            }
            ...
            fun value(): Value =
                when (this) {
                    ...
                    PHYSICAL_CHECK_BOOK_CREATED -> Value.PHYSICAL_CHECK_BOOK_CREATED
                    PHYSICAL_CHECK_BOOK_UPDATED -> Value.PHYSICAL_CHECK_BOOK_UPDATED
            ...
            fun known(): Known =
                when (this) {
                    ...
                    PHYSICAL_CHECK_BOOK_CREATED -> Known.PHYSICAL_CHECK_BOOK_CREATED
                    PHYSICAL_CHECK_BOOK_UPDATED -> Known.PHYSICAL_CHECK_BOOK_UPDATED
    ...
    override fun toString() =
        "EventSubscription{id=$id, createdAt=$createdAt, idempotencyKey=$idempotencyKey, oauthConnectionId=$oauthConnectionId, selectedEventCategories=$selectedEventCategories, status=$status, type=$type, url=$url, additionalProperties=$additionalProperties}"
}
