 ...
 * reversed.
 */
class CardReversalCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{cardPaymentId=$cardPaymentId, amount=$amount, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardReversalCreateParams: CardReversalCreateParams) =
            apply {
    ...
    override fun toString() = "CardReversalCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
