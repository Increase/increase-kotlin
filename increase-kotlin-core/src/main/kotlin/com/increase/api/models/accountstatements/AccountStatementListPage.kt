...
class AccountStatementListPage private constructor(
    ...
    companion object {
        ...
        fun of(accountStatementsService: AccountStatementService, params: AccountStatementListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<AccountStatement>> = JsonMissing.of(),
    ...
    class AutoPager(
        private val firstPage: AccountStatementListPage,

    ) : Sequence<AccountStatement> {

        override fun iterator(): Iterator<AccountStatement> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
