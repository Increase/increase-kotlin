...
class DeclinedTransactionListParams private constructor(
    ...
    /** A builder for [DeclinedTransactionListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(declinedTransactionListParams: DeclinedTransactionListParams) =
            apply {
    ...
    override fun toString() = "DeclinedTransactionListParams{accountId=$accountId, category=$category, createdAt=$createdAt, cursor=$cursor, limit=$limit, routeId=$routeId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
