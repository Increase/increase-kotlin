...
class DigitalWalletTokenListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "DigitalWalletTokenListParams{cardId=$cardId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(digitalWalletTokenListParams: DigitalWalletTokenListParams) = apply {
            ...
            additionalBodyProperties(digitalWalletTokenListParams.additionalBodyProperties)
        }
        ...
        fun build(): DigitalWalletTokenListParams = DigitalWalletTokenListParams(
            cardId,
            createdAt,
            cursor,
            limit,
