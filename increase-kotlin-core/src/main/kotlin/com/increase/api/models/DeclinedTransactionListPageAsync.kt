...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DeclinedTransactionListPageAsync && this.declinedTransactionsService == other.declinedTransactionsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(declinedTransactionsService, params, response) /* spotless:on */
    }
