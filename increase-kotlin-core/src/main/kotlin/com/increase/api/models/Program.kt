...
class Program private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    @ExcludeMissing
    fun _billingAccountId() = billingAccountId
    ...
    override fun toString() = "Program{billingAccountId=$billingAccountId, createdAt=$createdAt, defaultDigitalCardProfileId=$defaultDigitalCardProfileId, id=$id, interestRate=$interestRate, name=$name, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        /** The Program billing account. */
        fun billingAccountId(billingAccountId: String) = billingAccountId(JsonField.of(billingAccountId))
        ...
        /** The default configuration for digital cards attached to this Program. */
        fun defaultDigitalCardProfileId(defaultDigitalCardProfileId: String) = defaultDigitalCardProfileId(JsonField.of(defaultDigitalCardProfileId))
