...
class ProofOfAuthorizationRequestSubmissionListPageAsync private constructor(
    private val proofOfAuthorizationRequestSubmissionsService: ProofOfAuthorizationRequestSubmissionServiceAsync,
    ...
    companion object {
        ...
        fun of(proofOfAuthorizationRequestSubmissionsService: ProofOfAuthorizationRequestSubmissionServiceAsync, params: ProofOfAuthorizationRequestSubmissionListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<ProofOfAuthorizationRequestSubmission>> = JsonMissing.of(),
