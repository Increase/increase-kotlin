...
class OAuthConnectionListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(oauthConnectionsService: OAuthConnectionServiceAsync, params: OAuthConnectionListParams, response: Response) =
