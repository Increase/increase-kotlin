...
class OAuthConnectionListPage private constructor(
    ...
    companion object {
        ...
        fun of(oauthConnectionsService: OAuthConnectionService, params: OAuthConnectionListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<OAuthConnection> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
