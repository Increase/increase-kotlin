...
/** List Lockboxes */
class LockboxListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(lockboxesService: LockboxServiceAsync, params: LockboxListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<Lockbox>> = JsonMissing.of(),
