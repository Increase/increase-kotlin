...
class BookkeepingEntryListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bookkeepingEntryListParams: BookkeepingEntryListParams) =
            apply {
    ...
    override fun toString() = "BookkeepingEntryListParams{accountId=$accountId, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
