...
class InboundRealTimePaymentsTransferListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundRealTimePaymentsTransferListParams: InboundRealTimePaymentsTransferListParams) =
            apply {
                ...
                additionalHeaders = inboundRealTimePaymentsTransferListParams.additionalHeaders.toBuilder()
                additionalQueryParams = inboundRealTimePaymentsTransferListParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "InboundRealTimePaymentsTransferListParams{accountId=$accountId, accountNumberId=$accountNumberId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
