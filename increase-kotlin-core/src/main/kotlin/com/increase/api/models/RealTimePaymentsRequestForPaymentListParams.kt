...
class RealTimePaymentsRequestForPaymentListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RealTimePaymentsRequestForPaymentListParams &&
    ...
    override fun toString() = "RealTimePaymentsRequestForPaymentListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(realTimePaymentsRequestForPaymentListParams: RealTimePaymentsRequestForPaymentListParams) = apply {
            ...
            additionalBodyProperties(realTimePaymentsRequestForPaymentListParams.additionalBodyProperties)
        }
        ...
        fun build(): RealTimePaymentsRequestForPaymentListParams = RealTimePaymentsRequestForPaymentListParams(
            accountId,
            createdAt,
            cursor,
            idempotencyKey,
