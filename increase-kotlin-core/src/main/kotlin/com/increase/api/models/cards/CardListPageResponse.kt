...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Card>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Card>` value instead. This
        ...
        /**
         * Adds a single [Card] to [Builder.data].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
