...
class CheckDepositListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "CheckDepositListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(checkDepositListParams: CheckDepositListParams) = apply {
            ...
            additionalBodyProperties(checkDepositListParams.additionalBodyProperties)
        }
        ...
        fun build(): CheckDepositListParams = CheckDepositListParams(
            accountId,
            createdAt,
            cursor,
            idempotencyKey,
