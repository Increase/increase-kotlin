...
class CheckTransferListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CheckTransferListParams &&
    ...
    override fun toString() = "CheckTransferListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(checkTransferListParams: CheckTransferListParams) = apply {
            ...
            additionalBodyProperties(checkTransferListParams.additionalBodyProperties)
        }
        ...
        fun build(): CheckTransferListParams = CheckTransferListParams(
            accountId,
            createdAt,
            cursor,
            idempotencyKey,
