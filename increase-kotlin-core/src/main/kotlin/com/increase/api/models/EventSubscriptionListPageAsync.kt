...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EventSubscriptionListPageAsync && this.eventSubscriptionsService == other.eventSubscriptionsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
