...
class BookkeepingEntrySetListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(bookkeepingEntrySetsService: BookkeepingEntrySetServiceAsync, params: BookkeepingEntrySetListParams, response: Response) =
