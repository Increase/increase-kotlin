...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            digitalWalletTokenRequestCreateParams: DigitalWalletTokenRequestCreateParams
        ) = apply {
            ...
            additionalQueryParams =
                digitalWalletTokenRequestCreateParams.additionalQueryParams.toBuilder()
        }
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int = (if (cardId.asKnown() == null) 0 else 1)
    ...
    override fun toString() =
        "DigitalWalletTokenRequestCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
