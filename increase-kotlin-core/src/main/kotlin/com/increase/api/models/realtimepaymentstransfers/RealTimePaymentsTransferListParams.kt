...
class RealTimePaymentsTransferListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(realTimePaymentsTransferListParams: RealTimePaymentsTransferListParams) =
            apply {
                ...
                additionalQueryParams = realTimePaymentsTransferListParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "RealTimePaymentsTransferListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, externalAccountId=$externalAccountId, idempotencyKey=$idempotencyKey, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
