...
constructor(
    ...
    internal fun getQueryParams(): QueryParams {
        ...
        this.checkTransferId?.let { queryParams.put("check_transfer_id", listOf(it.toString())) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InboundCheckDepositListParams && this.accountId == other.accountId && this.checkTransferId == other.checkTransferId && this.createdAt == other.createdAt && this.cursor == other.cursor && this.limit == other.limit && this.additionalHeaders == other.additionalHeaders && this.additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(accountId, checkTransferId, createdAt, cursor, limit, additionalHeaders, additionalQueryParams) /* spotless:on */
    }
