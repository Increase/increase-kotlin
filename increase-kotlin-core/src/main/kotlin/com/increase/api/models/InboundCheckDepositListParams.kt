...
class InboundCheckDepositListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.checkTransferId?.let {
          params.put("check_transfer_id", listOf(it.toString()))
      }
    ...
    override fun toString() = "InboundCheckDepositListParams{accountId=$accountId, checkTransferId=$checkTransferId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): InboundCheckDepositListParams = InboundCheckDepositListParams(
            accountId,
            checkTransferId,
            createdAt,
            cursor,
