...
class PendingTransactionListPage private constructor(
    ...
    companion object {
        ...
        fun of(pendingTransactionsService: PendingTransactionService, params: PendingTransactionListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<PendingTransaction> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
