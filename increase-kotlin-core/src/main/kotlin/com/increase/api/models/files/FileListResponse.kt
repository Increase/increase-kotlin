...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileListResponse: FileListResponse) = apply {
            data = fileListResponse.data.map { it.toMutableList() }
            nextCursor = fileListResponse.nextCursor
    ...
    override fun toString() =
        "FileListResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
