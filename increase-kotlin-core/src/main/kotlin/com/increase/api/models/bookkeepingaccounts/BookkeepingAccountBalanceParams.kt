...
class BookkeepingAccountBalanceParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.atTime?.let {
          queryParams.put(
            "at_time", listOf(DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it))
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bookkeepingAccountBalanceParams: BookkeepingAccountBalanceParams) =
            apply {
                ...
                additionalQueryParams = bookkeepingAccountBalanceParams.additionalQueryParams.toBuilder()
            }
        ...
        /** The moment to query the balance at. If not set, returns the current balances. */
        fun atTime(atTime: OffsetDateTime?) =
            apply {
                this.atTime = atTime
            }
    ...
    override fun toString() = "BookkeepingAccountBalanceParams{bookkeepingAccountId=$bookkeepingAccountId, atTime=$atTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
