...
class IntrafiAccountEnrollmentCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("email_address") @ExcludeMissing private val emailAddress: JsonField<String> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** The contact email for the account owner, to be shared with IntraFi. */
            fun emailAddress(emailAddress: JsonField<String>) =
                apply {
        ...
        override fun toString() = "Body{accountId=$accountId, emailAddress=$emailAddress, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(intrafiAccountEnrollmentCreateParams: IntrafiAccountEnrollmentCreateParams) =
            apply {
                ...
                additionalQueryParams = intrafiAccountEnrollmentCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "IntrafiAccountEnrollmentCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
