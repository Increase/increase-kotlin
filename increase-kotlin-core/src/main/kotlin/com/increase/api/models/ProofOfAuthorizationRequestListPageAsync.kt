...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ProofOfAuthorizationRequestListPageAsync && this.proofOfAuthorizationRequestsService == other.proofOfAuthorizationRequestsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "ProofOfAuthorizationRequestListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
