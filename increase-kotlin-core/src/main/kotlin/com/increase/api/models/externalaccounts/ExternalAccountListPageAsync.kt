...
class ExternalAccountListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(externalAccountsService: ExternalAccountServiceAsync, params: ExternalAccountListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<ExternalAccount>> = JsonMissing.of(),
