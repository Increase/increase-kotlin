...
private constructor(
    ...
    override suspend fun nextPage(): EntityOnboardingSessionListPageAsync =
        service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<EntityOnboardingSession> = AutoPagerAsync.from(this)
    ...
    override fun toString() =
        "EntityOnboardingSessionListPageAsync{service=$service, params=$params, response=$response}"
}
