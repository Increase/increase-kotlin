...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RealTimePaymentsRequestForPaymentListPageAsync && realTimePaymentsRequestForPaymentsService == other.realTimePaymentsRequestForPaymentsService && params == other.params && response == other.response /* spotless:on */
    }
