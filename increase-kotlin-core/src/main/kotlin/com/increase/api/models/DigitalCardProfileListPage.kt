...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DigitalCardProfileListPage && this.digitalCardProfilesService == other.digitalCardProfilesService && this.params == other.params && this.response == other.response /* spotless:on */
    }
