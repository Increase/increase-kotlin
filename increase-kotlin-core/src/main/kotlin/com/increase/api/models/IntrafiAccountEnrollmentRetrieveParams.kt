...
class IntrafiAccountEnrollmentRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "IntrafiAccountEnrollmentRetrieveParams{intrafiAccountEnrollmentId=$intrafiAccountEnrollmentId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(intrafiAccountEnrollmentRetrieveParams: IntrafiAccountEnrollmentRetrieveParams) = apply {
            this.intrafiAccountEnrollmentId = intrafiAccountEnrollmentRetrieveParams.intrafiAccountEnrollmentId
            ...
            additionalBodyProperties(intrafiAccountEnrollmentRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): IntrafiAccountEnrollmentRetrieveParams = IntrafiAccountEnrollmentRetrieveParams(
