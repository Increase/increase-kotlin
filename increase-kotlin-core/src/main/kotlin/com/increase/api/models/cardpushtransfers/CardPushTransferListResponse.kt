...
private constructor(
    private val data: JsonField<List<CardPushTransfer>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CardPushTransfer>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CardPushTransfer> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CardPushTransfer>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<CardPushTransfer>>? = null
        ...
        /** The contents of the list. */
        fun data(data: List<CardPushTransfer>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CardPushTransfer>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CardPushTransfer>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CardPushTransfer] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CardPushTransfer) = apply {
            this.data =
