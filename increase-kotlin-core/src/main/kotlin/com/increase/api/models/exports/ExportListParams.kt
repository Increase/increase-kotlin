...
/** List Exports */
class ExportListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(exportListParams: ExportListParams) =
            apply {
    ...
    override fun toString() = "ExportListParams{category=$category, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
