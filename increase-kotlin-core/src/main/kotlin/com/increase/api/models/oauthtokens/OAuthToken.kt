 ...
 */
@NoAutoDetect
class OAuthToken @JsonCreator private constructor(
    @JsonProperty("access_token") @ExcludeMissing private val accessToken: JsonField<String> = JsonMissing.of(),
    @JsonProperty("token_type") @ExcludeMissing private val tokenType: JsonField<TokenType> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _tokenType(): JsonField<TokenType> = tokenType
    ...
    class Builder internal constructor() {
        ...
        internal fun from(oauthToken: OAuthToken) =
            apply {
        ...
        /** The type of OAuth token. */
        fun tokenType(tokenType: JsonField<TokenType>) =
            apply {
    ...
    /** The type of OAuth token. */
    class TokenType @JsonCreator private constructor(
        ...
        enum class Value {
            BEARER,
            /**
             * An enum member indicating that [TokenType] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
