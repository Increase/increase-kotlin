...
class SupplementalDocumentListPageResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = supplementalDocumentListPageResponse.data.map { it.toMutableList() }
            nextCursor = supplementalDocumentListPageResponse.nextCursor
            additionalProperties =
                supplementalDocumentListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SupplementalDocumentListPageResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SupplementalDocumentListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "SupplementalDocumentListPageResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
