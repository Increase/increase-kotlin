...
class IntrafiAccountEnrollmentListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(intrafiAccountEnrollmentListParams: IntrafiAccountEnrollmentListParams) =
            apply {
                ...
                additionalQueryParams = intrafiAccountEnrollmentListParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "IntrafiAccountEnrollmentListParams{accountId=$accountId, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
