...
/** Retrieve an Export */
class ExportRetrieveParams private constructor(
    ...
    /** A builder for [ExportRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(exportRetrieveParams: ExportRetrieveParams) =
            apply {
                exportId = exportRetrieveParams.exportId
                additionalHeaders = exportRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = exportRetrieveParams.additionalQueryParams.toBuilder()
            }

        /** The identifier of the Export to retrieve. */
        fun exportId(exportId: String) =
            apply {
    ...
    override fun toString() = "ExportRetrieveParams{exportId=$exportId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
