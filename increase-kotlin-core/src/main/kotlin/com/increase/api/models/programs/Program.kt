 ...
 */
@NoAutoDetect
class Program @JsonCreator private constructor(
    @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
    @JsonProperty("bank") @ExcludeMissing private val bank: JsonField<Bank> = JsonMissing.of(),
    @JsonProperty("billing_account_id") @ExcludeMissing private val billingAccountId: JsonField<String> = JsonMissing.of(),
    @JsonProperty("created_at") @ExcludeMissing private val createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("default_digital_card_profile_id") @ExcludeMissing private val defaultDigitalCardProfileId: JsonField<String> = JsonMissing.of(),
    ...
    fun defaultDigitalCardProfileId(): String? = defaultDigitalCardProfileId.getNullable("default_digital_card_profile_id")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(program: Program) =
            apply {
                id = program.id
                bank = program.bank
        ...
        /** The Program billing account. */
        fun billingAccountId(billingAccountId: String?) = billingAccountId(JsonField.ofNullable(billingAccountId))

        /** The Program billing account. */
        fun billingAccountId(billingAccountId: JsonField<String>) =
            apply {
        ...
        /** The default configuration for digital cards attached to this Program. */
        fun defaultDigitalCardProfileId(defaultDigitalCardProfileId: String?) = defaultDigitalCardProfileId(JsonField.ofNullable(defaultDigitalCardProfileId))

        /** The default configuration for digital cards attached to this Program. */
        fun defaultDigitalCardProfileId(defaultDigitalCardProfileId: JsonField<String>) =
            apply {
        ...
        fun build(): Program =
            Program(
              ...
              checkRequired(
                "defaultDigitalCardProfileId", defaultDigitalCardProfileId
              ),
              checkRequired(
    ...
    override fun toString() = "Program{id=$id, bank=$bank, billingAccountId=$billingAccountId, createdAt=$createdAt, defaultDigitalCardProfileId=$defaultDigitalCardProfileId, interestRate=$interestRate, name=$name, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
