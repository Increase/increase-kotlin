...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BookkeepingAccount>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BookkeepingAccount>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<BookkeepingAccount>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<BookkeepingAccount>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<BookkeepingAccount>>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BookkeepingAccountListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
