 ...
 */
@NoAutoDetect
class InboundWireDrawdownRequest @JsonCreator private constructor(
    @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
    @JsonProperty("amount") @ExcludeMissing private val amount: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("beneficiary_account_number") @ExcludeMissing private val beneficiaryAccountNumber: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("beneficiary_routing_number") @ExcludeMissing private val beneficiaryRoutingNumber: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("originator_account_number") @ExcludeMissing private val originatorAccountNumber: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("recipient_account_number_id") @ExcludeMissing private val recipientAccountNumberId: JsonField<String> = JsonMissing.of(),
    ...
    fun validate(): InboundWireDrawdownRequest =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundWireDrawdownRequest: InboundWireDrawdownRequest) =
            apply {
                ...
                originatorToBeneficiaryInformationLine1 = inboundWireDrawdownRequest.originatorToBeneficiaryInformationLine1
                originatorToBeneficiaryInformationLine2 = inboundWireDrawdownRequest.originatorToBeneficiaryInformationLine2
                originatorToBeneficiaryInformationLine3 = inboundWireDrawdownRequest.originatorToBeneficiaryInformationLine3
                originatorToBeneficiaryInformationLine4 = inboundWireDrawdownRequest.originatorToBeneficiaryInformationLine4
        ...
        /** The drawdown request's beneficiary's account number. */
        fun beneficiaryAccountNumber(beneficiaryAccountNumber: JsonField<String>) =
            apply {
        ...
        /** The drawdown request's beneficiary's routing number. */
        fun beneficiaryRoutingNumber(beneficiaryRoutingNumber: JsonField<String>) =
            apply {
        ...
        /** The drawdown request's originator's account number. */
        fun originatorAccountNumber(originatorAccountNumber: JsonField<String>) =
            apply {
         ...
         * to send funds.
         */
        fun recipientAccountNumberId(recipientAccountNumberId: JsonField<String>) =
            apply {
