...
/** Update an Account */
class AccountUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountUpdateParams: AccountUpdateParams) =
            apply {
    ...
    override fun toString() = "AccountUpdateParams{accountId=$accountId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
