...
class LockboxUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class LockboxUpdateBody internal constructor(
      private val description: String?,
      private val recipientName: String?,
      private val status: Status?,
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "LockboxUpdateBody{description=$description, recipientName=$recipientName, status=$status, additionalProperties=$additionalProperties}"
    ...
    override fun toString() = "LockboxUpdateParams{lockboxId=$lockboxId, description=$description, recipientName=$recipientName, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
