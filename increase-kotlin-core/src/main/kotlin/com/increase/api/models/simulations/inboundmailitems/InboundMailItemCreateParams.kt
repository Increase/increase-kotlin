 ...
 */
class InboundMailItemCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("contents_file_id") @ExcludeMissing private val contentsFileId: JsonField<String> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             * will be used.
             */
            fun contentsFileId(contentsFileId: String) = contentsFileId(JsonField.of(contentsFileId))

            /**
             * The file containing the PDF contents. If not present, a default check image file
             * will be used.
             */
            fun contentsFileId(contentsFileId: JsonField<String>) =
                apply {
        ...
        override fun toString() = "Body{amount=$amount, lockboxId=$lockboxId, contentsFileId=$contentsFileId, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundMailItemCreateParams: InboundMailItemCreateParams) =
            apply {
        ...
        /** The identifier of the Lockbox to simulate inbound mail to. */
        fun lockboxId(lockboxId: String) =
            apply {
                body.lockboxId(lockboxId)
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is InboundMailItemCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "InboundMailItemCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
