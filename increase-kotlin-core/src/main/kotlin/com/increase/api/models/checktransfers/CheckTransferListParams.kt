...
class CheckTransferListParams private constructor(
    ...
    companion object {
        ...
        fun none(): CheckTransferListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(checkTransferListParams: CheckTransferListParams) =
            apply {
    ...
    override fun toString() = "CheckTransferListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
