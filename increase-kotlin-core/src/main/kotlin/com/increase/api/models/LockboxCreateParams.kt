...
class LockboxCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class LockboxCreateBody internal constructor(
      private val accountId: String?,
      private val description: String?,
      private val recipientName: String?,
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "LockboxCreateBody{accountId=$accountId, description=$description, recipientName=$recipientName, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): LockboxCreateBody = LockboxCreateBody(
    ...
    override fun toString() = "LockboxCreateParams{accountId=$accountId, description=$description, recipientName=$recipientName, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): LockboxCreateParams = LockboxCreateParams(
            checkNotNull(accountId) {
                "`accountId` is required but was not set"
            },
            description,
