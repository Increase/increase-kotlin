...
private constructor(
     ...
     */
    fun companyTitle(): String? = body.companyTitle()
     ...
     */
    fun _individual(): JsonField<Individual> = body._individual()
     ...
     */
    fun _companyTitle(): JsonField<String> = body._companyTitle()
    ...
    class Builder internal constructor() {
         ...
         * supported value.
         */
        fun individual(individual: JsonField<Individual>) = apply { body.individual(individual) }
