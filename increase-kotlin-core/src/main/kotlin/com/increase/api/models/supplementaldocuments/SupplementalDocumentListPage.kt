...
class SupplementalDocumentListPage private constructor(
    ...
    companion object {
        ...
        fun of(supplementalDocumentsService: SupplementalDocumentService, params: SupplementalDocumentListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<EntitySupplementalDocument> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
