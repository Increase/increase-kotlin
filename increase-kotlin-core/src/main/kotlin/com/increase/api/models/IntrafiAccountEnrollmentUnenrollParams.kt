...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IntrafiAccountEnrollmentUnenrollParams && this.intrafiAccountEnrollmentId == other.intrafiAccountEnrollmentId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(intrafiAccountEnrollmentId, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "IntrafiAccountEnrollmentUnenrollParams{intrafiAccountEnrollmentId=$intrafiAccountEnrollmentId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            ...
            additionalQueryParams(intrafiAccountEnrollmentUnenrollParams.additionalQueryParams)
            additionalHeaders(intrafiAccountEnrollmentUnenrollParams.additionalHeaders)
            additionalBodyProperties(
                intrafiAccountEnrollmentUnenrollParams.additionalBodyProperties
            )
        }
