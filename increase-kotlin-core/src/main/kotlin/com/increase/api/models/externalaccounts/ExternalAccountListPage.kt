...
class ExternalAccountListPage private constructor(
    ...
    companion object {
        ...
        fun of(externalAccountsService: ExternalAccountService, params: ExternalAccountListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<ExternalAccount> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
