...
/** List Card Profiles */
class DigitalCardProfileListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(digitalCardProfileListParams: DigitalCardProfileListParams) =
            apply {
    ...
    override fun toString() = "DigitalCardProfileListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
