...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AchPrenotification>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<AchPrenotification>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<AchPrenotification>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<AchPrenotification>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<AchPrenotification>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AchPrenotification] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AchPrenotification) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AchPrenotificationListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
