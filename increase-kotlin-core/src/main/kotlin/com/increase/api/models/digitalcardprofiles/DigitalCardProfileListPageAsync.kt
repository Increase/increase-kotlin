...
/** List Card Profiles */
class DigitalCardProfileListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(digitalCardProfilesService: DigitalCardProfileServiceAsync, params: DigitalCardProfileListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<DigitalCardProfile>> = JsonMissing.of(),
    ...
    class AutoPager(
        private val firstPage: DigitalCardProfileListPageAsync,
