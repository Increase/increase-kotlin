...
private constructor(
    ...
    constructor(
        ...
        fun data(): List<InboundAchTransferReturn> = data.getNullable("data") ?: listOf()
    ...
    ) : Flow<InboundAchTransferReturn> {

        override suspend fun collect(collector: FlowCollector<InboundAchTransferReturn>) {
            var page = firstPage
            var index = 0
            while (true) {
