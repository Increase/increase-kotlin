...
class EntityUpdateIndustryCodeParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class EntityUpdateIndustryCodeBody internal constructor(private val industryCode: String?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "EntityUpdateIndustryCodeBody{industryCode=$industryCode, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): EntityUpdateIndustryCodeBody = EntityUpdateIndustryCodeBody(checkNotNull(industryCode) {
                "`industryCode` is required but was not set"
    ...
    override fun toString() = "EntityUpdateIndustryCodeParams{entityId=$entityId, industryCode=$industryCode, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): EntityUpdateIndustryCodeParams = EntityUpdateIndustryCodeParams(
            checkNotNull(entityId) {
                "`entityId` is required but was not set"
            },
            checkNotNull(industryCode) {
                "`industryCode` is required but was not set"
            },
