...
class AccountUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class AccountUpdateBody internal constructor(private val name: String?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "AccountUpdateBody{name=$name, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): AccountUpdateBody = AccountUpdateBody(name, additionalProperties.toUnmodifiable())
        }
    }
    ...
    override fun toString() = "AccountUpdateParams{accountId=$accountId, name=$name, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
