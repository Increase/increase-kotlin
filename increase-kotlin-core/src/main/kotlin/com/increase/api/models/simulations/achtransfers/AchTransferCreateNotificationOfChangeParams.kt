 ...
 */
class AchTransferCreateNotificationOfChangeParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{changeCode=$changeCode, correctedData=$correctedData, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(achTransferCreateNotificationOfChangeParams: AchTransferCreateNotificationOfChangeParams) =
            apply {
                ...
                additionalHeaders = achTransferCreateNotificationOfChangeParams.additionalHeaders.toBuilder()
                additionalQueryParams = achTransferCreateNotificationOfChangeParams.additionalQueryParams.toBuilder()
            }
        ...
        /** The corrected data for the notification of change (e.g., a new routing number). */
        fun correctedData(correctedData: String) =
            apply {
    ...
    override fun toString() = "AchTransferCreateNotificationOfChangeParams{achTransferId=$achTransferId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
