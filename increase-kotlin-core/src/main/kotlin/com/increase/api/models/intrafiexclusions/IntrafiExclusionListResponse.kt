...
class IntrafiExclusionListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IntrafiExclusionListResponse].
         *
    ...
    /** A builder for [IntrafiExclusionListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(intrafiExclusionListResponse: IntrafiExclusionListResponse) = apply {
            data = intrafiExclusionListResponse.data.map { it.toMutableList() }
            nextCursor = intrafiExclusionListResponse.nextCursor
            additionalProperties = intrafiExclusionListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntrafiExclusionListResponse].
         *
         ...
         */
        fun build(): IntrafiExclusionListResponse =
    ...
    fun validate(): IntrafiExclusionListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntrafiExclusionListResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "IntrafiExclusionListResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
