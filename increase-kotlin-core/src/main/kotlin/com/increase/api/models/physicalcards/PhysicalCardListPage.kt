...
/** List Physical Cards */
class PhysicalCardListPage private constructor(
    ...
    companion object {
        ...
        fun of(physicalCardsService: PhysicalCardService, params: PhysicalCardListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<PhysicalCard> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
