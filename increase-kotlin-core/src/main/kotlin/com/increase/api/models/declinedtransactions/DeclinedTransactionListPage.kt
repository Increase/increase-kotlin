...
class DeclinedTransactionListPage private constructor(
    ...
    companion object {
        ...
        fun of(declinedTransactionsService: DeclinedTransactionService, params: DeclinedTransactionListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<DeclinedTransaction>> = JsonMissing.of(),
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<DeclinedTransaction> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
