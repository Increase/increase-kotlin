...
private constructor(
    ...
    /**
     * Details of the sole proprietorship entity to update. If you specify this parameter and the
     * entity is not a sole proprietorship, the request will fail.
     *
     * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    /**
     * New terms that the Entity agreed to. Not all programs are required to submit this data. This
     * will not archive previously submitted terms.
     *
     * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun termsAgreements(): List<TermsAgreement>? = body.termsAgreements()
    ...
    class Builder internal constructor() {
        ...
        /**
         * Details of the sole proprietorship entity to update. If you specify this parameter and
         * the entity is not a sole proprietorship, the request will fail.
         */
        ...
        /**
         * New terms that the Entity agreed to. Not all programs are required to submit this data.
         * This will not archive previously submitted terms.
         */
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun termsAgreements(): List<TermsAgreement>? =
            termsAgreements.getNullable("terms_agreements")
        ...
        class Builder internal constructor() {
            ...
            /**
             * New terms that the Entity agreed to. Not all programs are required to submit this
             * data. This will not archive previously submitted terms.
             */
        ...
        override fun toString() =
            "Body{corporation=$corporation, detailsConfirmedAt=$detailsConfirmedAt, governmentAuthority=$governmentAuthority, naturalPerson=$naturalPerson, riskRating=$riskRating, soleProprietorship=$soleProprietorship, termsAgreements=$termsAgreements, thirdPartyVerification=$thirdPartyVerification, trust=$trust, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("website") @ExcludeMissing website: JsonField<String> = JsonMissing.of(),
        ) : this(address, email, soleProprietor, taxIdentifier, website, mutableMapOf())
         ...
         *   the server responded with an unexpected value).
         */
        fun soleProprietor(): SoleProprietor? = soleProprietor.getNullable("sole_proprietor")
        ...
        class Builder internal constructor() {
            ...
            private var address: JsonField<Address> = JsonMissing.of()
            private var email: JsonField<String> = JsonMissing.of()
            private var soleProprietor: JsonField<SoleProprietor> = JsonMissing.of()
        ...
        private constructor(
            ...
            private constructor(
                ...
                identification: JsonField<Identification> = JsonMissing.of(),
                @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
            ) : this(address, identification, name, mutableMapOf())

            /**
             * The sole proprietor's physical address. Mail receiving locations like PO Boxes and
             * PMB's are disallowed.
             *
             * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g.
             *   if the server responded with an unexpected value).
            ...
            private val hashCode: Int by lazy {
                Objects.hash(address, identification, name, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "SoleProprietor{address=$address, identification=$identification, name=$name, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() =
            "SoleProprietorship{address=$address, email=$email, soleProprietor=$soleProprietor, taxIdentifier=$taxIdentifier, website=$website, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (if (agreedAt.asKnown() == null) 0 else 1) +
                (if (ipAddress.asKnown() == null) 0 else 1) +
                (if (termsUrl.asKnown() == null) 0 else 1)
    ...
    private constructor(
        ...
        ) : this(address, grantor, name, trustees, mutableMapOf())
        ...
        /**
         * The grantor of the trust. If you specify this parameter, the trust's existing grantor
         * will be archived and replaced with the grantor you provide.
         *
         * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
         */
        ...
        /**
         * The trustees of the trust. If you specify this parameter, the trust's existing trustees
         * will be archived and replaced with the trustees you provide.
         *
         * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
         */
        fun trustees(): List<Trustee>? = trustees.getNullable("trustees")
        ...
        class Builder internal constructor() {
            ...
            fun build(): Trust =
                Trust(
                    ...
                    grantor,
                    name,
                    (trustees ?: JsonMissing.of()).map { it.toImmutable() },
                    additionalProperties.toMutableMap(),
                )
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(address, grantor, name, trustees, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Trust{address=$address, grantor=$grantor, name=$name, trustees=$trustees, additionalProperties=$additionalProperties}"
    }
