...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "SoleProprietorship{address=$address, email=$email, industryCode=$industryCode, soleProprietor=$soleProprietor, taxIdentifier=$taxIdentifier, website=$website, additionalProperties=$additionalProperties}"
    }
