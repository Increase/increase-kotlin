...
private constructor(
    ...
    private constructor(
        ...
        ) : this(address, name, trustees, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(address, name, trustees, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Trust{address=$address, name=$name, trustees=$trustees, additionalProperties=$additionalProperties}"
    }
