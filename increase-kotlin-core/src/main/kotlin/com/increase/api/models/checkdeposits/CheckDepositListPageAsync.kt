...
/** List Check Deposits */
class CheckDepositListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(checkDepositsService: CheckDepositServiceAsync, params: CheckDepositListParams, response: Response) =
