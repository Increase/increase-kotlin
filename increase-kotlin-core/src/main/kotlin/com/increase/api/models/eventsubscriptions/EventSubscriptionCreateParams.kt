...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun selectedEventCategories(): List<SelectedEventCategory>? = body.selectedEventCategories()
     ...
     * unexpected type.
     */
    fun _selectedEventCategories(): JsonField<List<SelectedEventCategory>> =
    ...
    class Builder internal constructor() {
         ...
         */
        fun selectedEventCategories(selectedEventCategories: List<SelectedEventCategory>) = apply {
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var selectedEventCategories: JsonField<MutableList<SelectedEventCategory>>? =
                null
