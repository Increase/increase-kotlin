...
/** List ACH Transfers */
class AchTransferListPage private constructor(
    ...
    companion object {
        ...
        fun of(achTransfersService: AchTransferService, params: AchTransferListParams, response: Response) =
            AchTransferListPage(
              achTransfersService,
              params,
              response,
