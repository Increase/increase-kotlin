...
/** List Wire Transfers */
class WireTransferListPage private constructor(
    ...
    companion object {
        ...
        fun of(wireTransfersService: WireTransferService, params: WireTransferListParams, response: Response) =
    ...
    class AutoPager(
        private val firstPage: WireTransferListPage,

    ) : Sequence<WireTransfer> {

        override fun iterator(): Iterator<WireTransfer> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
