...
/** List Card Profiles */
class DigitalCardProfileListPage private constructor(
    ...
    companion object {
        ...
        fun of(digitalCardProfilesService: DigitalCardProfileService, params: DigitalCardProfileListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<DigitalCardProfile> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
