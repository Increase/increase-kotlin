 ...
 */
@NoAutoDetect
class DigitalCardProfile @JsonCreator private constructor(
    ...
    fun validate(): DigitalCardProfile =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(digitalCardProfile: DigitalCardProfile) =
            apply {
        ...
        /** A website the user can visit to view and receive support for their card. */
        fun contactWebsite(contactWebsite: String?) = contactWebsite(JsonField.ofNullable(contactWebsite))
