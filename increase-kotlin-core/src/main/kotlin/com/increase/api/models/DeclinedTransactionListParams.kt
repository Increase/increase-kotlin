...
class DeclinedTransactionListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "DeclinedTransactionListParams{accountId=$accountId, category=$category, createdAt=$createdAt, cursor=$cursor, limit=$limit, routeId=$routeId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(declinedTransactionListParams: DeclinedTransactionListParams) = apply {
            ...
            additionalBodyProperties(declinedTransactionListParams.additionalBodyProperties)
        }
        ...
        fun build(): DeclinedTransactionListParams = DeclinedTransactionListParams(
            accountId,
            category,
            createdAt,
            cursor,
    ...
    class Category private constructor(private val in_: List<In>?, private val additionalProperties: Map<String, List<String>>, ) {
        ...
        class In @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            companion object {
                ...
                val INBOUND_REAL_TIME_PAYMENTS_TRANSFER_DECLINE = In(JsonField.of("inbound_real_time_payments_transfer_decline"))
