...
class EventSubscriptionListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "EventSubscriptionListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(eventSubscriptionListParams: EventSubscriptionListParams) = apply {
            ...
            additionalBodyProperties(eventSubscriptionListParams.additionalBodyProperties)
        }
        ...
        fun build(): EventSubscriptionListParams = EventSubscriptionListParams(
            cursor,
            idempotencyKey,
            limit,
