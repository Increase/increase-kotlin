...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BookkeepingEntrySet>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BookkeepingEntrySet> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BookkeepingEntrySet>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<BookkeepingEntrySet>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<BookkeepingEntrySet>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<BookkeepingEntrySet>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BookkeepingEntrySet] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BookkeepingEntrySet) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BookkeepingEntrySetListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
