...
class IntrafiExclusionRetrieveParams private constructor(
    ...
    /** A builder for [IntrafiExclusionRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(intrafiExclusionRetrieveParams: IntrafiExclusionRetrieveParams) =
            apply {
    ...
    override fun toString() = "IntrafiExclusionRetrieveParams{intrafiExclusionId=$intrafiExclusionId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
