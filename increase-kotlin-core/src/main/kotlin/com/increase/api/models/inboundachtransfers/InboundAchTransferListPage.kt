...
class InboundAchTransferListPage private constructor(
    ...
    companion object {
        ...
        fun of(inboundAchTransfersService: InboundAchTransferService, params: InboundAchTransferListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<InboundAchTransfer> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
