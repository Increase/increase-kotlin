...
private constructor(
     ...
     */
    fun balanceCheck(): BalanceCheck? = body.balanceCheck()
     ...
     *   server responded with an unexpected value).
     */
    fun validUntilDate(): LocalDate? = body.validUntilDate()
    ...
    private constructor(
         ...
         * most 24 lines. Paragraphs will wrap at about 120 characters, but depending on your exact
        ...
        /**
         * A custom name to print above the default return address. Cannot be provided together with
         * `return_address`.
         *
         * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
        ...
        class Builder internal constructor() {
             ...
             * contain at most 24 lines. Paragraphs will wrap at about 120 characters, but depending
            ...
            /**
             * A custom name to print above the default return address. Cannot be provided together
             * with `return_address`.
             */
            fun returnAddressName(returnAddressName: String) =
                returnAddressName(JsonField.of(returnAddressName))
        ...
        private constructor(
            ...
            ) : this(city, line1, postalCode, state, line2, name, phone, mutableMapOf())
            ...
            /**
             * The phone number to associate with the check's destination address. The phone number
            ...
            override fun toString() =
                "MailingAddress{city=$city, line1=$line1, postalCode=$postalCode, state=$state, line2=$line2, name=$name, phone=$phone, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            /**
             * The phone number to associate with the shipper. The phone number is only used when
             * `shipping_method` is `fedex_overnight` and will be supplied to FedEx to be used in
