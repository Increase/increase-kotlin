...
class BookkeepingEntrySetRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bookkeepingEntrySetRetrieveParams: BookkeepingEntrySetRetrieveParams) =
            apply {
                ...
                additionalQueryParams = bookkeepingEntrySetRetrieveParams.additionalQueryParams.toBuilder()
            }

        /** The identifier of the Bookkeeping Entry Set. */
        fun bookkeepingEntrySetId(bookkeepingEntrySetId: String) =
            apply {
    ...
    override fun toString() = "BookkeepingEntrySetRetrieveParams{bookkeepingEntrySetId=$bookkeepingEntrySetId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
