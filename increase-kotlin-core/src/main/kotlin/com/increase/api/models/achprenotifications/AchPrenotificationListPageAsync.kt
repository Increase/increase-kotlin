...
class AchPrenotificationListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(achPrenotificationsService: AchPrenotificationServiceAsync, params: AchPrenotificationListParams, response: Response) =
