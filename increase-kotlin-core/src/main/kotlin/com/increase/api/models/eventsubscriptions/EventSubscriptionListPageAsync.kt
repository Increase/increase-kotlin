...
class EventSubscriptionListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(eventSubscriptionsService: EventSubscriptionServiceAsync, params: EventSubscriptionListParams, response: Response) =
