...
class DocumentListParams private constructor(
    ...
    override fun toString() = "DocumentListParams{category=$category, createdAt=$createdAt, cursor=$cursor, entityId=$entityId, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
