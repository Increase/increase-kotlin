...
class InboundCheckDepositListPage private constructor(
    ...
    companion object {
        ...
        fun of(inboundCheckDepositsService: InboundCheckDepositService, params: InboundCheckDepositListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<InboundCheckDeposit>> = JsonMissing.of(),
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<InboundCheckDeposit> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
