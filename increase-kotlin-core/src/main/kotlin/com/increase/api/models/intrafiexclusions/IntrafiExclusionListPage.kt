...
class IntrafiExclusionListPage private constructor(
    ...
    companion object {
        ...
        fun of(intrafiExclusionsService: IntrafiExclusionService, params: IntrafiExclusionListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<IntrafiExclusion>> = JsonMissing.of(),
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<IntrafiExclusion> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
