...
class AccountNumberRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "AccountNumberRetrieveParams{accountNumberId=$accountNumberId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(accountNumberRetrieveParams: AccountNumberRetrieveParams) = apply {
            ...
            additionalBodyProperties(accountNumberRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): AccountNumberRetrieveParams = AccountNumberRetrieveParams(
