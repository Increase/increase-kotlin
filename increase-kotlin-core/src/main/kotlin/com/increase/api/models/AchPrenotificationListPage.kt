...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AchPrenotificationListPage && this.achPrenotificationsService == other.achPrenotificationsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
