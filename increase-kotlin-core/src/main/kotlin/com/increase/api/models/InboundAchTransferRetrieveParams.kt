...
class InboundAchTransferRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "InboundAchTransferRetrieveParams{inboundAchTransferId=$inboundAchTransferId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(inboundAchTransferRetrieveParams: InboundAchTransferRetrieveParams) = apply {
        ...
        fun build(): InboundAchTransferRetrieveParams = InboundAchTransferRetrieveParams(
