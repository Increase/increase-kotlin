...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InboundAchTransferRetrieveParams && this.inboundAchTransferId == other.inboundAchTransferId && this.additionalHeaders == other.additionalHeaders && this.additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(inboundAchTransferId, additionalHeaders, additionalQueryParams) /* spotless:on */
    }
