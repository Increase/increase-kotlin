...
class Entity @JsonCreator private constructor(
    ...
    @JsonProperty("details_confirmed_at") @ExcludeMissing private val detailsConfirmedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    ...
    @JsonProperty("supplemental_documents") @ExcludeMissing private val supplementalDocuments: JsonField<List<EntitySupplementalDocument>> = JsonMissing.of(),
     ...
     */
    fun supplementalDocuments(): List<EntitySupplementalDocument> = supplementalDocuments.getRequired("supplemental_documents")
    ...
    @ExcludeMissing
    fun _supplementalDocuments(): JsonField<List<EntitySupplementalDocument>> = supplementalDocuments
    ...
    class Builder internal constructor() {
        ...
        private var supplementalDocuments: JsonField<MutableList<EntitySupplementalDocument>>? = null
         ...
         * Entity's details were most recently confirmed.
         */
        fun detailsConfirmedAt(detailsConfirmedAt: OffsetDateTime?) = detailsConfirmedAt(JsonField.ofNullable(detailsConfirmedAt))

        /**
         * The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) time at which the
         * Entity's details were most recently confirmed.
         */
        fun detailsConfirmedAt(detailsConfirmedAt: JsonField<OffsetDateTime>) =
            apply {
         ...
         * equal to `government_authority`.
         */
        fun governmentAuthority(governmentAuthority: GovernmentAuthority?) = governmentAuthority(JsonField.ofNullable(governmentAuthority))
         ...
         * `natural_person`.
         */
        fun naturalPerson(naturalPerson: NaturalPerson?) = naturalPerson(JsonField.ofNullable(naturalPerson))
         ...
         * the GET /entity_supplemental_documents list endpoint to retrieve them.
         */
        fun supplementalDocuments(supplementalDocuments: List<EntitySupplementalDocument>) = supplementalDocuments(JsonField.of(supplementalDocuments))
         ...
         * the GET /entity_supplemental_documents list endpoint to retrieve them.
         */
        fun supplementalDocuments(supplementalDocuments: JsonField<List<EntitySupplementalDocument>>) =
            apply {
         ...
         * the GET /entity_supplemental_documents list endpoint to retrieve them.
         */
        fun addSupplementalDocument(supplementalDocument: EntitySupplementalDocument) =
            apply {
    ...
    class Corporation @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
             ...
             * corporation's state of incorporation.
             */
            fun incorporationState(incorporationState: String?) = incorporationState(JsonField.ofNullable(incorporationState))
             ...
             * for the corporation.
             */
            fun industryCode(industryCode: String?) = industryCode(JsonField.ofNullable(industryCode))
            ...
            /** The Employer Identification Number (EIN) for the corporation. */
            fun taxIdentifier(taxIdentifier: String?) = taxIdentifier(JsonField.ofNullable(taxIdentifier))
        ...
        class BeneficialOwner @JsonCreator private constructor(
            ...
            @JsonProperty("prong") @ExcludeMissing private val prong: JsonField<Prong> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            @JsonProperty("prong")
            @ExcludeMissing
            fun _prong(): JsonField<Prong> = prong
            ...
            class Builder internal constructor() {
                ...
                /** Why this person is considered a beneficial owner of the entity. */
                fun prong(prong: JsonField<Prong>) =
                    apply {
                        this.prong = prong
                    }
            ...
            class Individual @JsonCreator private constructor(
                ...
                class Identification @JsonCreator private constructor(
                    ...
                    @JsonProperty("number_last4") @ExcludeMissing private val numberLast4: JsonField<String> = JsonMissing.of(),
                    @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                    ...
                    class Builder internal constructor() {
                         ...
                         * individual's identity.
                         */
                        fun numberLast4(numberLast4: JsonField<String>) =
                            apply {
    ...
    class GovernmentAuthority @JsonCreator private constructor(
        ...
        class AuthorizedPerson @JsonCreator private constructor(
            @JsonProperty("authorized_person_id") @ExcludeMissing private val authorizedPersonId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("name") @ExcludeMissing private val name: JsonField<String> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            class Builder internal constructor() {
                ...
                /** The identifier of this authorized person. */
                fun authorizedPersonId(authorizedPersonId: JsonField<String>) =
                    apply {
    ...
    class Trust @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** The ID for the File containing the formation document of the trust. */
            fun formationDocumentFileId(formationDocumentFileId: String?) = formationDocumentFileId(JsonField.ofNullable(formationDocumentFileId))
             ...
             * which the trust was formed.
             */
            fun formationState(formationState: String?) = formationState(JsonField.ofNullable(formationState))
            ...
            fun build(): Trust =
                Trust(
                  ...
                  checkRequired(
                    "formationDocumentFileId", formationDocumentFileId
                  ),
                  checkRequired(
        ...
        class Trustee @JsonCreator private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * `structure` is equal to `individual`.
                 */
                fun individual(individual: Individual?) = individual(JsonField.ofNullable(individual))
