...
private constructor(
    ...
    private constructor(
        ...
        private val beneficialOwners: JsonField<List<EntityBeneficialOwner>>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            beneficialOwners: JsonField<List<EntityBeneficialOwner>> = JsonMissing.of(),
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun beneficialOwners(): List<EntityBeneficialOwner> =
        ...
        @JsonProperty("beneficial_owners")
        @ExcludeMissing
        fun _beneficialOwners(): JsonField<List<EntityBeneficialOwner>> = beneficialOwners
        ...
        class Builder internal constructor() {
            ...
            private var beneficialOwners: JsonField<MutableList<EntityBeneficialOwner>>? = null
             ...
             * corporation.
             */
            fun beneficialOwners(beneficialOwners: List<EntityBeneficialOwner>) =
             ...
             * `List<EntityBeneficialOwner>` value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
            fun beneficialOwners(beneficialOwners: JsonField<List<EntityBeneficialOwner>>) = apply {
