...
class WireDrawdownRequestRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "WireDrawdownRequestRetrieveParams{wireDrawdownRequestId=$wireDrawdownRequestId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(wireDrawdownRequestRetrieveParams: WireDrawdownRequestRetrieveParams) = apply {
            ...
            additionalBodyProperties(wireDrawdownRequestRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): WireDrawdownRequestRetrieveParams = WireDrawdownRequestRetrieveParams(
