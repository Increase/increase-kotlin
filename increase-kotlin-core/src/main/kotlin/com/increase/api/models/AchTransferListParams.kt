...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AchTransferListParams && this.accountId == other.accountId && this.createdAt == other.createdAt && this.cursor == other.cursor && this.externalAccountId == other.externalAccountId && this.idempotencyKey == other.idempotencyKey && this.limit == other.limit && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(accountId, createdAt, cursor, externalAccountId, idempotencyKey, limit, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "AchTransferListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, externalAccountId=$externalAccountId, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(achTransferListParams: AchTransferListParams) = apply {
            ...
            this.idempotencyKey = achTransferListParams.idempotencyKey
