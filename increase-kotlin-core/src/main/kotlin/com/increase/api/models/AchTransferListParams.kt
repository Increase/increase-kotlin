...
constructor(
    ...
    override fun toString() =
        "AchTransferListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, externalAccountId=$externalAccountId, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(achTransferListParams: AchTransferListParams) = apply {
            ...
            additionalBodyProperties(achTransferListParams.additionalBodyProperties)
        }
