...
class SupplementalDocumentListPageAsync private constructor(private val supplementalDocumentsService: SupplementalDocumentServiceAsync, private val params: SupplementalDocumentListParams, private val response: Response, ) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SupplementalDocumentListPageAsync &&
    ...
    override fun toString() = "SupplementalDocumentListPageAsync{supplementalDocumentsService=$supplementalDocumentsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(supplementalDocumentsService: SupplementalDocumentServiceAsync, params: SupplementalDocumentListParams, response: Response) = SupplementalDocumentListPageAsync(
            supplementalDocumentsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<EntitySupplementalDocument>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "SupplementalDocumentListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: SupplementalDocumentListPageAsync, ) : Flow<EntitySupplementalDocument> {
