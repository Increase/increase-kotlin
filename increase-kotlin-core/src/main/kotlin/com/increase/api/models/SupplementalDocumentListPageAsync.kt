...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SupplementalDocumentListPageAsync && this.supplementalDocumentsService == other.supplementalDocumentsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(supplementalDocumentsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "SupplementalDocumentListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
