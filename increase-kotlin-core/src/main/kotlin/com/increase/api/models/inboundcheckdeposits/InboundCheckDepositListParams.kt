...
class InboundCheckDepositListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.checkTransferId?.let {
          queryParams.put(
            "check_transfer_id", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundCheckDepositListParams: InboundCheckDepositListParams) =
            apply {
    ...
    override fun toString() = "InboundCheckDepositListParams{accountId=$accountId, checkTransferId=$checkTransferId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
