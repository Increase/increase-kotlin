...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountNumberListPageAsync && this.accountNumbersService == other.accountNumbersService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(accountNumbersService, params, response) /* spotless:on */
    }
    ...
    fun getNextPageParams(): AccountNumberListParams? {
        ...
        return AccountNumberListParams.builder()
            .from(params)
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<AccountNumber>>? = data
