...
class CardAuthorizationExpirationCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{cardPaymentId=$cardPaymentId, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardAuthorizationExpirationCreateParams: CardAuthorizationExpirationCreateParams) =
            apply {
                body = cardAuthorizationExpirationCreateParams.body.toBuilder()
                additionalHeaders = cardAuthorizationExpirationCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = cardAuthorizationExpirationCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CardAuthorizationExpirationCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "CardAuthorizationExpirationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
