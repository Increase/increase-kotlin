...
class DeclinedTransactionListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(declinedTransactionsService: DeclinedTransactionServiceAsync, params: DeclinedTransactionListParams, response: Response) =
