...
class ExternalAccountUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class ExternalAccountUpdateBody internal constructor(
      private val accountHolder: AccountHolder?,
      private val description: String?,
      private val funding: Funding?,
      private val status: Status?,
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "ExternalAccountUpdateBody{accountHolder=$accountHolder, description=$description, funding=$funding, status=$status, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): ExternalAccountUpdateBody = ExternalAccountUpdateBody(
                accountHolder,
                description,
                funding,
                status,
    ...
    override fun toString() = "ExternalAccountUpdateParams{externalAccountId=$externalAccountId, accountHolder=$accountHolder, description=$description, funding=$funding, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): ExternalAccountUpdateParams = ExternalAccountUpdateParams(
