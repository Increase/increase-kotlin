...
class OAuthConnectionListPage private constructor(private val oauthConnectionsService: OAuthConnectionService, private val params: OAuthConnectionListParams, private val response: Response, ) {
    ...
    override fun toString() = "OAuthConnectionListPage{oauthConnectionsService=$oauthConnectionsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): OAuthConnectionListParams? {
      ...
      return OAuthConnectionListParams.builder().from(params).apply {nextCursor()?.let{ this.cursor(it) } }.build()
    }

    fun getNextPage(): OAuthConnectionListPage? {
      return getNextPageParams()?.let {
          oauthConnectionsService.list(it)
      }
    }
    ...
    companion object {
        ...
        fun of(oauthConnectionsService: OAuthConnectionService, params: OAuthConnectionListParams, response: Response) = OAuthConnectionListPage(
            oauthConnectionsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<OAuthConnection>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        @JsonProperty("data")
        fun _data(): JsonField<List<OAuthConnection>>? = data
        ...
        override fun toString() = "OAuthConnectionListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: OAuthConnectionListPage, ) : Sequence<OAuthConnection> {
