...
class LockboxListPageAsync private constructor(private val lockboxesService: LockboxServiceAsync, private val params: LockboxListParams, private val response: Response, ) {
    ...
    override fun toString() = "LockboxListPageAsync{lockboxesService=$lockboxesService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(lockboxesService: LockboxServiceAsync, params: LockboxListParams, response: Response) = LockboxListPageAsync(
            lockboxesService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<Lockbox>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "LockboxListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: LockboxListPageAsync, ) : Flow<Lockbox> {
