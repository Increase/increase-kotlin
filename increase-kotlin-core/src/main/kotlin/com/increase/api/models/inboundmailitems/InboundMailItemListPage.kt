...
class InboundMailItemListPage private constructor(
    ...
    companion object {
        ...
        fun of(inboundMailItemsService: InboundMailItemService, params: InboundMailItemListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<InboundMailItem>> = JsonMissing.of(),
    ...
    ) : Sequence<InboundMailItem> {

        override fun iterator(): Iterator<InboundMailItem> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
