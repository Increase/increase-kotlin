...
class InboundFednowTransferListParams
private constructor(
    ...
    companion object {
        ...
        fun none(): InboundFednowTransferListParams = builder().build()
    ...
    /** A builder for [InboundFednowTransferListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(inboundFednowTransferListParams: InboundFednowTransferListParams) =
            apply {
                accountId = inboundFednowTransferListParams.accountId
                accountNumberId = inboundFednowTransferListParams.accountNumberId
                createdAt = inboundFednowTransferListParams.createdAt
                cursor = inboundFednowTransferListParams.cursor
                limit = inboundFednowTransferListParams.limit
                additionalHeaders = inboundFednowTransferListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    inboundFednowTransferListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [InboundFednowTransferListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InboundFednowTransferListParams =
            InboundFednowTransferListParams(
                accountId,
                accountNumberId,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InboundFednowTransferListParams &&
    ...
    override fun toString() =
        "InboundFednowTransferListParams{accountId=$accountId, accountNumberId=$accountNumberId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
