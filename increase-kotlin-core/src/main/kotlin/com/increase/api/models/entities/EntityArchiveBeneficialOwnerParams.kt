...
class EntityArchiveBeneficialOwnerParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{beneficialOwnerId=$beneficialOwnerId, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(entityArchiveBeneficialOwnerParams: EntityArchiveBeneficialOwnerParams) =
            apply {
                ...
                additionalQueryParams = entityArchiveBeneficialOwnerParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "EntityArchiveBeneficialOwnerParams{entityId=$entityId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
