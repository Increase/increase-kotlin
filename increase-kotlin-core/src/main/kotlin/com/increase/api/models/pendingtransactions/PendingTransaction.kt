...
private constructor(
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun blockchainOfframpTransfer(): BlockchainOfframpTransfer? =
            blockchainOfframpTransfer.getNullable("blockchain_offramp_transfer")
         ...
         *   the server responded with an unexpected value).
         */
        fun sepaInstantTransferInstruction(): SepaInstantTransferInstruction? =
            sepaInstantTransferInstruction.getNullable("sepa_instant_transfer_instruction")
         ...
         *   the server responded with an unexpected value).
         */
        fun ukFasterPaymentSystemTransferInstruction(): UkFasterPaymentSystemTransferInstruction? =
            ukFasterPaymentSystemTransferInstruction.getNullable(
                "uk_faster_payment_system_transfer_instruction"
            )
        ...
        fun validate(): Source = apply {
            ...
            blockchainOfframpTransfer()?.validate()
            ...
            sepaInstantTransferInstruction()?.validate()
            swiftTransferInstruction()?.validate()
            ukFasterPaymentSystemTransferInstruction()?.validate()
        ...
        internal fun validity(): Int =
            (category.asKnown()?.validity() ?: 0) +
                ...
                (blockchainOfframpTransfer.asKnown()?.validity() ?: 0) +
                ...
                (sepaInstantTransferInstruction.asKnown()?.validity() ?: 0) +
                (swiftTransferInstruction.asKnown()?.validity() ?: 0) +
                (ukFasterPaymentSystemTransferInstruction.asKnown()?.validity() ?: 0) +
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (if (id.asKnown() == null) 0 else 1) +
                    (token.asKnown()?.validity() ?: 0) +
                    (if (amount.asKnown() == null) 0 else 1) +
                    (if (createdAt.asKnown() == null) 0 else 1) +
                    (if (destinationAccountId.asKnown() == null) 0 else 1) +
                    (if (initiatingTransactionHash.asKnown() == null) 0 else 1) +
            ...
            class Token @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                companion object {
                    ...
                    fun of(value: String) = Token(JsonField.of(value))
                }
        ...
        private constructor(
             ...
             *
             * Unlike [healthcare], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("healthcare")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * programs.
                 */
                fun healthcare(healthcare: Healthcare?) =
                    healthcare(JsonField.ofNullable(healthcare))
            ...
            private constructor(
                ...
                fun merchantNinetyPercentEligibility(): MerchantNinetyPercentEligibility =
                    merchantNinetyPercentEligibility.getRequired(
                ...
                @JsonProperty("merchant_ninety_percent_eligibility")
                @ExcludeMissing
                fun _merchantNinetyPercentEligibility():
                    JsonField<MerchantNinetyPercentEligibility> = merchantNinetyPercentEligibility
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(healthcare: Healthcare) = apply {
                        merchantNinetyPercentEligibility =
                            healthcare.merchantNinetyPercentEligibility
                    ...
                    fun merchantNinetyPercentEligibility(
                        ...
                        merchantNinetyPercentEligibility(
                            JsonField.of(merchantNinetyPercentEligibility)
                        )
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    companion object {
                        ...
                        fun of(value: String) =
                            MerchantNinetyPercentEligibility(JsonField.of(value))
                    }
                    ...
                    /**
                     * An enum containing [MerchantNinetyPercentEligibility]'s known values, as well
                     * as an [_UNKNOWN] member.
                     *
                     * An instance of [MerchantNinetyPercentEligibility] can contain an unknown
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is Healthcare &&
                        merchantNinetyPercentEligibility ==
                            other.merchantNinetyPercentEligibility &&
                        additionalProperties == other.additionalProperties
                }
