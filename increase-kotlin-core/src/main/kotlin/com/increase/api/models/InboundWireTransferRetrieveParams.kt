...
class InboundWireTransferRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "InboundWireTransferRetrieveParams{inboundWireTransferId=$inboundWireTransferId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(inboundWireTransferRetrieveParams: InboundWireTransferRetrieveParams) = apply {
            ...
            additionalBodyProperties(inboundWireTransferRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): InboundWireTransferRetrieveParams = InboundWireTransferRetrieveParams(
