...
class ProofOfAuthorizationRequestListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(proofOfAuthorizationRequestListParams: ProofOfAuthorizationRequestListParams) =
            apply {
                ...
                additionalQueryParams = proofOfAuthorizationRequestListParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "ProofOfAuthorizationRequestListParams{createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
