...
class InboundMailItemRetrieveParams private constructor(
    ...
    /** A builder for [InboundMailItemRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(inboundMailItemRetrieveParams: InboundMailItemRetrieveParams) =
            apply {
                inboundMailItemId = inboundMailItemRetrieveParams.inboundMailItemId
                additionalHeaders = inboundMailItemRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = inboundMailItemRetrieveParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "InboundMailItemRetrieveParams{inboundMailItemId=$inboundMailItemId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
