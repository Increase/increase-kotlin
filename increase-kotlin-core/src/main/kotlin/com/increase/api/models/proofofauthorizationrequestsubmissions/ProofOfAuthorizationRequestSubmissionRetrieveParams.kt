...
class ProofOfAuthorizationRequestSubmissionRetrieveParams private constructor(
    ...
    /** A builder for [ProofOfAuthorizationRequestSubmissionRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(proofOfAuthorizationRequestSubmissionRetrieveParams: ProofOfAuthorizationRequestSubmissionRetrieveParams) =
            apply {
                proofOfAuthorizationRequestSubmissionId = proofOfAuthorizationRequestSubmissionRetrieveParams.proofOfAuthorizationRequestSubmissionId
                additionalHeaders = proofOfAuthorizationRequestSubmissionRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = proofOfAuthorizationRequestSubmissionRetrieveParams.additionalQueryParams.toBuilder()
            }

        /** The identifier of the Proof of Authorization Request Submission. */
        fun proofOfAuthorizationRequestSubmissionId(proofOfAuthorizationRequestSubmissionId: String) =
            apply {
        ...
        fun build(): ProofOfAuthorizationRequestSubmissionRetrieveParams =
            ProofOfAuthorizationRequestSubmissionRetrieveParams(
              checkRequired(
                "proofOfAuthorizationRequestSubmissionId", proofOfAuthorizationRequestSubmissionId
              ),
    ...
    override fun toString() = "ProofOfAuthorizationRequestSubmissionRetrieveParams{proofOfAuthorizationRequestSubmissionId=$proofOfAuthorizationRequestSubmissionId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
