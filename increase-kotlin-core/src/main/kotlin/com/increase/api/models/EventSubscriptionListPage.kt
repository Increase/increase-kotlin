...
class EventSubscriptionListPage private constructor(private val eventSubscriptionsService: EventSubscriptionService, private val params: EventSubscriptionListParams, private val response: Response, ) {
    ...
    companion object {
        ...
        fun of(eventSubscriptionsService: EventSubscriptionService, params: EventSubscriptionListParams, response: Response) = EventSubscriptionListPage(
            eventSubscriptionsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<EventSubscription>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "EventSubscriptionListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: EventSubscriptionListPage, ) : Sequence<EventSubscription> {
