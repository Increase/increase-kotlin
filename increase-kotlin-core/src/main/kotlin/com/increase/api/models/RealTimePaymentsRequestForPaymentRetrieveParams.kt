...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RealTimePaymentsRequestForPaymentRetrieveParams && this.requestForPaymentId == other.requestForPaymentId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(requestForPaymentId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "RealTimePaymentsRequestForPaymentRetrieveParams{requestForPaymentId=$requestForPaymentId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
