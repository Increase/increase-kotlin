...
class CardPurchaseSupplementRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardPurchaseSupplementRetrieveParams: CardPurchaseSupplementRetrieveParams) =
            apply {
                ...
                additionalQueryParams = cardPurchaseSupplementRetrieveParams.additionalQueryParams.toBuilder()
            }

        /** The identifier of the Card Purchase Supplement. */
        fun cardPurchaseSupplementId(cardPurchaseSupplementId: String) =
            apply {
    ...
    override fun toString() = "CardPurchaseSupplementRetrieveParams{cardPurchaseSupplementId=$cardPurchaseSupplementId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
