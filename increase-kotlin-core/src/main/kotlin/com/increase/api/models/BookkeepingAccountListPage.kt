...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BookkeepingAccountListPage && this.bookkeepingAccountsService == other.bookkeepingAccountsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(bookkeepingAccountsService, params, response) /* spotless:on */
    }
    ...
    fun getNextPageParams(): BookkeepingAccountListParams? {
        ...
        return BookkeepingAccountListParams.builder()
            .from(params)
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<BookkeepingAccount>>? = data
        ...
        override fun toString() =
            "BookkeepingAccountListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
