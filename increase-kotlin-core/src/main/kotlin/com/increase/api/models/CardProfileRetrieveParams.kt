...
constructor(
    ...
    class Builder {
        ...
        internal fun from(cardProfileRetrieveParams: CardProfileRetrieveParams) = apply {
            this.cardProfileId = cardProfileRetrieveParams.cardProfileId
            additionalQueryParams(cardProfileRetrieveParams.additionalQueryParams)
            additionalHeaders(cardProfileRetrieveParams.additionalHeaders)
        }
