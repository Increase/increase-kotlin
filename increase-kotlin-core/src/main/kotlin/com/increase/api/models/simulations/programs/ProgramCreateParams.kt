 ...
 * accounts.
 */
class ProgramCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(programCreateParams: ProgramCreateParams) =
            apply {
    ...
    override fun toString() = "ProgramCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
