...
class OAuthApplicationListPageAsync private constructor(
    ...
    override fun toString() = "OAuthApplicationListPageAsync{oauthApplicationsService=$oauthApplicationsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(oauthApplicationsService: OAuthApplicationServiceAsync, params: OAuthApplicationListParams, response: Response) =
