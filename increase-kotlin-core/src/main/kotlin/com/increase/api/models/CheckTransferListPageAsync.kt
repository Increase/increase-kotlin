...
class CheckTransferListPageAsync private constructor(private val checkTransfersService: CheckTransferServiceAsync, private val params: CheckTransferListParams, private val response: Response, ) {
    ...
    companion object {
        ...
        fun of(checkTransfersService: CheckTransferServiceAsync, params: CheckTransferListParams, response: Response) = CheckTransferListPageAsync(
            checkTransfersService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<CheckTransfer>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "CheckTransferListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: CheckTransferListPageAsync, ) : Flow<CheckTransfer> {
