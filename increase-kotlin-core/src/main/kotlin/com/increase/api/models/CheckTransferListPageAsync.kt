...
private constructor(
    ...
    fun getNextPageParams(): CheckTransferListParams? {
        ...
        return CheckTransferListParams.builder().from(params).cursor(nextCursor()).build()
    }
    ...
    constructor(
        ...
        override fun toString() =
            "CheckTransferListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
