...
@NoAutoDetect
class EventSubscription private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "EventSubscription{createdAt=$createdAt, id=$id, idempotencyKey=$idempotencyKey, oauthConnectionId=$oauthConnectionId, selectedEventCategory=$selectedEventCategory, status=$status, type=$type, url=$url, additionalProperties=$additionalProperties}"
