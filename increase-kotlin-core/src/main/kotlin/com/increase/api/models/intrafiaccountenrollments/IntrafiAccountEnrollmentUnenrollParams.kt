...
class IntrafiAccountEnrollmentUnenrollParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(intrafiAccountEnrollmentUnenrollParams: IntrafiAccountEnrollmentUnenrollParams) =
            apply {
                intrafiAccountEnrollmentId = intrafiAccountEnrollmentUnenrollParams.intrafiAccountEnrollmentId
                additionalHeaders = intrafiAccountEnrollmentUnenrollParams.additionalHeaders.toBuilder()
                additionalQueryParams = intrafiAccountEnrollmentUnenrollParams.additionalQueryParams.toBuilder()
                additionalBodyProperties = intrafiAccountEnrollmentUnenrollParams.additionalBodyProperties.toMutableMap()
            }

        /** The Identifier of the IntraFi Account Enrollment to remove from IntraFi. */
        fun intrafiAccountEnrollmentId(intrafiAccountEnrollmentId: String) =
            apply {
    ...
    override fun toString() = "IntrafiAccountEnrollmentUnenrollParams{intrafiAccountEnrollmentId=$intrafiAccountEnrollmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
