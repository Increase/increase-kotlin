...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DeclinedTransactionListPage && this.declinedTransactionsService == other.declinedTransactionsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
