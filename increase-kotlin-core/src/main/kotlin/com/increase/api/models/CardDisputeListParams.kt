...
class CardDisputeListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "CardDisputeListParams{createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(cardDisputeListParams: CardDisputeListParams) = apply {
            ...
            additionalBodyProperties(cardDisputeListParams.additionalBodyProperties)
        }
        ...
        fun build(): CardDisputeListParams = CardDisputeListParams(
            createdAt,
            cursor,
            idempotencyKey,
            limit,
