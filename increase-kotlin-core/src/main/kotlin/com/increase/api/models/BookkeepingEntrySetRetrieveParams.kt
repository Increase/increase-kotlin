...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BookkeepingEntrySetRetrieveParams && this.bookkeepingEntrySetId == other.bookkeepingEntrySetId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(bookkeepingEntrySetId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }
