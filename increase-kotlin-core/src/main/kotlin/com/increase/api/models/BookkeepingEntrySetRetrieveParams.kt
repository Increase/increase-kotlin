...
class BookkeepingEntrySetRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "BookkeepingEntrySetRetrieveParams{bookkeepingEntrySetId=$bookkeepingEntrySetId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(bookkeepingEntrySetRetrieveParams: BookkeepingEntrySetRetrieveParams) = apply {
            ...
            additionalBodyProperties(bookkeepingEntrySetRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): BookkeepingEntrySetRetrieveParams = BookkeepingEntrySetRetrieveParams(
