...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SimulationInboundFundsHoldReleaseParams && this.inboundFundsHoldId == other.inboundFundsHoldId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(inboundFundsHoldId, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "SimulationInboundFundsHoldReleaseParams{inboundFundsHoldId=$inboundFundsHoldId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): SimulationInboundFundsHoldReleaseParams =
            SimulationInboundFundsHoldReleaseParams(
                checkNotNull(inboundFundsHoldId) {
                    "`inboundFundsHoldId` is required but was not set"
                },
