...
class InboundWireTransferListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(inboundWireTransfersService: InboundWireTransferServiceAsync, params: InboundWireTransferListParams, response: Response) =
