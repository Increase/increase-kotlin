...
class InboundWireDrawdownRequestListPageResponse
private constructor(
    ...
    /** A builder for [InboundWireDrawdownRequestListPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = inboundWireDrawdownRequestListPageResponse.data.map { it.toMutableList() }
            nextCursor = inboundWireDrawdownRequestListPageResponse.nextCursor
            additionalProperties =
                inboundWireDrawdownRequestListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): InboundWireDrawdownRequestListPageResponse =
            InboundWireDrawdownRequestListPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InboundWireDrawdownRequestListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "InboundWireDrawdownRequestListPageResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
