...
/** List Card Disputes */
class CardDisputeListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(cardDisputesService: CardDisputeServiceAsync, params: CardDisputeListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<CardDispute>> = JsonMissing.of(),
    ...
    class AutoPager(
        private val firstPage: CardDisputeListPageAsync,
