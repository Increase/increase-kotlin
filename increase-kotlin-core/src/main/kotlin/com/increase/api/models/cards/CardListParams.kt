...
/** List Cards */
class CardListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardListParams: CardListParams) =
            apply {
                accountId = cardListParams.accountId
                createdAt = cardListParams.createdAt
    ...
    override fun toString() = "CardListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
