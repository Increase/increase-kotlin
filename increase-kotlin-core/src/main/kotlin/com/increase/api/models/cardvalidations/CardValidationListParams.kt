...
class CardValidationListParams
private constructor(
    ...
    companion object {
        ...
        fun none(): CardValidationListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CardValidationListParams]. */
        fun builder() = Builder()
    }

    /** A builder for [CardValidationListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(cardValidationListParams: CardValidationListParams) = apply {
            accountId = cardValidationListParams.accountId
            createdAt = cardValidationListParams.createdAt
            cursor = cardValidationListParams.cursor
            idempotencyKey = cardValidationListParams.idempotencyKey
            limit = cardValidationListParams.limit
            status = cardValidationListParams.status
            additionalHeaders = cardValidationListParams.additionalHeaders.toBuilder()
            additionalQueryParams = cardValidationListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CardValidationListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CardValidationListParams =
    ...
    private constructor(private val in_: List<In>?, private val additionalProperties: QueryParams) {
        ...
        class In @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                /**
                 * The validation has been submitted and is pending a response from the card
                 * network.
                 */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardValidationListParams &&
    ...
    override fun toString() =
        "CardValidationListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
