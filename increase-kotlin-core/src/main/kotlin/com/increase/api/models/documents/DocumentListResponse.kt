...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentListResponse: DocumentListResponse) = apply {
            data = documentListResponse.data.map { it.toMutableList() }
            nextCursor = documentListResponse.nextCursor
    ...
    override fun toString() =
        "DocumentListResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
