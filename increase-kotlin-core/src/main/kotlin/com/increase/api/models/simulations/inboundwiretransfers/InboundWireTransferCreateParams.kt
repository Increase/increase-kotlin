...
class InboundWireTransferCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundWireTransferCreateParams: InboundWireTransferCreateParams) =
            apply {
                ...
                additionalQueryParams = inboundWireTransferCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "InboundWireTransferCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
