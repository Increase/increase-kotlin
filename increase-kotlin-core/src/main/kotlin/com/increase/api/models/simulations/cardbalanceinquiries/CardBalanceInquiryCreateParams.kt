...
private constructor(
     ...
     */
    fun _balance(): JsonField<Long> = body._balance()
    ...
    companion object {
        ...
        fun none(): CardBalanceInquiryCreateParams = builder().build()
    ...
    class Builder internal constructor() {
         ...
         */
        fun balance(balance: JsonField<Long>) = apply { body.balance(balance) }
    ...
    private constructor(
         ...
         */
        fun balance(): Long? = balance.getNullable("balance")
