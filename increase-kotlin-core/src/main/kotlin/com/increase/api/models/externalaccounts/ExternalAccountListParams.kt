...
class ExternalAccountListParams private constructor(
    ...
    override fun toString() = "ExternalAccountListParams{cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, routingNumber=$routingNumber, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
