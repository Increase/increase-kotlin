...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [InboundWireTransferListParams].
         *
    ...
    private constructor(private val in_: List<In>?, private val additionalProperties: QueryParams) {
        ...
        /**
         * Filter Inbound Wire Transfers to those with the specified status. For GET requests, this
        ...
        class Builder internal constructor() {
            ...
            /**
             * Filter Inbound Wire Transfers to those with the specified status. For GET requests,
