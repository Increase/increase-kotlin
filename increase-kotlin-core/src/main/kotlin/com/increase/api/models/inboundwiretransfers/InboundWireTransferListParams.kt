...
class InboundWireTransferListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundWireTransferListParams: InboundWireTransferListParams) =
            apply {
    ...
    override fun toString() = "InboundWireTransferListParams{accountId=$accountId, accountNumberId=$accountNumberId, createdAt=$createdAt, cursor=$cursor, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
