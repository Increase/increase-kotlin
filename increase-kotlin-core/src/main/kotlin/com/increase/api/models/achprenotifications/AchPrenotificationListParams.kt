...
class AchPrenotificationListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(achPrenotificationListParams: AchPrenotificationListParams) =
            apply {
    ...
    override fun toString() = "AchPrenotificationListParams{createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
