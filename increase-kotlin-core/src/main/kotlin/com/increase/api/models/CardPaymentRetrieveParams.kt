...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardPaymentRetrieveParams && this.cardPaymentId == other.cardPaymentId && this.additionalHeaders == other.additionalHeaders && this.additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(cardPaymentId, additionalHeaders, additionalQueryParams) /* spotless:on */
    }
