...
class CardPaymentRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "CardPaymentRetrieveParams{cardPaymentId=$cardPaymentId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(cardPaymentRetrieveParams: CardPaymentRetrieveParams) = apply {
            ...
            additionalBodyProperties(cardPaymentRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): CardPaymentRetrieveParams = CardPaymentRetrieveParams(
