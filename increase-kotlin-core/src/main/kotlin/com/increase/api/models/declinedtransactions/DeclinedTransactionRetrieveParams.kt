...
class DeclinedTransactionRetrieveParams private constructor(
    ...
    /** A builder for [DeclinedTransactionRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {

        private var declinedTransactionId: String? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(declinedTransactionRetrieveParams: DeclinedTransactionRetrieveParams) =
            apply {
                declinedTransactionId = declinedTransactionRetrieveParams.declinedTransactionId
                additionalHeaders = declinedTransactionRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = declinedTransactionRetrieveParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "DeclinedTransactionRetrieveParams{declinedTransactionId=$declinedTransactionId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
