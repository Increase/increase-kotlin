...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InboundWireTransferListPageAsync && this.inboundWireTransfersService == other.inboundWireTransfersService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(inboundWireTransfersService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "InboundWireTransferListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
