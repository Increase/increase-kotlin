...
/** List Files */
class FileListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileListParams: FileListParams) =
            apply {
    ...
    class Purpose private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(purpose: Purpose) =
                apply {
    ...
    override fun toString() = "FileListParams{createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, purpose=$purpose, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
