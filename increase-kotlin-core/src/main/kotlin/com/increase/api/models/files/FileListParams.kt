    ...
    private constructor(private val in_: List<In>?, private val additionalProperties: QueryParams) {
        ...
        class In @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                 ...
                 * you've requested Increase print. This must be a PDF whose pages are all US letter
                 * size and all have the same orientation.
                 */
                ...
                /** A fee statement. */
                val FEE_STATEMENT = of("fee_statement")
