...
private constructor(
    ...
    override suspend fun nextPage(): CardTokenListPageAsync = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<CardToken> = AutoPagerAsync.from(this)
    ...
    override fun toString() =
        "CardTokenListPageAsync{service=$service, params=$params, response=$response}"
}
