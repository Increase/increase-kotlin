 ...
 */
@NoAutoDetect
class InboundCheckDeposit @JsonCreator private constructor(
    ...
    @JsonProperty("bank_of_first_deposit_routing_number") @ExcludeMissing private val bankOfFirstDepositRoutingNumber: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("payee_name_analysis") @ExcludeMissing private val payeeNameAnalysis: JsonField<PayeeNameAnalysis> = JsonMissing.of(),
     ...
     */
    fun payeeNameAnalysis(): PayeeNameAnalysis = payeeNameAnalysis.getRequired("payee_name_analysis")
    ...
    fun validate(): InboundCheckDeposit =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboundCheckDeposit: InboundCheckDeposit) =
            apply {
        ...
        /** The Account Number the check is being deposited against. */
        fun accountNumberId(accountNumberId: String?) = accountNumberId(JsonField.ofNullable(accountNumberId))
         ...
         * Check21 and the value will be null.
         */
        fun bankOfFirstDepositRoutingNumber(bankOfFirstDepositRoutingNumber: String?) = bankOfFirstDepositRoutingNumber(JsonField.ofNullable(bankOfFirstDepositRoutingNumber))
         ...
         * Transaction object created as a result of the failed deposit.
         */
        fun declinedTransactionId(declinedTransactionId: String?) = declinedTransactionId(JsonField.ofNullable(declinedTransactionId))
         ...
         * This is an optional feature, contact sales to enable.
         */
        fun payeeNameAnalysis(payeeNameAnalysis: PayeeNameAnalysis) = payeeNameAnalysis(JsonField.of(payeeNameAnalysis))

        /**
         * Whether the details on the check match the recipient name of the check transfer.
         * This is an optional feature, contact sales to enable.
         */
        fun payeeNameAnalysis(payeeNameAnalysis: JsonField<PayeeNameAnalysis>) =
            apply {
        ...
        fun build(): InboundCheckDeposit =
            InboundCheckDeposit(
              ...
              checkRequired(
                "bankOfFirstDepositRoutingNumber", bankOfFirstDepositRoutingNumber
              ),
              checkRequired(
    ...
    @NoAutoDetect
    class Adjustment @JsonCreator private constructor(
        @JsonProperty("adjusted_at") @ExcludeMissing private val adjustedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("amount") @ExcludeMissing private val amount: JsonField<Long> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            internal fun from(adjustment: Adjustment) =
                apply {
            ...
            /** The time at which the return adjustment was received. */
            fun adjustedAt(adjustedAt: JsonField<OffsetDateTime>) =
                apply {
        ...
        override fun toString() = "Adjustment{adjustedAt=$adjustedAt, amount=$amount, reason=$reason, transactionId=$transactionId, additionalProperties=$additionalProperties}"
    }
     ...
     * This is an optional feature, contact sales to enable.
     */
    class PayeeNameAnalysis @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        /**
         * An enum containing [PayeeNameAnalysis]'s known values, as well as an [_UNKNOWN]
         * member.
         *
         * An instance of [PayeeNameAnalysis] can contain an unknown value in a couple of
         * cases:
         *
         * - It was deserialized from data that doesn't match any known member. For
         *   example, if the SDK is on an older version than the API, then the API may
        ...
        enum class Value {
            ...
            NOT_EVALUATED,
            /**
             * An enum member indicating that [PayeeNameAnalysis] was instantiated with an
             * unknown value.
             */
            _UNKNOWN,
        }
