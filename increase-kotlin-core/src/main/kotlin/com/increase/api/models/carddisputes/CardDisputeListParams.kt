...
/** List Card Disputes */
class CardDisputeListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardDisputeListParams: CardDisputeListParams) =
            apply {
    ...
    override fun toString() = "CardDisputeListParams{createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
