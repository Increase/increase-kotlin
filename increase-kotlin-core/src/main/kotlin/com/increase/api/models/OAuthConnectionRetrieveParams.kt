...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OAuthConnectionRetrieveParams && this.oauthConnectionId == other.oauthConnectionId && this.additionalHeaders == other.additionalHeaders && this.additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(oauthConnectionId, additionalHeaders, additionalQueryParams) /* spotless:on */
    }
