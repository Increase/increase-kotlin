...
class OAuthConnectionRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "OAuthConnectionRetrieveParams{oauthConnectionId=$oauthConnectionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(oauthConnectionRetrieveParams: OAuthConnectionRetrieveParams) = apply {
            ...
            additionalBodyProperties(oauthConnectionRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): OAuthConnectionRetrieveParams = OAuthConnectionRetrieveParams(
