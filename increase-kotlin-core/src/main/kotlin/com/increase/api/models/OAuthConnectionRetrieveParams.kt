...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OAuthConnectionRetrieveParams && this.oauthConnectionId == other.oauthConnectionId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(oauthConnectionId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }
