...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DigitalCardProfileListPageAsync && this.digitalCardProfilesService == other.digitalCardProfilesService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(digitalCardProfilesService, params, response) /* spotless:on */
    }
    ...
    fun getNextPageParams(): DigitalCardProfileListParams? {
        ...
        return DigitalCardProfileListParams.builder()
            .from(params)
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<DigitalCardProfile>>? = data
        ...
        override fun toString() =
            "DigitalCardProfileListPageAsync.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
