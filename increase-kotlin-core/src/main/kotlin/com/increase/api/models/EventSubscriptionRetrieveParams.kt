...
class EventSubscriptionRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "EventSubscriptionRetrieveParams{eventSubscriptionId=$eventSubscriptionId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(eventSubscriptionRetrieveParams: EventSubscriptionRetrieveParams) = apply {
            ...
            additionalBodyProperties(eventSubscriptionRetrieveParams.additionalBodyProperties)
        }
        ...
        fun build(): EventSubscriptionRetrieveParams = EventSubscriptionRetrieveParams(
