...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EventSubscriptionRetrieveParams && this.eventSubscriptionId == other.eventSubscriptionId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(eventSubscriptionId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }
