...
/** List Card Payments */
class CardPaymentListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardPaymentListParams: CardPaymentListParams) =
            apply {
    ...
    override fun toString() = "CardPaymentListParams{accountId=$accountId, cardId=$cardId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
