...
class InboundCheckDepositRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "InboundCheckDepositRetrieveParams{inboundCheckDepositId=$inboundCheckDepositId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(inboundCheckDepositRetrieveParams: InboundCheckDepositRetrieveParams) = apply {
        ...
        fun build(): InboundCheckDepositRetrieveParams = InboundCheckDepositRetrieveParams(
