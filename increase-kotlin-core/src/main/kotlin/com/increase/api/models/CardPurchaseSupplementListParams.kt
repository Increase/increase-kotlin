...
constructor(
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.cardPaymentId?.let { params.put("card_payment_id", listOf(it.toString())) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardPurchaseSupplementListParams && this.cardPaymentId == other.cardPaymentId && this.createdAt == other.createdAt && this.cursor == other.cursor && this.limit == other.limit && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(cardPaymentId, createdAt, cursor, limit, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "CardPurchaseSupplementListParams{cardPaymentId=$cardPaymentId, createdAt=$createdAt, cursor=$cursor, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(cardPurchaseSupplementListParams: CardPurchaseSupplementListParams) =
            apply {
                this.cardPaymentId = cardPurchaseSupplementListParams.cardPaymentId
                this.createdAt = cardPurchaseSupplementListParams.createdAt
                this.cursor = cardPurchaseSupplementListParams.cursor
                this.limit = cardPurchaseSupplementListParams.limit
                additionalQueryParams(cardPurchaseSupplementListParams.additionalQueryParams)
                additionalHeaders(cardPurchaseSupplementListParams.additionalHeaders)
            }
