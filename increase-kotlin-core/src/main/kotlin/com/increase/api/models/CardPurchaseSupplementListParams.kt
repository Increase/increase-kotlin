...
constructor(
    ...
    internal fun getQueryParams(): QueryParams {
        ...
        this.cardPaymentId?.let { queryParams.put("card_payment_id", listOf(it.toString())) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardPurchaseSupplementListParams && this.cardPaymentId == other.cardPaymentId && this.createdAt == other.createdAt && this.cursor == other.cursor && this.limit == other.limit && this.additionalHeaders == other.additionalHeaders && this.additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(cardPaymentId, createdAt, cursor, limit, additionalHeaders, additionalQueryParams) /* spotless:on */
    }
