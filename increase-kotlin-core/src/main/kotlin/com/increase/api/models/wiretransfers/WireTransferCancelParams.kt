...
class WireTransferCancelParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(wireTransferCancelParams: WireTransferCancelParams) =
            apply {
                ...
                additionalBodyProperties = wireTransferCancelParams.additionalBodyProperties.toMutableMap()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is WireTransferCancelParams && wireTransferId == other.wireTransferId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() = "WireTransferCancelParams{wireTransferId=$wireTransferId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
