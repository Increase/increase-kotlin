 ...
 */
class CardRefundCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{transactionId=$transactionId, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardRefundCreateParams: CardRefundCreateParams) =
            apply {
    ...
    override fun toString() = "CardRefundCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
