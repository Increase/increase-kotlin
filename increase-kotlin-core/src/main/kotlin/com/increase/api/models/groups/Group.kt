 ...
 */
@NoAutoDetect
class Group @JsonCreator private constructor(
    @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
    @JsonProperty("ach_debit_status") @ExcludeMissing private val achDebitStatus: JsonField<AchDebitStatus> = JsonMissing.of(),
    @JsonProperty("activation_status") @ExcludeMissing private val activationStatus: JsonField<ActivationStatus> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        /** If the Group is allowed to create ACH debits. */
        fun achDebitStatus(achDebitStatus: JsonField<AchDebitStatus>) =
            apply {
        ...
        /** If the Group is activated or not. */
        fun activationStatus(activationStatus: JsonField<ActivationStatus>) =
            apply {
    ...
    /** If the Group is allowed to create ACH debits. */
    class AchDebitStatus @JsonCreator private constructor(
        ...
        /**
         * An enum containing [AchDebitStatus]'s known values, as well as an [_UNKNOWN]
         * member.
         *
         * An instance of [AchDebitStatus] can contain an unknown value in a couple of
         * cases:
         *
    ...
    /** If the Group is activated or not. */
    class ActivationStatus @JsonCreator private constructor(
        private val value: JsonField<String>,
         ...
         * member.
         *
         * An instance of [ActivationStatus] can contain an unknown value in a couple of
         * cases:
         *
         * - It was deserialized from data that doesn't match any known member. For
         *   example, if the SDK is on an older version than the API, then the API may
    ...
    override fun toString() = "Group{id=$id, achDebitStatus=$achDebitStatus, activationStatus=$activationStatus, createdAt=$createdAt, type=$type, additionalProperties=$additionalProperties}"
}
