...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LockboxListParams && this.accountId == other.accountId && this.createdAt == other.createdAt && this.cursor == other.cursor && this.idempotencyKey == other.idempotencyKey && this.limit == other.limit && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(accountId, createdAt, cursor, idempotencyKey, limit, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "LockboxListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(lockboxListParams: LockboxListParams) = apply {
            this.accountId = lockboxListParams.accountId
            this.createdAt = lockboxListParams.createdAt
            this.cursor = lockboxListParams.cursor
            this.idempotencyKey = lockboxListParams.idempotencyKey
            this.limit = lockboxListParams.limit
            additionalQueryParams(lockboxListParams.additionalQueryParams)
            additionalHeaders(lockboxListParams.additionalHeaders)
        }
