...
class LockboxListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "LockboxListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(lockboxListParams: LockboxListParams) = apply {
            ...
            additionalBodyProperties(lockboxListParams.additionalBodyProperties)
        }
        ...
        fun build(): LockboxListParams = LockboxListParams(
            accountId,
            createdAt,
            cursor,
            idempotencyKey,
