...
class IntrafiAccountEnrollmentListPage private constructor(
    ...
    companion object {
        ...
        fun of(intrafiAccountEnrollmentsService: IntrafiAccountEnrollmentService, params: IntrafiAccountEnrollmentListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<IntrafiAccountEnrollment> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
