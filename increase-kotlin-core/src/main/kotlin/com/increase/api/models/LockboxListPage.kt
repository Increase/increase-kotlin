...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LockboxListPage && this.lockboxesService == other.lockboxesService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(lockboxesService, params, response) /* spotless:on */
    }
    ...
    fun getNextPageParams(): LockboxListParams? {
        ...
        return LockboxListParams.builder()
            .from(params)
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<Lockbox>>? = data
        ...
        override fun toString() =
            "LockboxListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
