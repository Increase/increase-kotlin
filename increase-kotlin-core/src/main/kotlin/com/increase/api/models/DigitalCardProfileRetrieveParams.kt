...
class DigitalCardProfileRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "DigitalCardProfileRetrieveParams{digitalCardProfileId=$digitalCardProfileId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(digitalCardProfileRetrieveParams: DigitalCardProfileRetrieveParams) = apply {
        ...
        fun build(): DigitalCardProfileRetrieveParams = DigitalCardProfileRetrieveParams(
