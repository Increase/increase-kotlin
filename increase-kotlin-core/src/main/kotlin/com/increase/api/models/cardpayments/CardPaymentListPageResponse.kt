...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<CardPayment>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CardPayment> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CardPayment>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<CardPayment>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<CardPayment>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CardPayment>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CardPayment] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CardPayment) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardPaymentListPageResponse && data == other.data && nextCursor == other.nextCursor && additionalProperties == other.additionalProperties /* spotless:on */
    }
