...
class Event private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "Event{associatedObjectId=$associatedObjectId, associatedObjectType=$associatedObjectType, category=$category, createdAt=$createdAt, id=$id, type=$type, additionalProperties=$additionalProperties}"
    ...
    class Category @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            val BOOKKEEPING_ENTRY_SET_UPDATED = Category(JsonField.of("bookkeeping_entry_set.updated"))
            ...
            val DECLINED_TRANSACTION_CREATED = Category(JsonField.of("declined_transaction.created"))

            val DIGITAL_CARD_PROFILE_CREATED = Category(JsonField.of("digital_card_profile.created"))

            val DIGITAL_CARD_PROFILE_UPDATED = Category(JsonField.of("digital_card_profile.updated"))

            val DIGITAL_WALLET_TOKEN_CREATED = Category(JsonField.of("digital_wallet_token.created"))

            val DIGITAL_WALLET_TOKEN_UPDATED = Category(JsonField.of("digital_wallet_token.updated"))
            ...
            val INBOUND_ACH_TRANSFER_CREATED = Category(JsonField.of("inbound_ach_transfer.created"))

            val INBOUND_ACH_TRANSFER_UPDATED = Category(JsonField.of("inbound_ach_transfer.updated"))

            val INBOUND_ACH_TRANSFER_RETURN_CREATED = Category(JsonField.of("inbound_ach_transfer_return.created"))

            val INBOUND_ACH_TRANSFER_RETURN_UPDATED = Category(JsonField.of("inbound_ach_transfer_return.updated"))

            val INBOUND_CHECK_DEPOSIT_CREATED = Category(JsonField.of("inbound_check_deposit.created"))

            val INBOUND_CHECK_DEPOSIT_UPDATED = Category(JsonField.of("inbound_check_deposit.updated"))
            ...
            val INBOUND_WIRE_DRAWDOWN_REQUEST_CREATED = Category(JsonField.of("inbound_wire_drawdown_request.created"))

            val INBOUND_WIRE_TRANSFER_CREATED = Category(JsonField.of("inbound_wire_transfer.created"))

            val INBOUND_WIRE_TRANSFER_UPDATED = Category(JsonField.of("inbound_wire_transfer.updated"))

            val INTRAFI_ACCOUNT_ENROLLMENT_CREATED = Category(JsonField.of("intrafi_account_enrollment.created"))

            val INTRAFI_ACCOUNT_ENROLLMENT_UPDATED = Category(JsonField.of("intrafi_account_enrollment.updated"))
            ...
            val LOCKBOX_CREATED = Category(JsonField.of("lockbox.created"))

            val LOCKBOX_UPDATED = Category(JsonField.of("lockbox.updated"))

            val OAUTH_CONNECTION_CREATED = Category(JsonField.of("oauth_connection.created"))

            val OAUTH_CONNECTION_DEACTIVATED = Category(JsonField.of("oauth_connection.deactivated"))
            ...
            val PHYSICAL_CARD_PROFILE_CREATED = Category(JsonField.of("physical_card_profile.created"))

            val PHYSICAL_CARD_PROFILE_UPDATED = Category(JsonField.of("physical_card_profile.updated"))

            val PROOF_OF_AUTHORIZATION_REQUEST_CREATED = Category(JsonField.of("proof_of_authorization_request.created"))

            val PROOF_OF_AUTHORIZATION_REQUEST_UPDATED = Category(JsonField.of("proof_of_authorization_request.updated"))

            val PROOF_OF_AUTHORIZATION_REQUEST_SUBMISSION_CREATED = Category(JsonField.of("proof_of_authorization_request_submission.created"))

            val PROOF_OF_AUTHORIZATION_REQUEST_SUBMISSION_UPDATED = Category(JsonField.of("proof_of_authorization_request_submission.updated"))

            val REAL_TIME_DECISION_CARD_AUTHORIZATION_REQUESTED = Category(JsonField.of("real_time_decision.card_authorization_requested"))

            val REAL_TIME_DECISION_DIGITAL_WALLET_TOKEN_REQUESTED = Category(JsonField.of("real_time_decision.digital_wallet_token_requested"))

            val REAL_TIME_DECISION_DIGITAL_WALLET_AUTHENTICATION_REQUESTED = Category(JsonField.of("real_time_decision.digital_wallet_authentication_requested"))

            val REAL_TIME_PAYMENTS_TRANSFER_CREATED = Category(JsonField.of("real_time_payments_transfer.created"))

            val REAL_TIME_PAYMENTS_TRANSFER_UPDATED = Category(JsonField.of("real_time_payments_transfer.updated"))

            val REAL_TIME_PAYMENTS_REQUEST_FOR_PAYMENT_CREATED = Category(JsonField.of("real_time_payments_request_for_payment.created"))

            val REAL_TIME_PAYMENTS_REQUEST_FOR_PAYMENT_UPDATED = Category(JsonField.of("real_time_payments_request_for_payment.updated"))

            val TRANSACTION_CREATED = Category(JsonField.of("transaction.created"))

            val WIRE_DRAWDOWN_REQUEST_CREATED = Category(JsonField.of("wire_drawdown_request.created"))

            val WIRE_DRAWDOWN_REQUEST_UPDATED = Category(JsonField.of("wire_drawdown_request.updated"))
