...
class SimulationRealTimePaymentsTransferCompleteParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class SimulationRealTimePaymentsTransferCompleteBody internal constructor(private val rejection: Rejection?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "SimulationRealTimePaymentsTransferCompleteBody{rejection=$rejection, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(simulationRealTimePaymentsTransferCompleteBody: SimulationRealTimePaymentsTransferCompleteBody) = apply {
                this.rejection = simulationRealTimePaymentsTransferCompleteBody.rejection
                additionalProperties(simulationRealTimePaymentsTransferCompleteBody.additionalProperties)
            }

            /** If set, the simulation will reject the transfer. */
            @JsonProperty("rejection")
            fun rejection(rejection: Rejection) = apply {
            ...
            fun build(): SimulationRealTimePaymentsTransferCompleteBody = SimulationRealTimePaymentsTransferCompleteBody(rejection, additionalProperties.toUnmodifiable())
        }
    }
    ...
    override fun toString() = "SimulationRealTimePaymentsTransferCompleteParams{realTimePaymentsTransferId=$realTimePaymentsTransferId, rejection=$rejection, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(simulationRealTimePaymentsTransferCompleteParams: SimulationRealTimePaymentsTransferCompleteParams) = apply {
            this.realTimePaymentsTransferId = simulationRealTimePaymentsTransferCompleteParams.realTimePaymentsTransferId
            this.rejection = simulationRealTimePaymentsTransferCompleteParams.rejection
            additionalQueryParams(simulationRealTimePaymentsTransferCompleteParams.additionalQueryParams)
            additionalHeaders(simulationRealTimePaymentsTransferCompleteParams.additionalHeaders)
            additionalBodyProperties(simulationRealTimePaymentsTransferCompleteParams.additionalBodyProperties)
        }
        ...
        fun build(): SimulationRealTimePaymentsTransferCompleteParams = SimulationRealTimePaymentsTransferCompleteParams(
    ...
    @NoAutoDetect
    class Rejection private constructor(private val rejectReasonCode: RejectReasonCode?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        class Builder {
            ...
            fun build(): Rejection = Rejection(checkNotNull(rejectReasonCode) {
