...
/** List Accounts */
class AccountListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.informationalEntityId?.let {
          queryParams.put(
            "informational_entity_id", listOf(it.toString())
          )
      }
      this.limit?.let {
          queryParams.put(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountListParams: AccountListParams) =
            apply {
    ...
    override fun toString() = "AccountListParams{createdAt=$createdAt, cursor=$cursor, entityId=$entityId, idempotencyKey=$idempotencyKey, informationalEntityId=$informationalEntityId, limit=$limit, programId=$programId, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
