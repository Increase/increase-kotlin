...
private constructor(
     ...
     * other document if you've confirmed the individual does not have a US tax id (either a Social
     ...
     *
     * Unlike [confirmedNoUsTaxId], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(beneficialOwnerUpdateParams: BeneficialOwnerUpdateParams) = apply {
            entityBeneficialOwnerId = beneficialOwnerUpdateParams.entityBeneficialOwnerId
         ...
         *
         * You should usually call [Builder.confirmedNoUsTaxId] with a well-typed [Boolean] value
         ...
         *
         * You should usually call [Builder.identification] with a well-typed [Identification] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
    ...
    private constructor(
         ...
         * `method` is equal to `drivers_license`.
         *
         * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
         */
        ...
        /**
         * Information about the identification document provided. Required if `method` is equal to
         * `other`.
         *
         * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
        ...
        /**
         * Information about the passport used for identification. Required if `method` is equal to
         * `passport`.
         *
         * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
         ...
         *
         * Unlike [driversLicense], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("drivers_license")
        @ExcludeMissing
         ...
         */
        @JsonProperty("passport") @ExcludeMissing fun _passport(): JsonField<Passport> = passport
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.driversLicense] with a well-typed [DriversLicense]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
        ...
        private constructor(
             ...
             *
             * Unlike [backFileId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("back_file_id")
            @ExcludeMissing
        ...
        private constructor(
            ...
            /**
             * The identifier of the File containing the back of the document. Not every document
             * has a reverse side.
             *
             * @throws IncreaseInvalidDataException if the JSON field has an unexpected type (e.g.
             *   if the server responded with an unexpected value).
    ...
    override fun hashCode(): Int =
        Objects.hash(entityBeneficialOwnerId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "BeneficialOwnerUpdateParams{entityBeneficialOwnerId=$entityBeneficialOwnerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
