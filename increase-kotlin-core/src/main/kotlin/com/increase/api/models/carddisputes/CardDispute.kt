 ...
 */
@NoAutoDetect
class CardDispute @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardDispute: CardDispute) =
            apply {
                id = cardDispute.id
    ...
    class Acceptance @JsonCreator private constructor(
        ...
        @JsonProperty("card_dispute_id") @ExcludeMissing private val cardDisputeId: JsonField<String> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** The identifier of the Card Dispute that was accepted. */
            fun cardDisputeId(cardDisputeId: JsonField<String>) =
                apply {
     ...
     */
    @NoAutoDetect
    class Loss @JsonCreator private constructor(
        @JsonProperty("card_dispute_id") @ExcludeMissing private val cardDisputeId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("explanation") @ExcludeMissing private val explanation: JsonField<String> = JsonMissing.of(),
        @JsonProperty("lost_at") @ExcludeMissing private val lostAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("transaction_id") @ExcludeMissing private val transactionId: JsonField<String> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        class Builder internal constructor() {
             ...
             * the Card Dispute was lost.
             */
            fun lostAt(lostAt: JsonField<OffsetDateTime>) =
                apply {
                    this.lostAt = lostAt
                }
        ...
        override fun toString() = "Loss{cardDisputeId=$cardDisputeId, explanation=$explanation, lostAt=$lostAt, transactionId=$transactionId, additionalProperties=$additionalProperties}"
    }
    ...
    class Rejection @JsonCreator private constructor(
        ...
        override fun toString() = "Rejection{cardDisputeId=$cardDisputeId, explanation=$explanation, rejectedAt=$rejectedAt, additionalProperties=$additionalProperties}"
    }
     ...
     */
    @NoAutoDetect
    class Win @JsonCreator private constructor(
        @JsonProperty("card_dispute_id") @ExcludeMissing private val cardDisputeId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("won_at") @ExcludeMissing private val wonAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        @JsonProperty("won_at")
        @ExcludeMissing
        fun _wonAt(): JsonField<OffsetDateTime> = wonAt
        ...
        class Builder internal constructor() {
             ...
             * the Card Dispute was won.
             */
            fun wonAt(wonAt: JsonField<OffsetDateTime>) =
                apply {
                    this.wonAt = wonAt
                }
        ...
        override fun toString() = "Win{cardDisputeId=$cardDisputeId, wonAt=$wonAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "CardDispute{id=$id, acceptance=$acceptance, amount=$amount, createdAt=$createdAt, disputedTransactionId=$disputedTransactionId, explanation=$explanation, idempotencyKey=$idempotencyKey, loss=$loss, rejection=$rejection, status=$status, type=$type, win=$win, additionalProperties=$additionalProperties}"
}
