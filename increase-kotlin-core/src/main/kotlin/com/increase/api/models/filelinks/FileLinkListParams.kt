...
private constructor(
    ...
    override fun _queryParams(): QueryParams {
        ...
        this.fileId.let { queryParams.put("file_id", listOf(it.toString())) }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileLinkListParams].
         *
    ...
    /** A builder for [FileLinkListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(fileLinkListParams: FileLinkListParams) = apply {
            fileId = fileLinkListParams.fileId
            createdAt = fileLinkListParams.createdAt
            cursor = fileLinkListParams.cursor
            idempotencyKey = fileLinkListParams.idempotencyKey
            limit = fileLinkListParams.limit
            additionalHeaders = fileLinkListParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileLinkListParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FileLinkListParams && fileId == other.fileId && createdAt == other.createdAt && cursor == other.cursor && idempotencyKey == other.idempotencyKey && limit == other.limit && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(fileId, createdAt, cursor, idempotencyKey, limit, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "FileLinkListParams{fileId=$fileId, createdAt=$createdAt, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
