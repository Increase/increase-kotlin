 ...
 */
class CardFuelConfirmationCreateParams
private constructor(
        ...
        internal fun from(cardFuelConfirmationCreateParams: CardFuelConfirmationCreateParams) =
            apply {
                ...
                additionalQueryParams =
                    cardFuelConfirmationCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    private constructor(
        ...
        ) : this(amount, cardPaymentId, mutableMapOf())
    ...
    override fun toString() =
        "CardFuelConfirmationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
