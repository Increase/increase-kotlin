 ...
 */
class CardFuelConfirmationCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{amount=$amount, cardPaymentId=$cardPaymentId, additionalProperties=$additionalProperties}"
    }
    ...
    /** A builder for [CardFuelConfirmationCreateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(cardFuelConfirmationCreateParams: CardFuelConfirmationCreateParams) =
            apply {
                body = cardFuelConfirmationCreateParams.body.toBuilder()
                additionalHeaders = cardFuelConfirmationCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = cardFuelConfirmationCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CardFuelConfirmationCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "CardFuelConfirmationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
