...
class InboundWireTransferListPage private constructor(
    ...
    companion object {
        ...
        fun of(inboundWireTransfersService: InboundWireTransferService, params: InboundWireTransferListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<InboundWireTransfer>> = JsonMissing.of(),
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<InboundWireTransfer> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
