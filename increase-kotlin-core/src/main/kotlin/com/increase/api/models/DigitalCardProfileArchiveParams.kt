...
class DigitalCardProfileArchiveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "DigitalCardProfileArchiveParams{digitalCardProfileId=$digitalCardProfileId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(digitalCardProfileArchiveParams: DigitalCardProfileArchiveParams) = apply {
        ...
        fun build(): DigitalCardProfileArchiveParams = DigitalCardProfileArchiveParams(
