...
@NoAutoDetect
class AccountTransfer @JsonCreator private constructor(
    ...
    @JsonProperty("destination_transaction_id") @ExcludeMissing private val destinationTransactionId: JsonField<String> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountTransfer: AccountTransfer) =
            apply {
        ...
        /** The ID for the transaction receiving the transfer. */
        fun destinationTransactionId(destinationTransactionId: String?) = destinationTransactionId(JsonField.ofNullable(destinationTransactionId))

        /** The ID for the transaction receiving the transfer. */
        fun destinationTransactionId(destinationTransactionId: JsonField<String>) =
            apply {
