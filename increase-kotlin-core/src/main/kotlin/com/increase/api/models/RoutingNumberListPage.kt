...
class RoutingNumberListPage private constructor(private val routingNumbersService: RoutingNumberService, private val params: RoutingNumberListParams, private val response: Response, ) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RoutingNumberListPage &&
    ...
    override fun toString() = "RoutingNumberListPage{routingNumbersService=$routingNumbersService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(routingNumbersService: RoutingNumberService, params: RoutingNumberListParams, response: Response) = RoutingNumberListPage(
            routingNumbersService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<RoutingNumberListResponse>>, private val nextCursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "RoutingNumberListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: RoutingNumberListPage, ) : Sequence<RoutingNumberListResponse> {
