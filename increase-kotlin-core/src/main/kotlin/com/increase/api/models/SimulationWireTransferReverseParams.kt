...
class SimulationWireTransferReverseParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SimulationWireTransferReverseParams &&
    ...
    override fun toString() = "SimulationWireTransferReverseParams{wireTransferId=$wireTransferId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(simulationWireTransferReverseParams: SimulationWireTransferReverseParams) = apply {
        ...
        fun build(): SimulationWireTransferReverseParams = SimulationWireTransferReverseParams(
