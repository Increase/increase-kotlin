...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountCreateParams && this.name == other.name && this.entityId == other.entityId && this.informationalEntityId == other.informationalEntityId && this.programId == other.programId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(name, entityId, informationalEntityId, programId, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }
