...
@NoAutoDetect
class CardDetails @JsonCreator private constructor(
    @JsonProperty("card_id") @ExcludeMissing private val cardId: JsonField<String> = JsonMissing.of(),
    @JsonProperty("expiration_month") @ExcludeMissing private val expirationMonth: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("expiration_year") @ExcludeMissing private val expirationYear: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("primary_account_number") @ExcludeMissing private val primaryAccountNumber: JsonField<String> = JsonMissing.of(),
    @JsonProperty("type") @ExcludeMissing private val type: JsonField<Type> = JsonMissing.of(),
    @JsonProperty("verification_code") @ExcludeMissing private val verificationCode: JsonField<String> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cardDetails: CardDetails) =
            apply {
        ...
        /** The month the card expires in M format (e.g., August is 8). */
        fun expirationMonth(expirationMonth: JsonField<Long>) =
            apply {
        ...
        /** The year the card expires in YYYY format (e.g., 2025). */
        fun expirationYear(expirationYear: JsonField<Long>) =
            apply {
        ...
        /** The card number. */
        fun primaryAccountNumber(primaryAccountNumber: JsonField<String>) =
            apply {
         ...
         * Identification (CID).
         */
        fun verificationCode(verificationCode: JsonField<String>) =
            apply {
    ...
    override fun toString() = "CardDetails{cardId=$cardId, expirationMonth=$expirationMonth, expirationYear=$expirationYear, primaryAccountNumber=$primaryAccountNumber, type=$type, verificationCode=$verificationCode, additionalProperties=$additionalProperties}"
}
