...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WireTransferListPage && this.wireTransfersService == other.wireTransfersService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(wireTransfersService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "WireTransferListPage.Response{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
