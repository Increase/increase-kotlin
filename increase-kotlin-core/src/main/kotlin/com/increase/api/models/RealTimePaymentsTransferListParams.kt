...
class RealTimePaymentsTransferListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RealTimePaymentsTransferListParams &&
    ...
    class Builder {
        ...
        internal fun from(realTimePaymentsTransferListParams: RealTimePaymentsTransferListParams) = apply {
            ...
            additionalBodyProperties(realTimePaymentsTransferListParams.additionalBodyProperties)
        }
        ...
        fun build(): RealTimePaymentsTransferListParams = RealTimePaymentsTransferListParams(
            accountId,
            createdAt,
            cursor,
            externalAccountId,
