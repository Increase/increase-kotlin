...
constructor(
    ...
    override fun toString() =
        "RealTimePaymentsTransferListParams{accountId=$accountId, createdAt=$createdAt, cursor=$cursor, externalAccountId=$externalAccountId, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(realTimePaymentsTransferListParams: RealTimePaymentsTransferListParams) =
            apply {
                ...
                additionalBodyProperties(
                    realTimePaymentsTransferListParams.additionalBodyProperties
                )
            }
