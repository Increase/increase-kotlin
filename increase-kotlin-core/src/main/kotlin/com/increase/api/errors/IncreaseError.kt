...
@NoAutoDetect
class IncreaseError @JsonCreator private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [IncreaseError]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(increaseError: IncreaseError) =
            apply {
