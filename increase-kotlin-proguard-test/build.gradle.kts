...
dependencies {
    testImplementation(project(":increase-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../increase-kotlin-core/src/main/resources/META-INF/proguard/increase-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../increase-kotlin-core/src/main/resources/META-INF/proguard/increase-kotlin-core.pro",
